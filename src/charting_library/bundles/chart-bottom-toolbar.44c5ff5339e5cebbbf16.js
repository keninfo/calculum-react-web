  ...
  [7260],
  {
    ...
    23829: (e, t, n) => {
      ...
      function p(e) {
        const {
          ...
          W = !!S.length
        return i
          ? s.createElement('li', { className: a()(t, m.item, m.loading, m[w]) }, s.createElement(r.Loader, null))
          : s.createElement(
              'li',
              {
                className: a()(
              ...
              s.createElement(
                ...
                { className: a()(m.label) },
                !B && E
                  ? E.map(({ text: e, ...t }, n) => s.createElement('span', { key: n, style: t }, e))
                  : null != B
                    ? B
                    : y,
              ),
              ...
              !W && x && s.createElement(c.Hint, { className: m.shortcut, text: x }),
    ...
    1109: (e, t, n) => {
      ...
      var s = n(50959),
        ...
        a = n(47625)
      function o(e) {
        return s.createElement('div', { className: i(a.separator, e.className) })
      }
    },
    74483: (e) => {
      e.exports = {
    ...
    6190: (e, t, n) => {
      ...
      const d = (0, s.forwardRef)(function (e, t) {
        const { onKeyDown: n, orientation: d, blurOnEscKeydown: u = !0, blurOnClick: m = !0, ...p } = e,
        ...
        return (
          ...
          s.createElement('div', {
            ...
            onKeyDown: (0, a.createSafeMulticastEventHandler)(function (e) {
              ...
              if (u && 27 === t) return e.preventDefault(), void document.activeElement.blur()
              if ('vertical' !== d && 37 !== t && 39 !== t) return
              if ('vertical' === d && 38 !== t && 40 !== t) return
              const n = e.currentTarget,
                s = (0, r.queryFocusableElements)(n).sort(r.navigationOrderComparator)
              ...
              const a = () => {
                  ...
                  ;(0, l.becomeSecondaryElement)(s[i]), (0, l.becomeMainElement)(s[e]), s[e].focus()
                },
                c = () => {
                  const e = (i + s.length + 1) % s.length
                  ;(0, l.becomeSecondaryElement)(s[i]), (0, l.becomeMainElement)(s[e]), s[e].focus()
    ...
    68426: (e, t, n) => {
      ...
      var s = n(50959),
        ...
        C = n(52033),
        f = n(85049)
      const x = (e) => a.t(null, { plural: '{str} minutes', count: e, replace: { str: `${e}` } }, n(5926)),
        S = (e) => a.t(null, { plural: '{str} hours', count: e, replace: { str: `${e}` } }, n(64963)),
        y = (e) => a.t(null, { plural: '{str} months', count: e, replace: { str: `${e}` } }, n(20062)),
        E = {
          ...
          '1D': {
            resolution: '1D',
            text: ((R = 1), a.t(null, { plural: '{str} days', count: R, replace: { str: `${R}` } }, n(62368))),
          },
          '1W': {
            resolution: '1W',
            text: ((k = 1), a.t(null, { plural: '{str} weeks', count: k, replace: { str: `${k}` } }, n(49306))),
          },
          ...
          '12M': {
            resolution: '12M',
            text: ((M = 1), a.t(null, { plural: '{str} years', count: M, replace: { str: `${M}` } }, n(91549))),
          },
        }
      var M, k, R
      function B(e) {
        const t = (function (e) {
            ...
            if (!s.isValid()) {
              if ('YTD' === t) return a.t(null, { context: 'timeframe_title' }, n(19273))
              if ('ALL' === t) return a.t(null, { context: 'timeframe_title' }, n(58221))
            ...
            if (s.isMinutes()) {
              ...
              return e % 60 != 0
                ? ((o = e),
                  a.t(
                    null,
                    { plural: '{str} minutes', count: o, replace: { str: `${o}` }, context: 'timeframe_title' },
                    n(95484),
                  ))
                : ((i = e / 60),
                  a.t(
                    null,
                    { plural: '{str} hours', count: i, replace: { str: `${i}` }, context: 'timeframe_title' },
                    n(72495),
                  ))
            }
            var i
            ...
            if (s.isMonths()) {
              ...
              return e % 12 != 0
                ? ((r = e),
                  a.t(
                    null,
                    { plural: '{str} months', count: r, replace: { str: `${r}` }, context: 'timeframe_title' },
                    n(12752),
                  ))
                : ((e) =>
                    a.t(
            ...
            if (s.isMinutes()) {
              ...
              return e % 60 != 0
                ...
                : ((i = e / 60),
                  a.t(
                    null,
                    { plural: '{str} hours intervals', count: i, replace: { str: `${i}` }, context: 'timeframe_title' },
                    n(14887),
                  ))
            }
            var i
        ...
        return a.t(null, { replace: { timePeriod: t, timeInterval: s }, context: 'timeframe_title' }, n(58426))
      }
      const w = (e) =>
        a.t(null, { plural: '{str} days', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, n(63808))
      class T {
        constructor(e) {
          ;(this._state = { ranges: [] }),
            (this._change = new C.Delegate()),
            (this._rangeChangedListenerBound = this._onRangeChanged.bind(this)),
            (this._updateAvailableRangesBound = this._updateAvailableRanges.bind(this, void 0))
          ...
          t.withModel(null, () => {
            ...
            n.onStatusChanged().subscribe(this, this._updateAvailableRanges),
              c.enabled('update_timeframes_set_on_symbol_resolve') &&
                n.dataEvents().symbolResolved().subscribe(this, this._updateAvailableRangesBound),
              n.priceScale().properties().childs().lockScale.subscribe(this, this._updateAvailableRangesBound)
        ...
        destroy() {
          ...
          e.withModel(null, () => {
            ...
            n.onStatusChanged().unsubscribe(this, this._updateAvailableRanges),
              c.enabled('update_timeframes_set_on_symbol_resolve') &&
                n.dataEvents().symbolResolved().unsubscribe(this, this._updateAvailableRangesBound),
              n.priceScale().properties().childs().lockScale.unsubscribe(this, this._updateAvailableRangesBound),
        ...
        _updateAvailableRanges(e) {
          ...
          const o = t(i, a).map((e) => ({ ...e, description: '' === e.description ? B(e) : e.description }))
            ...
            constructor(e, t) {
              super(e, t),
                ...
                (this._handleSelectRange = (e) => {
                  var t, n
                  ;(0, v.trackEvent)('GUI', 'Chart Bottom Toolbar', `range ${e.value}`),
              ...
              const n = (this._binding = (0, b.ensureDefined)(D.get(t.chartWidget)))
              this.state = n.state()
            }
            componentDidMount() {
      ...
      const O = { title: a.t(null, void 0, n(85444)), goToDate: (0, P.appendEllipsis)(a.t(null, void 0, n(42432))) },
        ...
        constructor(e, t) {
          super(e, t),
            ...
            (this._renderChildren = (e) => {
              const { ranges: t, activeRange: n, goToDateButton: i } = this.props
              return e
                ? s.createElement(
                    s.Fragment,
                    null,
                    s.createElement(I, { ranges: t, activeRange: n, onSelectRange: this._handleRangeSelect }),
                    i && s.createElement(X, { onGoToDateClick: this._handleGoToDateClick }),
                  )
                : s.createElement(
                    s.Fragment,
                    null,
                    ...
                    i && t.length > 0 && s.createElement(g.PopupMenuSeparator, null),
                    i &&
                      s.createElement(p.AccessibleMenuItem, { label: O.goToDate, onClick: this._handleGoToDateClick }),
                  )
            }),
            (0, _.validateRegistry)(t, { chartWidget: o.any.isRequired })
        }
        render() {
          return s.createElement(m.MatchMedia, { rule: 'screen and (max-width: 430px)' }, (e) =>
            s.createElement(
              h.ToolbarMenuButton,
              {
      ...
      function q(e) {
        return class extends s.PureComponent {
          ...
          componentDidUpdate() {
            ;((0, b.ensureNotNull)(this._slider).style.transition = 'transform 350ms'), this._componentDidUpdate()
          }
          componentDidMount() {
      ...
      q(function (e) {
        return s.createElement('div', { className: J.slider, ref: e.reference })
      })
      var $ = n(40173),
        Z = n(20792),
        K = n(56905)
      ...
      function Y(e) {
        const { reference: t, text: n, tooltip: i, isActive: a, className: o, onClick: l, theme: c = K, ...h } = e,
      ...
      class de extends s.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._handleClick = () => {
              const { chartWidget: e } = this.context
              ;(0, v.trackEvent)('GUI', 'Chart Bottom Toolbar', 'go to'), (0, N.showGoToDateDialog)(e)
            }),
            (0, _.validateRegistry)(t, { chartWidget: o.any.isRequired })
        }
        render() {
      ...
      var me = n(76460),
        ...
        fe = n(40443),
        xe = n(98638)
      const Se = (0, $.mergeThemes)(Z.DEFAULT_TOOLBAR_BUTTON_THEME, { isDisabled: xe.disabled, button: xe.button })
      const ye = (0, _.registryContextType)()
      class Ee extends s.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._timeFormatter = new ge.TimeFormatter(
              (0, _e.getHourMinuteSecondFormat)(Ce.timeHoursFormatProperty.value()),
            )),
            ...
            (this._getActions = () => {
              ...
              return (function (e) {
                e.updateActions()
                const t = e.actions()
                return t && t.applyTimeZone instanceof be.Action ? t.applyTimeZone.getSubItems() : []
              })(e)
            }),
            (this._handleRef = (e) => {
              this._element = e
            ...
            (this._showMenu = (e) => {
              if (this._preventShowingMenu) return void fe.ContextMenuManager.hideAll()
          ...
          ;(this._tickInterval = setInterval(this._tickClock, 1e3)),
            e.withModel(null, () => {
              ...
              t.model().mainSeries().dataEvents().symbolResolved().subscribe(this, this.updateTimezonesButton),
                ...
                Ce.timeHoursFormatProperty.subscribe(this, this._timeHoursFormatPropertyChanged)
            })
        }
        componentWillUnmount() {
          const { chartWidget: e } = this.context
          clearInterval(this._tickInterval),
            e.withModel(null, () => {
              ...
              t.model().mainSeries().dataEvents().symbolResolved().unsubscribe(this, this.updateTimezonesButton),
                ...
                Ce.timeHoursFormatProperty.unsubscribe(this, this._timeHoursFormatPropertyChanged)
            })
        }
        render() {
          const { className: e, withMenu: t } = this.props,
            { time: i } = this.state,
            o = void 0 !== this._timezone ? (0, pe.parseTzOffset)(this._timezone.name()).string : null
          return s.createElement(Z.ToolbarButton, {
        ...
        updateTimezonesButton() {
          ...
          const t = (0, b.ensureNotNull)(e.model().model().timezoneExceptExchange().value())
      ...
      var Me = n(19615)
      function ke(e) {
        return s.createElement('span', { className: r(Me.separator, e.className) })
      }
      var Re = n(6190),
        Be = n(45126),
        we = n(49483)
      ...
      const We = (0, _.registryContextType)(),
        Ae = new Be.TranslatedString('toggle log scale', a.t(null, void 0, n(49403)))
      const De = (0, _.registryContextType)(),
        Ne = new Be.TranslatedString('toggle auto scale', a.t(null, void 0, n(42240)))
      const ze = (0, _.registryContextType)(),
        Fe = new Be.TranslatedString('toggle percentage scale', a.t(null, void 0, n(98994)))
      ...
      var He = n(42142),
        ...
        Xe = n(95700),
        Oe = n(88108)
      const Ge = new Be.TranslatedString('change session', a.t(null, void 0, n(87041))),
        je = { hint: a.t(null, void 0, n(94031)), headerMenuText: a.t(null, void 0, n(27665)) },
      ...
      class Je extends s.PureComponent {
        ...
        updateSessionButton() {
          ...
          const i = s.subsession_id,
            a =
              null !== (t = null === (e = s.subsessions) || void 0 === e ? void 0 : e.filter((e) => !e.private)) &&
              void 0 !== t
                ? t
                : [],
            o = a.find((e) => e.id === i)
          this.setState({
            sessionId: i,
            sessionName: (0, Xe.translateSessionShortDescription)((null == o ? void 0 : o.description) || ''),
            sessionDescription: (0, Xe.translateSessionDescription)((null == o ? void 0 : o.description) || ''),
            availableSessions: a,
          })
        }
        _menuItems() {
          ...
          for (const a of t) {
            const t = { category: 'SetSession', event: a.id },
              o = () => {
                e.model().setProperty(n.properties().childs().sessionId, a.id, Ge)
              }
            i.push(
              s.createElement(p.AccessibleMenuItem, {
                key: a.id,
      ...
      !(function (e) {
        ...
        (function (e) {
          ;(e.Expanded = 'expanded'), (e.Collapsed = 'collapsed'), (e.Hidden = 'hidden')
        })(et || (et = {}))
      const tt =
        ((nt = (e) =>
            ...
            super(e, t),
              ...
              (this._handleSelect = () => {
                const e = this.context.chartWidget.model(),
                  ...
                  n = t.priceScale(),
                  s = n.mode()
                t.priceScale().isLockScale() || e.setPriceScaleMode({ log: !s.log }, n, Ae)
              }),
              (0, _.validateRegistry)(t, { chartWidget: o.any.isRequired }),
              (this.state = { isActive: !1, series: null }),
              (this._priceAxisHighlighter = new Te(this.context.chartWidget, () => this._priceScale, 'logarithm'))
          }
          componentDidMount() {
            ...
            ((t = class extends s.PureComponent {
              constructor(e, t) {
                super(e, t),
                  ...
                  (0, _.validateRegistry)(t, { chartWidget: o.any.isRequired }),
                  (this.state = { isActive: !1, series: null }),
                  (this._priceAxisHighlighter = new Te(this.context.chartWidget, () => this._priceScale, 'auto'))
              }
              componentDidMount() {
                const e = this.context.chartWidget
                e.withModel(null, () => {
                ...
                super(e, t),
                  ...
                  (this._handleSelect = () => {
                    const e = this.context.chartWidget.model(),
                      ...
                      n = t.priceScale(),
                      s = n.mode()
                    t.priceScale().isLockScale() || e.setPriceScaleMode({ percentage: !s.percentage }, n, Fe)
                  }),
                  (0, _.validateRegistry)(t, { chartWidget: o.any.isRequired }),
                  (this.state = { isActive: !1, series: null }),
                  (this._priceAxisHighlighter = new Te(this.context.chartWidget, () => this._priceScale, 'percentage'))
              }
              componentDidMount() {
                const e = this.context.chartWidget
                e.withModel(null, () => {
      ...
      const ot = (0, ie.hotKeySerialize)({
        ...
        rt = (function (e) {
          ...
          return (
            ((t = class extends s.PureComponent {
              ...
              render() {
                ...
                return s.createElement(e, { className: t, isFullscreen: n, onClick: this._handleClick })
              }
          ...
          s.createElement(Z.ToolbarButton, {
            ...
            tooltip: e.isFullscreen ? Ye.restoreChartHint : Ye.maximizeChartHint,
            className: e.className,
      ...
      class gt extends s.PureComponent {
          ...
          super(e, t),
            ...
            (this._updateButtonsVisibilityImp = (e) => {
              ...
              if (s.symbolResolvingActive().value())
                return void this._setStateWithResize({ intervalAllowsSessionButton: a }, e)
              const o = ((null == i ? void 0 : i.subsessions) || []).filter((e) => !e.private).length > 1
              this._setStateWithResize({ intervalAllowsSessionButton: a, symbolAllowsSessionButton: o }, e)
            }),
            (this._resizeByRaf = () => {
              null === this._raf &&
            ...
            (this._resizeHandler = () => {
              ...
              if ((Object.assign(e, { dateRangeMode: h, noRanges: c }), 'expanded' !== h)) {
                const t = o - (0, b.ensureNotNull)(this._rangeCollapsed).offsetWidth - 0
                let n = 0,
                  i = 0
                for (const a of s)
                  (n += a.width),
        ...
        componentDidMount() {
          const { onContentBoxChanged: e, resizerDetacher: t, chartWidgetCollection: n, chartWidget: s } = this.context
          e.subscribe(this, this._resizeByRaf),
            ...
            s.withModel(null, () => {
              ...
              e.mainSeries().isDWMProperty().subscribe(this, this._updateButtonsVisibility),
                ...
                t.symbolSourceCollectionChanged().subscribe(this, this._onSymbolSourceCollectionChanged),
                this._updateButtonsVisibility()
            }),
            this.updateTimezonesButton(),
            this.resizeUI()
        ...
        componentWillUnmount() {
          var e
          const { onContentBoxChanged: t, resizerDetacher: n, chartWidgetCollection: s, chartWidget: i } = this.context
          t.unsubscribe(this, this._resizeByRaf),
            ...
            i.withModel(null, () => {
              ...
              e.mainSeries().isDWMProperty().unsubscribe(this, this._updateButtonsVisibility),
                ...
                t.symbolSourceCollectionChanged().unsubscribe(this, this._onSymbolSourceCollectionChanged),
        ...
        render() {
          ...
          return s.createElement(
            Re.Toolbar,
            { className: Ke.toolbar, onContextMenu: Le.preventDefault, ref: this._handleToolbarRef },
            t &&
              s.createElement(
                He.FragmentMap,
                null,
                s.createElement(
                  'div',
                  {
                    className: r(Ke.dateRangeWrapper, 'collapsed' !== e.dateRangeMode && Ke.collapsed),
                    ref: this._handleRangeCollapsedRef,
                  },
                  s.createElement(
                    'div',
                    { className: r(Ke.dateRangeCollapsed) },
                    s.createElement(U, { goToDateButton: this.props.goToDateEnabled, className: Ke.dateRange }),
                  ),
                ),
                s.createElement(
                  'div',
                  ...
                  s.createElement(
                    ...
                    s.createElement(se, { onSelectRange: this._trackRangeButtonClick, className: Ke.dateRange }),
                    this.props.goToDateEnabled && s.createElement(ke, { className: r(Ke.separator) }),
            ...
            s.createElement(
              ...
              n &&
                s.createElement(
                  'div',
                  { className: r(Ke.inline, e.timeZones && Ke.collapsed), ref: this._handleTimeZonesRef },
                  s.createElement(
                    'div',
                    { className: Ke.inline, onClick: this._trackTimezonesButtonClick },
                    s.createElement(Ee, {
                      className: Ke.item,
              ...
              this.props.sessionIdButtonEnabled &&
                ...
                s.createElement(
                  'div',
                  { className: r(Ke.inline, e.session && Ke.collapsed), ref: this._handleSessionsRef },
                  s.createElement(
                    'div',
                    { className: Ke.inline },
                    s.createElement(Je, { className: Ke.item, withMenu: this.props.sessionIdButtonEnabled }),
                  ),
                ),
              s.createElement(
                'div',
                { ref: this._handleSeparatorRef, className: r(Ke.inline, e.separator && Ke.collapsed) },
              ...
              s.createElement(
                ...
                !1,
                !1,
                i && !c.enabled('fundamental_widget') && s.createElement(at, { className: Ke.item }),
        ...
        _setStateWithResize(e, t) {
          Object.assign(this._layout, mt),
            this._applyResizing(),
            t ? (this.setState(e), this._resizeHandler()) : this.setState(e, () => this._resizeByRaf())
        }
        _applyResizing() {
          const { dateRangeMode: e, noRanges: t, ...n } = this._layout
          this._rangeExpanded &&
            (this._rangeExpanded.classList.toggle(Ke.collapsed, 'expanded' !== e),
            this._rangeExpanded.classList.toggle(Ke.noranges, t)),
            this._rangeCollapsed && this._rangeCollapsed.classList.toggle(Ke.collapsed, 'collapsed' !== e)
          let s = !1,
            i = !1
          Object.keys(n).forEach((e) => {
            ...
            if ('separator' !== t) {
              const e = this._seriesComponents[t],
                a = !0 === n[t]
              e &&
                ('timeZones' === t || 'session' === t ? (s = s || !a) : (i = i || !a),
