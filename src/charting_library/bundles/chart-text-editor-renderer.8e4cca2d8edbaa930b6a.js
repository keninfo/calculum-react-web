;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5592],
  {
    ...
    99514: (e, t, n) => {
      'use strict'
      n.r(t), n.d(t, { closeChartEditorText: () => _, updateChartEditorText: () => p })
      var o = n(50959),
        a = n(32227),
        u = n(50151),
        r = n(77975),
      ...
      function b(e) {
        ...
        const F = S.includes('bold') ? 'b' : '',
          ...
          I = devicePixelRatio <= 2 || devicePixelRatio >= 3 ? devicePixelRatio : devicePixelRatio < 2.5 ? 2 : 2.5,
          $ = v.get(V + F + T + '_' + I),
          z = (0, o.useRef)(null),
          [H, K] = (0, o.useState)(!0)
        return (
          (0, o.useEffect)(() => {
            ...
            return (
              ...
              () => {
                document.removeEventListener('mousemove', e), document.removeEventListener('touchmove', e)
              }
            )
          }, []),
          o.createElement('textarea', {
            ...
            onKeyDown: function (e) {
              ...
              ;(27 === n || (b && 13 === n)) && (null === (t = z.current) || void 0 === t || t.blur())
            },
            onSelect: function (e) {
              const t = e.target
