      ...
      class g extends o.PureComponent {
          ...
          super(e),
            ...
            (this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
              ...
              const C = document.documentElement.clientHeight,
                ...
                M = null !== (n = this.props.closeOnScrollOutsideOffset) && void 0 !== n ? n : 0
              let x = C - 0 - M
              const y = g.height > x
              if (y) {
                ;((0, r.ensureNotNull)(this._scrollWrapRef).style.overflowY = 'scroll'), (g = _.getBoundingClientRect())
              }
              const { width: S, height: W } = g,
                R =
                  'function' == typeof v
                    ? v({ contentWidth: S, contentHeight: W, availableWidth: b, availableHeight: C })
                    : v,
                w =
                  null !==
                    (s = null === (o = null == R ? void 0 : R.indentFromWindow) || void 0 === o ? void 0 : o.left) &&
                  void 0 !== s
                    ? s
                    : 0,
                E =
                  ...
                  (null !==
                    (u = null === (a = null == R ? void 0 : R.indentFromWindow) || void 0 === a ? void 0 : a.right) &&
                  void 0 !== u
                    ? u
                    : 0),
                ...
                N =
                  (null !==
                    (d = null === (c = null == R ? void 0 : R.indentFromWindow) || void 0 === c ? void 0 : c.top) &&
                  void 0 !== d
                    ? d
                    : 0) + M,
                D =
                  ...
                  (null !==
                    (m = null === (p = null == R ? void 0 : R.indentFromWindow) || void 0 === p ? void 0 : p.bottom) &&
                  void 0 !== m
                    ? m
                    : 0)
              let P = (0, l.clamp)(R.y, N, Math.max(N, D))
              if (
                (R.forbidCorrectYCoord && P < R.y && ((x -= R.y - P), (P = R.y)),
                t && void 0 !== this.props.closeOnScrollOutsideOffset && R.y <= this.props.closeOnScrollOutsideOffset)
              )
                return void this._handleGlobalClose(!0)
              const k = null !== (f = R.overrideHeight) && void 0 !== f ? f : y ? x : void 0
              this.setState(
                {
                  appearingMenuHeight: t ? this.state.appearingMenuHeight : k,
                  appearingMenuWidth: t ? this.state.appearingMenuWidth : R.overrideWidth,
        ...
        render() {
          const {
            ...
            { appearingMenuHeight: R, appearingMenuWidth: w, appearingPosition: E, isMeasureValid: O } = this.state,
            N = {
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  o.createElement(
                    'div',
                    {
                      className: i()(_.scrollWrap, !this.props.noMomentumBasedScroll && _.momentumBased),
                      style: { overflowY: void 0 !== R ? 'scroll' : 'auto', maxHeight: b },
            ...
            onMouseOver: function (e) {
              if (
                !(
                  ...
                  ((o = e.target), null === (s = n.current) || void 0 === s ? void 0 : s.contains(o))
                )
              )
                return
              var o, s
