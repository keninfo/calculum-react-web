  ...
  [3005],
  {
    ...
    67842: (e, t, n) => {
      ...
      function a(e, t = []) {
        ...
        const c = (0, i.useFunctionalRefObject)(a),
          u = (0, r.useCallback)(
            (e) => {
              c(e), null !== o.current && (o.current.disconnect(), null !== e && o.current.observe(e))
            },
            [c, o],
          )
        return (
    ...
    9745: (e, t, n) => {
      ...
      const s = r.forwardRef((e, t) => {
        const { icon: n = '', title: s, ariaLabel: i, ariaLabelledby: a, ariaHidden: o, ...l } = e,
          c = !!(s || i || a)
    ...
    70412: (e, t, n) => {
      'use strict'
      n.d(t, { hoverMouseEventFilter: () => i, useAccurateHover: () => a, useHover: () => s })
      var r = n(50959)
      function s() {
    ...
    6190: (e, t, n) => {
      ...
      const d = (0, r.forwardRef)(function (e, t) {
        const { onKeyDown: n, orientation: d, blurOnEscKeydown: h = !0, blurOnClick: m = !0, ...p } = e,
          ...
          r.createElement('div', {
            ...
            onKeyDown: (0, i.createSafeMulticastEventHandler)(function (e) {
              ...
              const n = e.currentTarget,
                r = (0, o.queryFocusableElements)(n).sort(o.navigationOrderComparator)
              ...
              const i = () => {
                  ...
                  ;(0, l.becomeSecondaryElement)(r[s]), (0, l.becomeMainElement)(r[e]), r[e].focus()
                },
                c = () => {
                  const e = (s + r.length + 1) % r.length
                  ;(0, l.becomeSecondaryElement)(r[s]), (0, l.becomeMainElement)(r[e]), r[e].focus()
    ...
    39214: (e, t, n) => {
      ...
      var r = n(50959),
        ...
        f = n(4262)
      function g(e) {
        return r.createElement('div', { className: o()(f.separator, e.className) })
      }
      var S = n(95165)
      function b(e) {
        const {
        ...
        return r.createElement(
          r.Fragment,
          null,
          !c && r.createElement('div', { className: S.separatorWrap }, r.createElement(g, { className: S.separator })),
          r.createElement(
            'div',
            {
              className: a(n, S.group, { [S.noMinimalWidth]: o, [S.noLeftDecoration]: s, [S.noRightDecoration]: i }),
              onClick: l,
            },
            t,
          ),
      ...
      var k = n(61119),
        ...
        F = n(61380),
        O = n(71629)
      const W = { isVisibleScrollbar: !0, shouldMeasure: !0, hideButtonsFrom: 1 }
      function L(e) {
        return r.createElement('div', { className: a(O.fadeLeft, e.className, { [O.isVisible]: e.isVisible }) })
      }
      function N(e) {
        return r.createElement('div', { className: a(O.fadeRight, e.className, { [O.isVisible]: e.isVisible }) })
      }
      function T(e) {
      ...
      function A(e) {
        return r.createElement(
          ...
          r.createElement('div', { className: O.iconWrap }, r.createElement(E.Icon, { icon: F, className: O.icon })),
        )
      }
          ...
          ((o = class extends r.PureComponent {
            constructor(e) {
              super(e),
                ...
                (this._handleResizeContent = ([e]) => {
                  ...
                  const { shouldDecreaseWidthContent: n, buttonsWidthIfDecreasedWidthContent: r } = this.props
                  n && r ? this.setState({ widthContent: t.width + 2 * r }) : this.setState({ widthContent: t.width })
                }),
                (this._handleScroll = () => {
            ...
            render() {
              const {
                ...
                b = d && h
              return r.createElement(y.Measure, { onResize: u ? this._handleResizeWrap : null }, (d) =>
                r.createElement(
                  'div',
                  {
                  ...
                  r.createElement(
                    ...
                    r.createElement(
                      'div',
                      {
                        className: a(O.scrollWrap, v, { [O.noScrollBar]: !o }),
                        onScroll: this._handleScroll,
                        ref: this._scroll,
                      },
                      r.createElement(y.Measure, { onResize: u ? this._handleResizeContent : null }, i),
                    ),
                    l && r.createElement(n, { isVisible: S, className: f }),
                    l && r.createElement(s, { isVisible: g, className: f }),
                    c && r.createElement(e, { onClick: this._handleScrollLeft, isVisible: S }),
                    c && r.createElement(t, { onClick: this._handleScrollRight, isVisible: g }),
                  ),
                ),
              )
            }
        ...
        constructor(e, t) {
          super(e, t),
            (this._handleMouseOver = (e) => {
              ;(0, H.hoverMouseEventFilter)(e) && this.setState({ isHovered: !0 })
            }),
            (this._handleMouseOut = (e) => {
              ;(0, H.hoverMouseEventFilter)(e) && this.setState({ isHovered: !1 })
            }),
              ...
              return e.map((e) =>
                r.createElement(
                  ...
                  ((e) => {
                    switch (e.type) {
                      case 'Button':
                        return r.createElement(s.Custom, { ...e.params, isFake: t })
                      case 'TradingViewStyledButton':
                        return r.createElement(s.CustomTradingViewStyledButton, {
                          ...e.params,
                          className: G.button,
                          displayMode: n,
                        })
                      case 'Dropdown':
                        return r.createElement(s.Dropdown, { displayMode: n, params: e.params })
                      default:
                        return null
                    }
                  })(e),
        ...
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              (c) =>
                r.createElement(
                  ...
                  r.createElement(y.Measure, { onResize: m ? this._handleInnerResize : null }, (c) =>
                    r.createElement(
                      'div',
                      ...
                      r.createElement(
                        ...
                        !o &&
                          r.Children.toArray([
                            ...
                            e.DateRange && r.createElement(b, { key: 'range' }, r.createElement(e.DateRange, null)),
                            e.Intervals &&
                              r.createElement(
                                b,
                                { key: 'intervals' },
                            ...
                            e.AlertReferral &&
                              ...
                              r.createElement(
                                b,
                                { key: 'alert-referral' },
                                r.createElement(e.AlertReferral, { className: G.button, displayMode: n }),
                              ),
                            e.ScalePercentage &&
                              r.createElement(b, { key: 'percentage' }, r.createElement(e.ScalePercentage, null)),
                            e.ScaleLogarithm &&
                              r.createElement(b, { key: 'logarithm' }, r.createElement(e.ScaleLogarithm, null)),
                            ...g,
                          ]),
                        (function (e) {
                          const t = e.findIndex(
                            (e) => r.isValidElement(e) && !!e.key && -1 !== e.key.toString().indexOf('view-only-badge'),
                          )
                          return (
                            [t]
                              .filter((e) => e >= 0)
                                  ...
                                  if (r.isValidElement(e)) {
                                    switch ([t - 1, t, t + 1].indexOf(n)) {
                                      case 0:
                                        ...
                                        break
                                      case 1:
                                        const n = { noLeftDecoration: !0, noRightDecoration: !0 }
                          ...
                          r.Children.toArray([
                            ...
                            !o &&
                              ...
                              r.createElement(
                                b,
                                { key: 'undo-redo' },
                                r.createElement(e.UndoRedo, { id: m ? void 0 : x.UndoRedo }),
                              ),
                            r.createElement(b, {
                              removeSeparator: !0,
                              key: 'gap-1',
                            ...
                            (e.Layout || e.SaveLoad) &&
                              r.createElement(
                                ...
                                !o && e.Layout && r.createElement(e.Layout, { id: m ? void 0 : x.Layouts }),
                                e.SaveLoad &&
                            ...
                            e.SaveLoadReferral &&
                              r.createElement(
                                ...
                                r.createElement(e.SaveLoadReferral, { isReadOnly: o, displayMode: n }),
                              ),
                            t.showLaunchInPopupButton &&
                              e.OpenPopup &&
                              !d.enabled('hide_open_popup_button') &&
                              r.createElement(b, { key: 'popup' }, r.createElement(e.OpenPopup, null)),
                            !o &&
                                ...
                                r.createElement(
                                  ...
                                  !o &&
                                    ...
                                    r.createElement(
                                      ...
                                      r.createElement(e.Fullscreen, { id: m ? void 0 : x.Fullscreen }),
                                    ),
                                  !U &&
                                    e.Screenshot &&
                            ...
                            !o &&
                              ...
                              r.createElement(
                                ...
                                r.createElement(e.Publish, { id: m ? void 0 : x.PublishMobile }),
                              ),
                            ...S,
                          ]),
                        ),
            ...
            e.Publish &&
              ...
              !m &&
              !d.enabled('hide_publish_button') &&
              r.createElement(e.Publish, { id: x.PublishDesktop, className: G.desktopPublish }),
          )
        }
      ...
      ;(Q.contextType = X),
        (function (e) {
          ;(e[(e.Left = 0)] = 'Left'), (e[(e.Self = 1)] = 'Self'), (e[(e.Right = 2)] = 'Right')
        })(Y || (Y = {}))
      var K = n(64147),
        j = n(59063)
      ...
      class le {
        ...
        add(e, t, n) {
          ...
          return this._isIntervalDefault(r) || s.includes(r)
            ? null
            : (this._customIntervalsService.set((0, $.sortResolutions)([...s, r])), r)
        }
        remove(e) {
      ...
      class me {
        ...
        addFavorite(e) {
          const t = this.favId(e)
          this._favorites.push(ve(t)), this._favoritesChanged.fire(t), this._saveFavs()
        }
        removeFavorite(e) {
          const t = this.favId(e),
            n = this._findFavIndex(t)
          ;-1 !== n && (this._favorites.splice(n, 1), this._favoritesChanged.fire(t)), this._saveFavs()
        }
        favId(e) {
          return ue(e)
        }
      ...
      function ve(e) {
        return isPineIdString(e) ? { type: 'pine', pineId: e } : { type: 'java', studyId: e }
      }
      var fe = n(85049)
      const ge = {
      ...
      class Se extends j.CommonJsonStoreService {
        constructor(e, t, n = ge) {
          super(e, t, 'INTERVALS_MENU_VIEW_STATE_CHANGED', 'IntervalWidget.menu.viewState', n)
        }
        isAllowed(e) {
      ...
      function Ee(e = []) {
        return (0, $.mergeResolutions)(e, d.enabled('star_some_intervals_by_default') ? ye : [])
      }
      ...
      class ke extends r.PureComponent {
        constructor(e) {
          ...
          this._favoriteChartStylesService = h || new J(se.TVXWindowEvents, re, y)
          const C = Ee(this.props.defaultFavoriteIntervals)
          ;(this._favoriteIntervalsService = l || new ee(se.TVXWindowEvents, re, C)),
            (this._intervalsMenuViewStateService = new Se(se.TVXWindowEvents, re)),
        ...
        componentDidUpdate(e, t) {
          ...
          n !== t.isVisible && (h.emit('toggle_header', n), this._negotiateResizer()), r || this._setDisplayMode()
        }
        render() {
          const { resizerBridge: e, allowedModes: t, ...n } = this.props,
            { displayMode: s, isVisible: o, leftCustomElements: l, rightCustomElements: c } = this.state,
            u = {
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                'div',
                { className: a(Me.toolbar, { [Me.isHidden]: !o }), onClick: this.props.onClick },
                r.createElement(
                  'div',
        ...
        updateDropdown(e, t) {
          const n = (t) => 'Dropdown' === t.type && t.id === e,
            r = this.state.leftCustomElements.find(n) || this.state.rightCustomElements.find(n)
          void 0 !== r &&
            ((r.params = { ...r.params, ...t }),
            this.setState({
        ...
        _setDisplayMode() {
          const { availableWidth: e } = this.state,
            ...
            n = { full: this._fullWidth, medium: this._favoritesWidth, small: this._collapseWidth },
        ...
        _addCustomHTMLButton(e, t = 'left') {
          const n = new K.WatchedValue(0),
            r = (0, we.parseHtmlElement)(`<div class="apply-common-tooltip ${Me.customButton}">`),
            s = { type: 'Button', id: e, params: { key: Number(new Date()), element: r, width: n } }
      ...
      class Ie {
        constructor(e, t) {
          ;(this._component = null),
            ...
            (this._container = e),
            s.render(r.createElement(ke, { ...t, ref: this._handleRef }), this._container)
        }
        destroy() {
    ...
    77151: (e, t, n) => {
      'use strict'
      n.d(t, { RegistryProvider: () => l, registryContextType: () => c, validateRegistry: () => o })
      var r = n(50959),
        s = n(19036),
        i = n.n(s)
