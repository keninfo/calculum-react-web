;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4804],
  {
    ...
    94720: (e, t, n) => {
      ...
      function y(e) {
        const { startIcon: t, icon: n, iconOnly: r, children: s, endIcon: o, primaryText: i, secondaryText: a } = e,
          l = null != t ? t : n,
          d = !(t || n || o || r) && !s && i && a
        return c.createElement(
          ...
          o && !r && c.createElement(p.Icon, { icon: o, className: m().endIconWrap }),
          d &&
            (function (e) {
              return (
                e.primaryText &&
                ...
                c.createElement(
                  ...
                  c.createElement('span', { className: m().primaryText }, ' ', e.primaryText, ' '),
                  'string' == typeof e.secondaryText
                    ? c.createElement('span', { className: m().secondaryText }, ' ', e.secondaryText, ' ')
                    : c.createElement(
                        'span',
      ...
      function C(e) {
        ...
        return { ...h, ...(0, b.filterDataProps)(e), ...(0, b.filterAriaProps)(e) }
      }
      function R(e) {
        const { reference: t, tooltipText: n, ...r } = e,
          { isGrouped: s, cellState: o, disablePositionAdjustment: i } = (0, c.useContext)(w.ControlGroupContext),
          a = f({ ...r, isGrouped: s, cellState: o, disablePositionAdjustment: i })
        return c.createElement(
          'button',
          {
            ...C(r),
      ...
      n(78572)
      function x(e) {
        const { intent: t, size: n, appearance: r, useFullWidth: s, icon: o, ...c } = e
        return { ...c, color: a(t), size: l(n), variant: i(r), stretch: s, startIcon: o }
      }
      function D(e) {
    ...
    64388: (e, t, n) => {
      ...
      var r = n(50959),
        ...
        i = (n(78572), n(36136))
      function a(e) {
        const { size: t = 'large', preservePaddings: n, isLink: r, flipIconOnRtl: o, className: a } = e
        return s(i['nav-button'], i[`size-${t}`], n && i['preserve-paddings'], o && i['flip-icon'], r && i.link, a)
      }
      function l(e) {
        ...
        return r.createElement(
          ...
          r.createElement(o.Icon, { icon: n, className: i.icon, 'aria-hidden': !0 }),
          t && r.createElement('span', { className: i['visually-hidden'] }, t),
        )
      }
      const c = (0, r.forwardRef)((e, t) => {
        const { icon: n, type: s = 'button', preservePaddings: o, flipIconOnRtl: i, size: c, 'aria-label': u, ...d } = e
        return r.createElement(
          'button',
      ...
      ;(0, r.forwardRef)((e, t) => {
        ...
        return r.createElement(
          c,
          { ...i, className: a({ ...e, children: o, isLink: !0 }), reference: (0, d.isomorphicRef)(t) },
    ...
    67029: (e, t, n) => {
      ...
      function y(e, t) {
        const {
          ...
          { isGrouped: E, cellState: _, disablePositionAdjustment: N = !1 } = (0, r.useContext)(l.ControlGroupContext),
          z = (function (e, t = null, n) {
            ...
            return (0, r.useEffect)(() => ((o.current = [e, t, n]), i(), a), [e, t, n]), l
          })('wheel', P, f)
        return r.createElement(
          'span',
          {
    ...
    78274: (e, t, n) => {
      ...
      function a(e) {
        ...
        return r.createElement('span', { className: s(i()['inner-slot'], n && i().interactive, o && i().icon, t) }, a)
      }
      function l(e) {
        const { className: t, children: n } = e
        return r.createElement('span', { className: s(i()['inner-slot'], i()['inner-middle-slot'], t) }, n)
      }
      function c(e) {
        const { className: t, interactive: n = !0, icon: o = !1, children: a } = e
        return r.createElement('span', { className: s(i()['inner-slot'], n && i().interactive, o && i().icon, t) }, a)
      ...
      function u(e) {
        const { className: t, children: n } = e
        return r.createElement('span', { className: s(i()['after-slot'], t) }, n)
      }
    },
    31261: (e, t, n) => {
      'use strict'
        ...
        return r.createElement(p.ControlSkeleton, {
          ...
          middleSlot: r.createElement(
            ...
            r.createElement('input', {
              ...K,
              className: s(g().input, g()[`size-${I}`], M, F && g()['with-start-slot'], L && g()['with-end-slot']),
              disabled: O,
              readOnly: U,
              ref: A,
            }),
      ...
      function v(e) {
        ...
        const {
          ...
          b = t ? void 0 : v ? -1 : s,
          C = t ? void 0 : v ? s : -1,
          { isMouseDown: R, handleMouseDown: x, handleMouseUp: D } = (0, d.useIsMouseDown)(),
          ...
          E = (0, r.useCallback)(
            (e) => {
              ;(g.current = e), h && ('function' == typeof h && h(e), 'object' == typeof h && (h.current = e))
            },
            [g, h],
          )
    ...
    26996: (e, t, n) => {
      ...
      var r,
        ...
        a = n.n(i)
      function l(e) {
        const { className: t, size: n = 'medium', staticPosition: r, color: i = 'black' } = e,
          l = o(a().item, a()[i], a()[n])
      ...
      class m extends o.PureComponent {
        constructor(e) {
          if (
            ...
            (this._handleKeyDown = (e) => {
              ...
              const { allowUserDefinedValues: t, value: n, onChange: s, onSuggestionsOpen: o } = this.props,
              ...
              switch (e.which) {
                ...
                case r.Enter:
                  ...
                  t && (a && m ? this.setState(this._valueToQuery(m)) : (m = l)),
                    void 0 !== m &&
                      (this._close(), a || this._blur(), m !== n ? s && s(m) : this.setState(this._valueToQuery(m)))
              }
            }),
        ...
        render() {
          return o.createElement(u.OutsideEvent, { handler: this._handleOutsideClick, click: !0 }, (e) =>
            o.createElement(
              'div',
              { className: i(p.autocomplete, 'js-dialog-skip-escape'), ref: e },
              o.createElement(c.InputControl, {
                ...
                endSlot: Object.keys(this._suggestions(this.state.queryValue)).length
                  ? o.createElement(
                      ...
                      o.createElement(
                        'span',
                        { className: p.caret, onClick: this._handleCaretClick, tabIndex: -1 },
                        o.createElement(a.ToolWidgetCaret, { className: p.icon, dropped: this.state.isOpened }),
                      ),
                    )
                  : void 0,
        ...
        _renderSuggestionsItems() {
          const e = this._suggestions(this.state.queryValue),
            ...
            r = o.createElement('li', { className: p.noResults }, s.t(null, void 0, n(85888)))
    ...
    10381: (e, t, n) => {
      ...
      function l(e) {
        ...
        return r.createElement(o.Icon, { className: s(n, i.icon, { [i.dropped]: t }), icon: a })
      }
    },
    4237: (e, t, n) => {
      'use strict'
