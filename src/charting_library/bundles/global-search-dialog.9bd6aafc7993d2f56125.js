  ...
  [9754, 1754, 9685, 361],
  {
    ...
    89324: (e, t, o) => {
      ...
      function h(e) {
        ...
        const t = (0, i.getSymbolSearchCompleteOverrideFunction)(),
          { defaultValue: o, showSpreadActions: r, source: h, onSearchComplete: c, trackResultsOptions: d, ...v } = e,
          u = {
            ...v,
            ...
            onSearchComplete: (e, o) => {
              ...
              t(e[0].symbol, e[0].result).then((e) => {
                l.linking.setSymbolAndLogInitiator(e.symbol, 'symbol search'), null == c || c(e.symbol)
              })
            },
    ...
    1861: (e, t, o) => {
      ...
      function r(e) {
        ...
        function D() {
          R.unmount(), i.dialogsOpenerManager.setAsClosed('SymbolSearch'), b && b()
        }
        return i.dialogsOpenerManager.setAsOpened('SymbolSearch'), y && y(), { close: D }
      }
    },
    71043: (e, t, o) => {
      'use strict'
      ...
      var _ = o(39274)
      function H(e) {
        const { heading: t, selectedId: o, items: n, activeElRef: i, onExecute: a } = e
        return l.createElement(
          'table',
          { className: _.section },
          l.createElement(
            'tbody',
            null,
            l.createElement('tr', null, l.createElement('td', { className: _.heading }, t)),
            n.map((e) =>
              l.createElement(E, {
                key: e.id,
                action: e,
        ...
        const { dialogId: t, items: n, onClose: i, shouldReturnFocus: v } = e,
          ...
          { activeIdx: x, setActiveIdx: M } = (0, S.useKeyboardNavigation)(
            ...
            function (e, t) {
              t.preventDefault()
              const o = m[x]
              o && !o.isDisabled() && (o.execute(), o.isCheckable() ? A() : i())
            },
            'keyup',
          )
                ...
                u
                  ? l.createElement(
                      ...
                      m.length
                        ...
                        : l.createElement(b, { text: s.t(null, void 0, o(47202)), className: P.emptyState }),
                    )
                  : l.createElement(
                      l.Fragment,
                      null,
      ...
      !(function (e) {
        ;(e.Drawings = 'drawingsActions'), (e.Function = 'functionActions'), (e.Settings = 'settingsActions')
      })(V || (V = {}))
      class W extends B.Action {
        constructor({
          ...
          super({ actionId: 'UnknownAction', options: { ...h, doNotCloseOnClick: !0 }, id: e, optionsLoader: s }),
            (this.execute = () => {
              super.execute()
              const e = new Set(r.getJSON('GlobalSearchDialog.recent', [])),
                t = this._searchOptions.id
              e.has(t) && e.delete(t), e.add(t), r.setJSON('GlobalSearchDialog.recent', Array.from(e).slice(-10))
            }),
            (this.getState = () => ({
              ...super.getState(),
            ...
            (this._onFavouriteClick = (e) => {
              this._searchOptions.onFavouriteClick &&
                (this.update({ favourite: !this._searchOptions.favourite }), this._searchOptions.onFavouriteClick(e))
            }),
            (this._searchOptions = { id: e, category: t, favourite: o, onFavouriteClick: l, aliases: a })
        }
      }
      var N,
        K = o(45126),
      ...
      const X = (e) => {
              ...
              t.forEach((t) => {
                l.push(
                  new W({
                    ...
                    onExecute: () => {
                      J.loadTheme(e.chartWidgetCollection(), { themeName: t, standardTheme: !1 }).then(() => {
            ...
            l.push(
              new W({
                ...
                onExecute: () => {
                  ...
                  J.loadTheme(e.chartWidgetCollection(), { themeName: o, standardTheme: !0 }).then(() => {
                    e.readOnly() || window.saver.saveChartSilently()
                  })
                },
              }),
        ...
        return window.is_authenticated ? J.getThemeNames().then(t) : Promise.resolve(t())
      }
      var ee = o(928),
        te = o(81171)
      o(55917)
      ...
      const { DrawingSyncMode: ie } = ee,
        ...
        se = new K.TranslatedString('stay in drawing mode', s.t(null, void 0, o(4114))),
        re = new K.TranslatedString('sync drawings', s.t(null, void 0, o(94521))),
        he = s.t(null, void 0, o(62518)),
        ce = s.t(null, void 0, o(23391)),
        de = (s.t(null, void 0, o(93027)), s.t(null, void 0, o(3521)), s.t(null, void 0, o(79451))),
      ...
      class we extends W {
        constructor(e) {
          super({
            ...
            (this._model = e)
          ;(this._props = this._model.mainSeries().priceScale().properties().childs().isInverted).subscribe(
            this,
            () => {
      ...
      class fe extends W {
        constructor(e) {
          super({
            ...
            disabled:
              e.mainSeries().priceScale().isLockScale() || 6 === e.mainSeries().properties().childs().style.value(),
            checked: e.mainSeries().priceScale().isPercentage(),
          }),
            (this._model = e)
          ;(this._props = this._model.mainSeries().priceScale().properties().childs().percentage).subscribe(
            this,
            () => {
              this._onUpdate.fire(this)
            },
      ...
      const Se = O.enabled('show_average_close_price_line_and_label'),
        Te = new K.TranslatedString('change session', s.t(null, void 0, o(87041))),
        Le = new K.TranslatedString('change plus button visibility', s.t(null, void 0, o(96379))),
        xe = new K.TranslatedString('change countdown to bar close visibility', s.t(null, void 0, o(39383))),
        Me = new K.TranslatedString('scale price chart only', s.t(null, void 0, o(63796))),
        Ce = new K.TranslatedString('change symbol last value visibility', s.t(null, void 0, o(67453))),
        Ae = new K.TranslatedString('change high and low price labels visibility', s.t(null, void 0, o(24226))),
        ze = new K.TranslatedString('change average close price label visibility', s.t(null, void 0, o(76852))),
        ...
        _e = new K.TranslatedString('change high and low price lines visibility', s.t(null, void 0, o(80692))),
        He = new K.TranslatedString('change average close price line visibility', s.t(null, void 0, o(1022))),
        Pe = new K.TranslatedString('change symbol labels visibility', s.t(null, void 0, o(73357))),
        Re =
          (new K.TranslatedString('change pre/post market price label visibility', s.t(null, void 0, o(30870))),
          new K.TranslatedString('change symbol previous close value visibility', s.t(null, void 0, o(4729))),
          new K.TranslatedString('change previous close price line visibility', s.t(null, void 0, o(58419)))),
        De =
          (new K.TranslatedString('change bid and ask labels visibility', s.t(null, void 0, o(69362))),
          new K.TranslatedString('change bid and ask lines visibility', s.t(null, void 0, o(52919))),
          new K.TranslatedString('change pre/post market price lines visibility', s.t(null, void 0, o(91978))),
          new K.TranslatedString('change price line visibility', s.t(null, void 0, o(8662)))),
        Ve = new K.TranslatedString('change session breaks visibility', s.t(null, void 0, o(38413))),
        Ie =
          (new K.TranslatedString('change ideas visibility on chart', s.t(null, void 0, o(13489))),
          new K.TranslatedString('show all ideas', s.t(null, void 0, o(13336))),
          new K.TranslatedString('show ideas of followed users', s.t(null, void 0, o(91395))),
          new K.TranslatedString('show my ideas only', s.t(null, void 0, o(57460))),
          new K.TranslatedString('change events visibility on chart', s.t(null, void 0, o(6119))),
          new K.TranslatedString('change earnings visibility', s.t(null, void 0, o(6819))),
          new K.TranslatedString('change dividends visibility', s.t(null, void 0, o(53929))),
          new K.TranslatedString('change splits visibility', s.t(null, void 0, o(47474))),
          {
      ...
      async function Fe(e) {
        ...
        const v = [],
          ...
          m = ((e) => {
            const t = [],
              { stayInDrawingMode: o, drawOnAllCharts: l, drawOnAllChartsMode: n } = ee.properties().childs()
            t.push(
              new W({
                label: he,
                checkable: !0,
            ...
            return (
              ...
              t.push(
                new W({
                  ...
                  id: 'StrongMagnet',
                  category: 'functionActions',
                  checked: s.value() && r.value() === oe.MagnetMode.StrongMagnet,
              ...
              O.enabled('header_widget') &&
                ...
                t.push(
                  new W({
                    ...
                    category: 'functionActions',
                    onExecute: () => {
                      ;(0, pe.showDefaultSearchDialog)({ defaultValue: '', trackResultsOptions: void 0 })
                    },
                  }),
                ),
        ...
        const w = e.model().mainSeries(),
          ...
          y = null === (l = (t = e.model()).paneForSource) || void 0 === l ? void 0 : l.call(t, w)
        v.push(
          new W({
            id: 'ResetPriceScale',
            category: 'functionActions',
        ...
        v.push(
          new W({
            ...
            category: 'functionActions',
            disabled: Boolean('regular' === (null === (n = w.symbolInfo()) || void 0 === n ? void 0 : n.subsession_id)),
            onExecute: () => {
              e.model().setProperty(b.sessionId, 'regular', Te)
            },
            checked: Boolean('regular' === (null === (i = w.symbolInfo()) || void 0 === i ? void 0 : i.subsession_id)),
          }),
        ),
          v.push(
            new W({
              ...
              category: 'functionActions',
              disabled: !(null === (r = null === (a = w.symbolInfo()) || void 0 === a ? void 0 : a.subsessions) ||
              void 0 === r
                ? void 0
              ...
              onExecute: () => {
                var t
                const o =
                  'extended' === (null === (t = w.symbolInfo()) || void 0 === t ? void 0 : t.subsession_id)
                    ? 'regular'
                    : 'extended'
                e.model().setProperty(b.sessionId, o, Te)
              },
              checked: Boolean(
                'extended' === (null === (c = w.symbolInfo()) || void 0 === c ? void 0 : c.subsession_id),
              ),
            }),
          ),
          v.push(
        ...
        v.push(
          new W({
            label: x ? s.t(null, void 0, o(26493)) : s.t(null, void 0, o(40789)),
            id: 'MoveScaleToSide',
            category: 'functionActions',
          ...
          v.push(
            new W({
              ...
              category: 'settingsActions',
              onExecute: () => {
                e.model().setProperty(U.addPlusButtonProperty, !U.addPlusButtonProperty.value(), Le)
              },
            }),
          )
        ...
        v.push(
          new W({
            ...
            onExecute: () => {
              e.model().setProperty(k.highLowPriceLabelsVisible, !k.highLowPriceLabelsVisible.value(), Ae)
            },
          }),
        ),
          Se &&
        ...
        v.push(
          ...
          v.push(
            new W({
              ...
              onExecute: () => {
                e.model().setProperty(k.highLowPriceLinesVisible, !k.highLowPriceLinesVisible.value(), _e)
              },
            }),
          ),
          Se &&
        ...
        let V
        const F = (0, q.createWVFromProperty)(e.model().mainSeries().isDWMProperty()),
          B = new W({
            ...
            optionsLoader: async () => {
              ...
              return (
                (V = e.properties().childs().graphics.childs().vertlines.childs().sessBreaks.childs().visible),
          ...
          for (const o of t)
            v.push(
              new W({
                id: `ChartStyle_${o}`,
                category: 'functionActions',
                disabled: !(null === (d = I.linking.supportedChartStyles.value()) || void 0 === d
                  ? void 0
                  : d.includes(o)),
                onExecute: () => {
        ...
        return Be.lineToolsFlat.map((e) =>
          (function (e) {
            ...
            const l = Oe.lineToolsInfo[e],
              n = null === (t = l.selectHotkey) || void 0 === t ? void 0 : t.hash,
              i = {
                id: e,
            ...
            return e.toLowerCase().includes('fib') && (i.aliases = [s.t(null, void 0, o(26578))]), new W(i)
          })(e.name),
        )
      }
      var Ne = o(37404)
      ...
      function Ke(e, t) {
        ...
        return o === l ? 0 : 'drawingsActions' === l ? 1 : 'drawingsActions' === o || 'functionActions' === o ? -1 : 1
      }
      var Ge = o(16216),
        Ue = o(28124)
      class qe extends i.DialogRenderer {
        constructor(e) {
          super(),
            ...
            (this.show = (e) => {
              this.visible().value() ||
                (async function (e, t) {
                  ...
                  if (O.enabled('header_widget') && O.enabled('header_resolutions')) {
                    const t = {
                      label: (0, Z.appendEllipsis)(s.t(null, void 0, o(2569))),
                      id: 'ChangeInterval',
                      category: 'functionActions',
                      onExecute: () => {
                        ;(0, F.showChangeIntervalDialogAsync)({ initVal: I.linking.interval.value(), selectOnInit: !0 })
                      },
                    }
                  ...
                  if (t && O.enabled('header_widget') && O.enabled('header_saveload')) {
                    l.push(
                      new W({
                        id: 'LoadChartLayout',
                        category: 'functionActions',
                        ...
                        shortcutHint: s.t(null, { context: 'hotkey' }, o(23821)),
                      }),
                    )
                    ...
                    n &&
                      (l.push(
                        new W({
                          ...
                          category: 'functionActions',
                          label: (0, Z.appendEllipsis)(s.t(null, void 0, o(38206))),
                          onExecute: () => {
                            n.renameChart()
                          },
                        }),
                      ...
                      l.push(
                        new W({
                          ...
                          category: 'functionActions',
                          icon: o(53707),
                          label: (0, Z.appendEllipsis)(s.t(null, void 0, o(41569))),
                    ...
                    .concat(
                      (() => {
                        const e = new W({
                          ...
                          category: 'functionActions',
                          icon: o(81111),
                          label: (0, Z.appendEllipsis)(s.t(null, void 0, o(81031))),
            ...
            (this.hide = () => {
              var e
              null === (e = this._rootInstance) || void 0 === e || e.unmount(), this._setVisibility(!1)
              for (const e of this._actions) e.destroy()
            })
          const t = (0, Ge.service)(n.CHART_WIDGET_COLLECTION_SERVICE)
          ;(this._activeChartWidget = t.activeChartWidget.value()), (this._loadChartService = e)
        }
      }
    },
    63651: (e, t, o) => {
      ...
      function i(e, t, o, i = 'keydown') {
        ...
        return (
          ...
          (0, l.useEffect)(() => {
            ...
            const l = (e) => {
              var l
              e.repeat || (13 === (0, n.hashFromEvent)(e) && o(null !== (l = t[a]) && void 0 !== l ? l : null, e))
            }
            return (
    ...
    98715: (e, t, o) => {
      ...
      function n(e, t) {
        ;(0, l.useEffect)(() => {
          var o
          t >= 0 && (null === (o = e.current) || void 0 === o || o.scrollIntoView({ block: 'nearest' }))
        }, [t])
      }
    },
    37404: (e, t, o) => {
      ...
      let l = null
      function n(e) {
        return Promise.all([o.e(4166), o.e(8316), o.e(6220), o.e(291), o.e(1702)])
          .then(o.bind(o, 41662))
          .then((t) => {
      ...
      class f extends l.PureComponent {
          ...
          super(e),
            ...
            (this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
              ...
              const b = document.documentElement.clientHeight,
                ...
                S = null !== (o = this.props.closeOnScrollOutsideOffset) && void 0 !== o ? o : 0
              let T = b - 0 - S
              const L = f.height > T
              if (L) {
                ;((0, a.ensureNotNull)(this._scrollWrapRef).style.overflowY = 'scroll'), (f = w.getBoundingClientRect())
              }
              const { width: x, height: M } = f,
                C =
                  'function' == typeof p
                    ? p({ contentWidth: x, contentHeight: M, availableWidth: y, availableHeight: b })
                    : p,
                A =
                  null !==
                    (n = null === (l = null == C ? void 0 : C.indentFromWindow) || void 0 === l ? void 0 : l.left) &&
                  void 0 !== n
                    ? n
                    : 0,
                z =
                  ...
                  (null !==
                    (h = null === (r = null == C ? void 0 : C.indentFromWindow) || void 0 === r ? void 0 : r.right) &&
                  void 0 !== h
                    ? h
                    : 0),
                ...
                E =
                  (null !==
                    (d = null === (c = null == C ? void 0 : C.indentFromWindow) || void 0 === c ? void 0 : c.top) &&
                  void 0 !== d
                    ? d
                    : 0) + S,
                _ =
                  ...
                  (null !==
                    (g = null === (u = null == C ? void 0 : C.indentFromWindow) || void 0 === u ? void 0 : u.bottom) &&
                  void 0 !== g
                    ? g
                    : 0)
              let H = (0, s.clamp)(C.y, E, Math.max(E, _))
              if (
                (C.forbidCorrectYCoord && H < C.y && ((T -= C.y - H), (H = C.y)),
                t && void 0 !== this.props.closeOnScrollOutsideOffset && C.y <= this.props.closeOnScrollOutsideOffset)
              )
                return void this._handleGlobalClose(!0)
              const P = null !== (m = C.overrideHeight) && void 0 !== m ? m : L ? T : void 0
              this.setState(
                {
        ...
        render() {
          const {
            ...
            { appearingMenuHeight: C, appearingMenuWidth: A, appearingPosition: z, isMeasureValid: k } = this.state,
            E = {
              ...
              l.createElement(
                ...
                l.createElement(
                  ...
                  l.createElement(
                    'div',
                    {
                      className: i()(w.scrollWrap, !this.props.noMomentumBasedScroll && w.momentumBased),
                      style: { overflowY: void 0 !== C ? 'scroll' : 'auto', maxHeight: y },
            ...
            onMouseOver: function (e) {
              if (
                !(
                  ...
                  ((l = e.target), null === (n = o.current) || void 0 === n ? void 0 : n.contains(l))
                )
              )
                return
              var l, n
    ...
    59511: (e, t, o) => {
      'use strict'
      o.d(t, { isLineToolsGroupWithSections: () => r, lineTools: () => s, lineToolsFlat: () => h })
      var l = o(11542),
        n = o(49483),
        i = o(56570),
        a = o(37265)
      const s = [
        {
          ...
          items: [{ name: 'cursor' }, { name: 'dot' }, { name: 'arrow' }, { name: 'eraser' }, null].filter(
            a.isExistent,
          ),
          trackLabel: null,
        },
        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              items: [{ name: 'LineToolCircleLines' }, { name: 'LineToolTimeCycles' }, { name: 'LineToolSineLine' }],
            },
          ],
          trackLabel: null,
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              items: [{ name: 'LineToolAnchoredVWAP' }, { name: 'LineToolFixedRangeVolumeProfile' }, null].filter(
                a.isExistent,
              ),
            },
            {
        ...
        },
        {
          ...
          sections: [
            { title: l.t(null, void 0, o(65695)), items: [{ name: 'LineToolBrush' }, { name: 'LineToolHighlighter' }] },
            {
        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              items: [
                !(0, n.onWidget)() && i.enabled('image_drawingtool') ? { name: 'LineToolImage' } : null,
                null,
                null,
              ].filter(a.isExistent),
            },
    ...
    2627: (e, t, o) => {
      ...
      const v = (0, c.humanReadableModifiers)(c.Modifiers.Shift, !1),
        ...
        f = {
          ...
          LineToolGannFixed: {},
          LineToolGannFan: {},
          LineToolGannSquare: { hotKey: (0, i.hotKeySerialize)({ keys: [v], text: n.t(null, void 0, o(83042)) }) },
          LineToolHeadAndShoulders: {},
          LineToolHorzLine: { hotKey: (0, i.hotKeySerialize)({ keys: [u, 'H'], text: '{0} + {1}' }) },
          LineToolHorzRay: {},
          LineToolIcon: {},
          LineToolImage: {},
          LineToolEmoji: {},
          ...
          LineToolProjection: {},
          LineToolRay: {},
          LineToolRectangle: { hotKey: (0, i.hotKeySerialize)({ keys: [v], text: n.t(null, void 0, o(10539)) }) },
          LineToolCircle: {},
          ...
          LineToolVertLine: { hotKey: (0, i.hotKeySerialize)({ keys: [u, 'V'], text: '{0} + {1}' }) },
          LineToolCrossLine: {},
          LineToolHighlighter: {},
          LineToolGhostFeed: {},
          ...
          hideAllDrawings: {
            ...
            hotKey: (0, i.hotKeySerialize)({ keys: [g, u, 'H'], text: '{0} + {1} + {2}' }),
          },
          lockAllDrawings: { iconActive: s.drawingToolsIcons.lockAllDrawingsActive },
          magnet: { hotKey: (0, i.hotKeySerialize)({ keys: [g], text: '{0}' }) },
          measure: { hotKey: (0, i.hotKeySerialize)({ keys: [v], text: n.t(null, void 0, o(92949)) }) },
      ...
      Object.entries(f)
        .map(([e, t]) => {
          var o, n
          const i = null !== (o = a.lineToolsIcons[e]) && void 0 !== o ? o : s.drawingToolsIcons[e]
          ;(0, l.assert)(!!i, `Icon is not defined for drawing "${e}"`)
          const c = null !== (n = h.lineToolsLocalizedNames[e]) && void 0 !== n ? n : r[e]
          ;(0, l.assert)(!!c, `Localized name is not defined for drawing "${e}"`)
          return { ...t, name: e, icon: i, localizedName: c, selectHotkey: d.lineToolsSelectHotkeys[e] }
        })
        .forEach((e) => {
          b[e.name] = e
        })
    ...
    23076: (e, t, o) => {
      ...
      var l = o(94670),
        ...
        u = o(71705),
        g = o(9450)
      const m = { 3: l, 16: n, 0: i, 1: a, 8: s, 9: r, 2: h, 14: c, 15: d, 10: v, 12: u, 13: g }
    },
    26744: (e, t, o) => {
      'use strict'
      ...
      !(function (e) {
        function t() {
          ...
          e.favorites = []
          let r = !1
          const h = Boolean(void 0 === (0, i.getValue)('chart.favoriteDrawings')),
            c = (0, i.getJSON)('chart.favoriteDrawings', [])
          if (0 === c.length && h && 'undefined' != typeof window) {
            const e = JSON.parse(
              null !== (l = null === (t = window.urlParams) || void 0 === t ? void 0 : t.favorites) && void 0 !== l
                ? l
                : '{}',
            ).drawingTools
          ...
          ;(e.favoriteAdded = new l.Delegate()),
            ...
            (e.addFavorite = function (o, l) {
              return (
                ...
                (r.favorites.push(o), r.saveFavorites(l), e.favoriteAdded.fire(o), !0)
              )
            }),
