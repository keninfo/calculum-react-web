  ...
  [1584],
  {
    ...
    36383: (e, t, n) => {
      ...
      var i = n(50959),
        ...
        r = n(27267)
      function s(e) {
        const { click: t, mouseDown: n, touchEnd: s, touchStart: l, handler: a, reference: u } = e,
          c = (0, i.useRef)(null),
          d = (0, i.useRef)('undefined' == typeof window ? 0 : new window.CustomEvent('timestamp').timeStamp)
        return (
          (0, o.useIsomorphicLayoutEffect)(() => {
    ...
    9745: (e, t, n) => {
      ...
      const o = i.forwardRef((e, t) => {
        const { icon: n = '', title: o, ariaLabel: r, ariaLabelledby: s, ariaHidden: l, ...a } = e,
          u = !!(o || r || s)
      ...
      const i = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            null === (t = n.parentNode) || void 0 === t || t.removeChild(n), (e = o - s)
          }
          return e
        }
      })()
      ...
      function u(e) {
        ...
        if (e && 1 == ++l) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (o(n, 'right', `${i()}px`), (t.style.paddingRight = `${l + i()}px`), (a = !0)),
            t.classList.add('i-no-scroll')
        } else if (!e && l > 0 && 0 == --l && (t.classList.remove('i-no-scroll'), a)) {
          o(n, 'right', '0px')
          let e = 0
          0, t.scrollHeight <= t.clientHeight && (e -= i()), (t.style.paddingRight = (e < 0 ? 0 : e) + 'px'), (a = !1)
        }
      }
    },
    90692: (e, t, n) => {
      ...
      class g extends i.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
              ...
              const C = g.height > x
              if (C) {
                ;((0, s.ensureNotNull)(this._scrollWrapRef).style.overflowY = 'scroll'), (g = _.getBoundingClientRect())
              }
              const { width: E, height: S } = g,
                M =
                  'function' == typeof v
                    ? v({ contentWidth: E, contentHeight: S, availableWidth: w, availableHeight: y })
                    : v,
                R =
                  null !==
                    (o = null === (i = null == M ? void 0 : M.indentFromWindow) || void 0 === i ? void 0 : i.left) &&
                  void 0 !== o
                    ? o
                    : 0,
                W =
                  ...
                  (null !==
                    (u = null === (a = null == M ? void 0 : M.indentFromWindow) || void 0 === a ? void 0 : a.right) &&
                  void 0 !== u
                    ? u
                    : 0),
                ...
                N =
                  (null !==
                    (d = null === (c = null == M ? void 0 : M.indentFromWindow) || void 0 === c ? void 0 : c.top) &&
                  void 0 !== d
                    ? d
                    : 0) + b,
                D =
                  ...
                  (null !==
                    (m = null === (p = null == M ? void 0 : M.indentFromWindow) || void 0 === p ? void 0 : p.bottom) &&
                  void 0 !== m
                    ? m
                    : 0)
              let T = (0, l.clamp)(M.y, N, Math.max(N, D))
              if (
                (M.forbidCorrectYCoord && T < M.y && ((x -= M.y - T), (T = M.y)),
              ...
              const F = null !== (f = M.overrideHeight) && void 0 !== f ? f : C ? x : void 0
              this.setState(
                {
        ...
        render() {
          const {
            ...
            { appearingMenuHeight: M, appearingMenuWidth: R, appearingPosition: W, isMeasureValid: O } = this.state,
            N = {
              ...
              i.createElement(
                ...
                i.createElement(
                  ...
                  i.createElement(
                    'div',
                    {
                      className: r()(_.scrollWrap, !this.props.noMomentumBasedScroll && _.momentumBased),
                      style: { overflowY: void 0 !== M ? 'scroll' : 'auto', maxHeight: w },
            ...
            onMouseOver: function (e) {
              if (
                !(
                  ...
                  ((i = e.target), null === (o = n.current) || void 0 === o ? void 0 : o.contains(i))
                )
              )
                return
              var i, o
      ...
      function r(e, t) {
        return class extends i.PureComponent {
          render() {
            ...
            return 'parent' === r ? s : i.createElement(o.Portal, { shouldTrapFocus: t }, s)
          }
        }
      }
    },
      ...
      class a extends i.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            o.createPortal(i.createElement(u.Provider, { value: this }, this.props.children), e)
          )
        }
        moveToTop() {
        ...
        show(e) {
          this._onShow && this._onShow(),
            ...
            this._render({
              ...
              position: (t) => {
                var n, i, o, r, l, a, u
                const { contentWidth: c, contentHeight: d, availableWidth: h, availableHeight: p } = t
                let m
                if (void 0 !== e.box) m = e.box
                else {
                  m = {
                    x:
                      null !== (i = null === (n = e.touches) || void 0 === n ? void 0 : n[0].clientX) && void 0 !== i
                        ? i
                        : e.clientX,
                    y:
                      null !== (r = null === (o = e.touches) || void 0 === o ? void 0 : o[0].clientY) && void 0 !== r
                        ? r
                        : e.clientY,
                    w: 0,
                    h: 0,
                ...
                'auto-strict' === w && (w = p < m.y + m.h + v + d ? 'bottom' : 'top')
                let b = m.y
                switch (w) {
                  case 'top':
                    ...
                    break
                  case 'bottom':
                    ;(b = Math.max(0, m.y - v - d)), (y = 0 === b ? m.y - v : void 0)
                }
