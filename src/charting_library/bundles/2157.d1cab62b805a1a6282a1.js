;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2157],
  {
    ...
    10772: (e, t, n) => {
      ...
      class E extends o.PureComponent {
        ...
        _trackEvent() {
          ...
          ;(0, i.trackEvent)('ContextMenuClick', this.props.menuStatName || '', e)
        }
        _getStatName() {
    ...
    5304: (e, t, n) => {
      'use strict'
      n.d(t, { ContextMenuItem: () => E, DEFAUL_CONTEXT_MENU_ITEM_THEME: () => g })
      var o = n(50959),
        s = n(97754),
        r = n(70673),
        a = n(49483),
      ...
      class E extends o.PureComponent {
        constructor() {
          super(...arguments),
            (this._handleMouseOver = (e) => {
              ;(0, i.isTouchEvent)(e.nativeEvent) || (this.props.onMouseOver && this.props.onMouseOver())
            }),
        ...
        render() {
          const {
            ...
            E = this.props.checkable && this.props.checkboxInput ? 'label' : 'div'
          return o.createElement(
            o.Fragment,
            null,
            o.createElement(
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  o.createElement(
                    ...
                    !v && g
                      ? g.map(({ text: e, ...t }, n) => o.createElement('span', { key: n, style: t }, e))
                      : null != v
                        ? v
                        : p,
                  ),
                  ...
                  !e &&
                    t &&
                    !a.CheckMobile.any() &&
                    o.createElement(u.Hint, { className: s(r && l.invisibleHotkey), text: t }),
        ...
        _renderToolboxContent() {
          return this.props.toolbox && this.props.toolbox.type === d.ToolboxType.Delete
            ? o.createElement(l.RemoveButton, { icon: p, onClick: this.props.toolbox.action })
            : null
        }
      }
    },
      ...
      class _ extends o.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleFocus = (e) => {
              this.props.isKeyboardEvent && e.target && (0, y.focusFirstMenuItem)(e.target)
            }),
            (this.state = {})
        }
        render() {
          ...
          return e
            ? o.createElement(
                ...
                o.createElement(h.MatchMedia, { rule: 'screen and (max-width: 430px)' }, (t) =>
                  this._isDrawer(t)
                    ? o.createElement(
                        k.Provider,
                        { value: { type: 'drawer' } },
    ...
    23829: (e, t, n) => {
      ...
      function p(e) {
        const {
          ...
          L = !!k.length
        return s
          ? o.createElement('li', { className: r()(t, m.item, m.loading, m[I]) }, o.createElement(i.Loader, null))
          : o.createElement(
              'li',
              {
                className: r()(
              ...
              o.createElement(
                ...
                { className: r()(m.label) },
                !N && C
                  ? C.map(({ text: e, ...t }, n) => o.createElement('span', { key: n, style: t }, e))
                  : null != N
                    ? N
                    : y,
              ),
              ...
              !L && x && o.createElement(c.Hint, { className: m.shortcut, text: x }),
    ...
    41590: (e, t, n) => {
      ...
      var h
      function m(e) {
        const { position: t = 'Bottom', onClose: n, children: u, reference: h, className: m, theme: v = d } = e,
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              f === b.currentDrawer && o.createElement('div', { className: d.backdrop, onClick: n }),
              o.createElement(
                p,
                { className: r(v.drawer, d[`position${t}`], m), ref: g, 'data-name': e['data-name'] },
                u,
              ),
            ),
          )
      ...
      const p = (0, o.forwardRef)((e, t) => {
        const { className: n, ...s } = e
        return o.createElement(u.TouchScrollContainer, { className: r(d.drawer, n), tabIndex: -1, ref: t, ...s })
      })
    },
    36189: (e, t, n) => {
      'use strict'
      ...
      function d(e) {
        ...
        return s.createElement(a.Icon, {
          ...h,
          className: r(c.favorite, 'apply-common-tooltip', n && c.checked, o && c.active, t),
          icon: n ? i : l,
          onClick: d,
    ...
    96040: (e, t, n) => {
      ...
      function c(e) {
        ...
        return s.createElement(a.Icon, {
          ...b,
          'data-name': p,
          className: r(l.button, 'apply-common-tooltip', c && l.active, m && l.hidden, t),
          icon: v || i,
          onClick: u,
          onMouseDown: d,
              ...
              return (
                ...
                null !== c.current &&
                  (i
                    ...
                    : (0, s.disableBodyScroll)(c.current, { allowTouchMove: u(c) })),
                () => {
                  l--,
                    null !== c.current &&
                      (i
    ...
    20243: (e, t, n) => {
      ...
      function l(e) {
        ...
        const v = m(c),
          ...
          f = -1 !== b,
          g = (e) => {
            i && (0, s.becomeSecondaryElement)(i), (0, s.becomeMainElement)(e), e.focus()
          }
        switch ((0, o.mapKeyCodeToDirection)(n)) {
          case 'inlinePrev':
            if (!v.length) return
            e.preventDefault(), g(0 === b ? l[p] : f ? u(v, b, -1) : v[v.length - 1])
            break
          case 'inlineNext':
            if (!v.length) return
            e.preventDefault(), b === v.length - 1 ? g(l[p]) : g(f ? u(v, b, 1) : v[0])
            break
          case 'blockPrev': {
            e.preventDefault()
            const t = u(l, p, -1)
