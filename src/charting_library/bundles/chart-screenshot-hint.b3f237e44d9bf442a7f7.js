  ...
  [92],
  {
    ...
    64388: (e, t, n) => {
      ...
      function l(e) {
        ...
        return r.createElement(
          ...
          r.createElement(a.Icon, { icon: n, className: o.icon, 'aria-hidden': !0 }),
          t && r.createElement('span', { className: o['visually-hidden'] }, t),
        )
      }
      const c = (0, r.forwardRef)((e, t) => {
        const { icon: n, type: i = 'button', preservePaddings: a, flipIconOnRtl: o, size: c, 'aria-label': u, ...d } = e
        return r.createElement(
          'button',
      ...
      ;(0, r.forwardRef)((e, t) => {
        ...
        return r.createElement(
          c,
          { ...o, className: s({ ...e, children: a, isLink: !0 }), reference: (0, d.isomorphicRef)(t) },
    ...
    9745: (e, t, n) => {
      ...
      const i = r.forwardRef((e, t) => {
        const { icon: n = '', title: i, ariaLabel: a, ariaLabelledby: o, ariaHidden: s, ...l } = e,
          c = !!(i || a || o)
    ...
    1524: (e, t, n) => {
      ...
      var r,
        ...
        p = n.n(w)
      !(function (e) {
        ;(e.Danger = 'danger'), (e.Warning = 'warning'), (e.Success = 'success'), (e.Default = 'default')
      })(r || (r = {})),
        (function (e) {
      ...
      function v(e) {
        ...
        return a.createElement(
          'div',
          {
            className: l(p().container, p()[`container-${t}`], x && p()[`light-container-${t}`], r),
              ...
              a.createElement(
                ...
                a.createElement(
                  ...
                  i &&
                    a.createElement(
                      'span',
                      { className: l(x && p()['light-title'], p().header, p()[`header-${x ? 'new-line' : w}`]) },
                      i,
                    ),
      ...
      var x = n(29196),
        C = n(6388)
      function b(e) {
        const { text: t, style: n, hideTimeout: r, informerIntent: i = 'success' } = e,
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(v, { content: t, informerIntent: i, className: l(C.notice, o && C.noticeShowed) }),
          ),
        )
      }
      class y {
        ...
        show(e) {
          this._wrap &&
            ...
            o.render(a.createElement(b, { text: e, style: this._bottomPadding ? { bottom: 70 } : void 0 }), this._wrap),
            this._debouncedHide())
        }
        hide() {
