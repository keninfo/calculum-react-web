      ...
      <div>
        <Card className="w-full">
          <div className="items-end justify-between md:flex">
            ...
            <Link href="/dashboard">
              <button className="mt-5 w-full rounded-lg bg-carmesi px-5 py-2 md:mt-0 md:w-fit">
      ...
      <div className="items-center justify-between space-y-5 md:flex md:space-x-5 md:space-y-0">
        <Card className="w-full !bg-[#535E73]">
          <div className="items-start justify-start md:flex md:space-x-5">
            ...
            />
            <div className="md:w-fit">
              <h2 className="w-full text-nowrap text-center text-3xl font-bold md:text-left md:text-4xl">Momentum</h2>
