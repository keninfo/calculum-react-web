  ...
  return (
    <>
      ...
      <div className="space-y-5">
        ...
        <Card className="w-full">
          <div className="items-end justify-between md:flex">
            <div className="items-start justify-start md:flex md:space-x-5">
              <img
                src="https://placehold.co/600x600/gold/eerie?text=M"
                width={50}
                height={50}
                alt="image"
      ...
      <div className="items-center justify-between space-y-5 md:flex md:space-x-5 md:space-y-0">
        <Card className="w-full !bg-payne">
          <div className="items-start justify-start md:flex md:space-x-5">
            <img
              src="https://placehold.co/600x600/lightblue/eerie?text=A1"
              width={50}
              height={50}
              alt="image"
            ...
            <div className="md:w-fit">
              ...
              <p className="w-full text-nowrap text-center text-xs text-citron md:text-left md:text-sm">Arbitrum</p>
