  ...
  return (
    <li>
      <button onClick={() => handleSelection(days)}>
        <p
          className={`${selected === selection ? 'border-b-2 border-[#63d9bd] text-[#63d9bd]' : 'text-dark'} h-5 cursor-pointer px-1 pb-2`}
        >
          {string}
        </p>
      </button>
  ...
  return (
    <ul className="flex items-center justify-center space-x-3 p-5 text-xs">
      <li onClick={() => setStudyCase(1)} className="cursor-pointer">
        <p
          className={`${selected === 0 ? 'border-b-2 border-[#63d9bd] text-[#63d9bd]' : 'text-dark'} h-5 cursor-pointer px-1 pb-2`}
        >
          Bull
        </p>
      </li>
      <li onClick={() => setStudyCase(2)} className="cursor-pointer">
        <p
          className={`${selected === 1 ? 'border-b-2 border-[#63d9bd] text-[#63d9bd]' : 'text-dark'} h-5 cursor-pointer px-1 pb-2`}
        >
          Bear
        </p>
      </li>
