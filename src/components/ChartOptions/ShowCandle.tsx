...
const ShowCandle = () => {
  ...
  return (
    <button
      ...
      className="px-10 py-0.5 h-fit w-full text-sm  bg-smoke text-white text-center rounded-none hover:text-carmesi hover:scale-105 border border-white | md:border-none"
    >
