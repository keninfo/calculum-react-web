...
const IntroQuestionnaire = () => {
  ...
  return (
    <Card
      className={`flex relative mx-auto flex-col justify-center items-center z-20 px-[5vw] w-screen h-screen | md:h-fit md:w-[60vw] ${status ? 'md:mt-[20vh]' : 'md:mt-[15vh]'}`}
    >
      <h2 className="text-center text-white text-xl">Hello Anon, Welcome to Bear Protocol</h2>
      <h2 className="text-center text-carmesi text-xl mb-[6vh]">Why are you here?</h2>
