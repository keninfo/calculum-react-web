  ...
  if (open) {
    return (
      <div className="fixed top-0 left-0 bg-black/80 w-screen h-screen z-50 flex items-end justify-center | md:items-center">
        <div ref={modalRef} className="bg-smoke z-40 drop-shadow-xl rounded-xl | md:h-fit md:w-[50vw]">
          <button
            onClick={handleClose}
            className="absolute translate-y-[4vh] left-1/2 -translate-x-1/2 font-bold z-50 text-[#ffffff] -top-[8vh]"
          >
