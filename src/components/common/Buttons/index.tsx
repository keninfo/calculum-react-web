...
export const PrimaryButton = ({ handleClick, children, disabled, border, className }: ButtonProps) => (
  <button
    onClick={handleClick}
    className={`bg-smoke py-6 flex justify-center text-white  hover:scale-110 w-[100%] hover:text-carmesi ${border ? 'border-2' : ''} ${className}`}
    disabled={disabled}
  >
    {children}
  </button>
...
export const SecondaryButton = ({ handleClick, children, disabled, border, className }: ButtonProps) => (
  <button
    onClick={handleClick}
    className={`bg-darkness py-6 flex justify-center text-white  hover:scale-110 w-[100%] hover:text-carmesi ${border ? 'border-2' : ''} ${className}`}
    disabled={disabled}
  >
    {children}
  </button>
