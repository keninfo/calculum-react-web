...
const Select = ({ handleChange, value, options, className = '', disabled = false }: SelectProps) => {
  return (
    <div className="relative">
      <select
        className={`py-0.5 h-fit w-full text-sm border border-white bg-smoke text-white text-left cursor-pointer pr-[2vw] pl-[2vw] | md:w-fit md:pr-[2vw] md:pl-[.5vw] ${className}`}
        id="cryptoCoin"
