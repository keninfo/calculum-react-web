;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2704],
  {
    ...
    57340: (e, t, i) => {
      ...
      const h = n.forwardRef((e, t) => n.createElement(o.NavButton, { ...e, ref: t, icon: d(e.size) }))
    },
    64388: (e, t, i) => {
      'use strict'
      i.d(t, { NavButton: () => c })
      var n = i(50959),
        ...
        r = (i(78572), i(36136))
      function a(e) {
        const { size: t = 'large', preservePaddings: i, isLink: n, flipIconOnRtl: s, className: a } = e
        return o(r['nav-button'], r[`size-${t}`], i && r['preserve-paddings'], s && r['flip-icon'], n && r.link, a)
      }
      function l(e) {
        ...
        return n.createElement(
          ...
          n.createElement(s.Icon, { icon: i, className: r.icon, 'aria-hidden': !0 }),
          t && n.createElement('span', { className: r['visually-hidden'] }, t),
        )
      }
      const c = (0, n.forwardRef)((e, t) => {
        const { icon: i, type: o = 'button', preservePaddings: s, flipIconOnRtl: r, size: c, 'aria-label': d, ...h } = e
        return n.createElement(
          'button',
      ...
      ;(0, n.forwardRef)((e, t) => {
        ...
        return n.createElement(
          c,
          { ...r, className: a({ ...e, children: s, isLink: !0 }), reference: (0, h.isomorphicRef)(t) },
    ...
    78572: (e, t, i) => {
      ...
      var n, o, s, r
      !(function (e) {
        ;(e.Primary = 'primary'), (e.QuietPrimary = 'quiet-primary'), (e.Secondary = 'secondary'), (e.Ghost = 'ghost')
      })(n || (n = {})),
        (function (e) {
          ;(e.XXSmall = 'xxsmall'),
            (e.XSmall = 'xsmall'),
    ...
    27267: (e, t, i) => {
      ...
      function n(e, t, i, n, o) {
        function s(o) {
          ...
          const s = o.target
          void 0 !== i && null !== t && null !== s && s.ownerDocument === n && (t.contains(s) || i(o))
        }
        return (
    ...
    36383: (e, t, i) => {
      ...
      var n = i(50959),
        ...
        s = i(27267)
      function r(e) {
        const { click: t, mouseDown: i, touchEnd: r, touchStart: a, handler: l, reference: c } = e,
          d = (0, n.useRef)(null),
          h = (0, n.useRef)('undefined' == typeof window ? 0 : new window.CustomEvent('timestamp').timeStamp)
        return (
    ...
    9745: (e, t, i) => {
      ...
      const o = n.forwardRef((e, t) => {
        const { icon: i = '', title: o, ariaLabel: s, ariaLabelledby: r, ariaHidden: a, ...l } = e,
          c = !!(o || s || r)
        ...
        moveToTop(e) {
          if (this.getZindex(e) !== this._index) {
            ...
            this._windows.forEach((e, i) => {
              e.hasAttribute('data-focus-trap') && e.setAttribute('data-focus-trap', e === t ? 'true' : 'false')
            }),
      ...
      function c(e) {
        ...
        if (e && 1 == ++a) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (o(i, 'right', `${n()}px`), (t.style.paddingRight = `${a + n()}px`), (l = !0)),
            t.classList.add('i-no-scroll')
        } else if (!e && a > 0 && 0 == --a && (t.classList.remove('i-no-scroll'), l)) {
          o(i, 'right', '0px')
          let e = 0
          0, t.scrollHeight <= t.clientHeight && (e -= n()), (t.style.paddingRight = (e < 0 ? 0 : e) + 'px'), (l = !1)
        }
      }
    },
    24437: (e, t, i) => {
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              n.createElement('div', { className: r()(o ? w.textWrap : w.ellipsis) }, t),
              s && n.createElement('div', { className: r()(w.ellipsis, w.subtitle) }, s),
            ),
            h,
            a &&
              !y &&
      ...
      class k extends n.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._embedResizerOverridesEnabled = b.enabled('embed_resizer_overrides')),
              ...
              if (!e.defaultPrevented) {
                if ((this.props.onKeyDown && this.props.onKeyDown(e), 27 === (0, a.hashFromEvent)(e))) {
                  ...
                  if (null !== i) {
                    if (
                      (e.preventDefault(),
                      'true' === (t = i).getAttribute('data-haspopup') && 'true' !== t.getAttribute('data-expanded'))
                    )
                      return void this._handleClose()
                    const n = this._reference
                    if (null !== n && (0, c.isTextEditingField)(i)) return void n.focus()
                ...
                ;(function (e) {
                  ...
                  ((i = e), [9, a.Modifiers.Shift + 9].includes((0, a.hashFromEvent)(i)) && i.stopPropagation())
              }
            }),
            (this._requestResize = () => {
            ...
            (this._calculatePositionWithOffsets = (e, t) => {
              const i = (0, o.ensureDefined)(this.props.fullScreenViewOffsets).value()
              return {
                top: i.top,
        ...
        componentDidMount() {
          this.props.ignoreClosePopupsAndDialog ||
            f.subscribe(g.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
              ((this._orientationMediaQuery = window.matchMedia('(orientation: portrait)')),
              this._orientationMediaQuery.addEventListener('change', this._handleOpen)),
        ...
        componentWillUnmount() {
          this.props.ignoreClosePopupsAndDialog ||
            f.unsubscribe(g.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            null !== this._orientationMediaQuery &&
              this._orientationMediaQuery.removeEventListener('change', this._handleOpen),
            this.props.fullScreenViewOffsets &&
              this.props.fullScreen &&
        ...
        contains(e) {
          var t, i
          return (
            null !== (i = null === (t = this._reference) || void 0 === t ? void 0 : t.contains(e)) && void 0 !== i && i
          )
        }
        render() {
          const {
          ...
          return n.createElement(p.MatchMedia, { rule: u.DialogBreakpoints.SmallHeight }, (g) =>
            n.createElement(p.MatchMedia, { rule: u.DialogBreakpoints.TabletSmall }, (u) =>
              n.createElement(
                d.PopupDialog,
                {
                  rounded: !(u || N) && T,
                  ...
                  containerAriaLabel: H,
                  containerTabIndex: W,
                  calculateDialogPosition: N && $ ? this._calculatePositionWithOffsets : void 0,
                  shadowed: q,
                  fixedBody: G,
                  onClick: V,
                  ...J,
                ...
                n.createElement(
                  'div',
                  { className: r()(S.wrapper, t), 'data-name': l, 'data-dialog-name': Z },
                  void 0 !== s &&
                    n.createElement(y, {
                      draggable: M && !(u || N),
                  ...
                  b && n.createElement(h.Separator, { className: S.separator }),
                  n.createElement(m.PopupContext.Consumer, null, (e) => this._renderChildren(e, u || N)),
                ),
              ),
            ),
          )
    ...
    69654: (e, t, i) => {
      ...
      function h(e) {
        ...
        return n.createElement(
          ...
          n.createElement(
            'div',
            { className: s()(d.inputContainer, o && d.mobile, g, p && d.withCancel) },
            h || n.createElement(u, { isMobile: o, ..._ }),
          ),
          t,
          n.createElement(a.Icon, { className: s()(d.icon, o && d.mobile, f), icon: o ? c : l }),
          p &&
            (!o || '' !== _.value) &&
            n.createElement('div', { className: s()(d.cancel, o && d.mobile), onClick: p }, v),
        )
      }
      function u(e) {
        const {
    ...
    41153: (e, t, i) => {
      ...
      const M = n.memo(
        function (e) {
          ...
          return n.createElement(
            'div',
            { className: v()(k.action, c && k.active, x, p && k.withDescription, h && k.selected), onClick: _, ref: u },
            m &&
              (void 0 !== i
            ...
            n.createElement(
              ...
              p && n.createElement('span', { className: v()(k.description, x) }, r ? w(r) : ''),
            ),
            void 0 !== g &&
              n.createElement(
                'div',
                { className: v()(k.action__favoriteIcon, g && k.action__favoriteIcon_active) },
      ...
      function L(e) {
        const {
          ...
          [f, y] = (0, n.useState)(() => o.reduce((e, t, i) => (t.name && (e[t.id] = !0), e), {}))
        function E(e) {
          const { id: t, ...i } = e
        ...
        return n.createElement(I.AdaptivePopupDialog, {
          ...
          render: function () {
            return n.createElement(
              n.Fragment,
              null,
              n.createElement(z.DialogSearch, { placeholder: _.t(null, void 0, i(8573)), onChange: g, reference: u }),
              n.createElement(
                'div',
                ...
                l
                  ...
                  : s.map((e, t) =>
                      n.createElement(
                        n.Fragment,
                        { key: e.id },
                        e.name && n.createElement('div', { className: R.section }, e.name),
                        e.actions.map((i, c) => {
                          const { id: d, ...u } = i,
                          ...
                          return n.createElement(
                            ...
                            !f && g && n.createElement('div', { className: R.separator }),
                          )
                        }),
                      ),
                    ),
      ...
      function U(e) {
        const { element: t, ...i } = e,
          ...
          { activeIdx: _, setActiveIdx: x } = (0, h.useKeyboardNavigation)(l.current, o, function (e) {
        ...
        return n.createElement(c.MatchMedia, { rule: m.DialogBreakpoints.TabletSmall }, (e) =>
          e
            ? n.createElement(O, { ...i, ...w })
            : n.createElement(L, { ...i, ...w, position: (0, g.getPopupPositioner)(t, H), doNotCloseOn: t }),
        )
        function y() {
      ...
      class K {
        constructor(e, t, i, n, c, d) {
          ;(this._rootElem = document.createElement('div')),
            ...
            (this.close = () => {
              ...
              if (((this._isOpened = !1), this._disableShowMenu)) {
                ...
                W(t[0], this._isOpened, t[1], t[2], t[3]),
                  null === (e = this._handlerOutsideClickDestroy) || void 0 === e || e.call(this)
              }
              a.unsubscribe(r.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.close, this),
                null !== this._rootElem &&
                  (o.unmountComponentAtNode(this._rootElem),
                  l.favoriteCurrencyUnitConversionService.getOnChange().unsubscribe(this, this._render),
                  (this._rootElem = null),
            ...
            (this._handlerOutsideClick = () => {
              var e
              null === (e = this._handlerOutsideClickDestroy) || void 0 === e || e.call(this),
                (this._handlerOutsideClickDestroy = (0, s.addOutsideEventListener)(
                  new CustomEvent('timestamp').timeStamp,
                  this._element,
                  () => {
                    var e
                    null === (e = this._handlerOutsideClickDestroy) || void 0 === e || e.call(this), this.close()
                  },
                  window.document,
                  { touchEnd: !0, click: !0 },
                ))
            ...
            this._render(),
            l.favoriteCurrencyUnitConversionService.getOnChange().subscribe(this, this._render),
        ...
        _render() {
          if (((this._isOpened = !0), this._disableShowMenu)) {
            ...
            return W(e[0], this._isOpened, e[1], e[2], e[3]), void this._handlerOutsideClick()
          }
          const e = {
            title: this._title,
      ...
      function s(e, t, i, s = 'keydown') {
        ...
        return (
          ...
          (0, n.useEffect)(() => {
            ...
            const n = (e) => {
              var n
              e.repeat || (13 === (0, o.hashFromEvent)(e) && i(null !== (n = t[r]) && void 0 !== n ? n : null, e))
            }
            return (
    ...
    98715: (e, t, i) => {
      ...
      function o(e, t) {
        ;(0, n.useEffect)(() => {
          var i
          t >= 0 && (null === (i = e.current) || void 0 === i || i.scrollIntoView({ block: 'nearest' }))
        }, [t])
      }
    },
    59695: (e, t, i) => {
      ...
      function a(e) {
        ...
        const s = (0, o.getStyleClasses)(e.size, e.className),
          r = null !== (i = null !== (t = e.alt) && void 0 !== t ? t : e.title) && void 0 !== i ? i : ''
        return (0, o.isCircleLogoWithUrlProps)(e)
          ...
          : n.createElement(
              'span',
              { className: s, title: e.title, 'aria-label': e['aria-label'], 'aria-hidden': e['aria-hidden'] },
              e.placeholderLetter,
            )
      }
    },
    ...
    82206: (e, t, i) => {
      ...
      class d extends n.PureComponent {
        ...
        render() {
          const {
            ...
            u = o(a, c.dialog, e && c.rounded, t && c.shadowed, i && c.fullscreen, s && c.darker),
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              { value: this._manager },
              d && n.createElement('div', { onClick: this.props.onClickBackdrop, className: c.backdrop }),
              n.createElement(
                'div',
                {
                  ...p,
        ...
        _createStyles() {
          const { bottom: e, left: t, width: i, right: n, top: o, zIndex: s, height: r } = this.props
          return { bottom: e, left: t, right: n, top: o, zIndex: s, maxWidth: i, height: r }
        }
      }
      var h,
        u = i(86431),
      ...
      class M {
        ...
        dispatch(e) {
          if ('dialog-open' === e) {
            if (null !== this._openSessionId) return void k.logError('Multiple calls to open dialog')
            this._openSessionId = (0, A.randomHash)()
          }
          null !== this._openSessionId
            ? (window.dispatchEvent(
                new CustomEvent(e, { bubbles: !0, detail: { dialogSessionId: this._openSessionId } }),
              ),
      ...
      const T = class {
        ...
        updateOptions(e) {
          ;(this._guard = e.guard || y), (this._calculateDialogPosition = e.calculateDialogPosition)
        }
        setFullscreen(e) {
        ...
        getDialogsTopLeftCoordinates() {
          const { clientWidth: e, clientHeight: t } = this._getClientDimensions(),
        ...
        recalculateBounds() {
          var e
          const { clientWidth: t, clientHeight: i } = this._getClientDimensions(),
            { vertical: n } = this._guard,
            o =
              null === (e = this._calculateDialogPosition) || void 0 === e
                ? void 0
                : e.call(this, this._dialog, { clientWidth: t, clientHeight: i }, { vertical: n })
          if (this._isFullscreen) {
            if (
              ...
              ;(this._dialog.style.transform = `translate(${Math.round(e)}px, ${Math.round(t)}px)`),
                ...
                n && ((this._dialog.style.height = `${n}px`), (this._dialog.style.minHeight = 'unset'))
            }
          } else if (o) {
        ...
        _calcAvailableHeight() {
          return this._getClientDimensions().clientHeight - 2 * this._guard.vertical
        }
      }
                ...
                n.createElement(
                  ...
                  n.createElement(
                    d,
                    {
                      ...
                      className: o(
                        F.dialog,
                        (0, N.isOnMobileAppPage)('any') && !this.props.noMobileAppShadows && F.mobile,
        ...
        componentDidMount() {
          ...
          if ((this._eventDispatcher.dispatch('dialog-open'), e)) {
            ...
            if (e && e instanceof HTMLElement) {
              const o = new w(n, e, { boundByScreen: Boolean(t), onDragStart: i })
              this._cleanUpFunctions.push(() => o.destroy()), (this._drag = o)
            }
          }
          this.props.autofocus && !n.contains(document.activeElement) && n.focus(),
          ...
          if (
            (this._isFullScreen() && this._eventDispatcher.dispatch('dialog-fullscreen-on'),
          ...
          if (!n.contains(document.activeElement)) {
            const e = (function (e) {
              ...
              const i = (0, g.getActiveElementSelectors)(),
                n = Array.from(e.querySelectorAll(i)).filter((0, g.createScopedVisibleElementFilter)(e))
        ...
        componentDidUpdate(e) {
          ...
          if (
            ...
            e && !t
              ...
              : !e && t && this._eventDispatcher.dispatch('dialog-fullscreen-off')
          }
        }
        componentWillUnmount() {
          var e
          ...
          ;(this._isFullScreen() || this.props.fixedBody) && (0, S.setFixedBodyState)(!1),
            this._isFullScreen() && this._eventDispatcher.dispatch('dialog-fullscreen-off'),
        ...
        _applyAppearanceAnimation(e) {
          if (this._resize && this._dialog) {
            ...
            this._dialog.style.setProperty('--animationTranslateStartX', `${t}px`),
              ...
              this._dialog.style.setProperty('--animationTranslateEndX', `${n}px`),
      ...
      ;(B.contextType = C.PortalContext),
        (B.defaultProps = { boundByScreen: !0, draggable: !0, centeredOnMount: !0, shouldReturnFocus: !0 })
    ...
    36189: (e, t, i) => {
      ...
      var n = i(11542),
        ...
        l = i(48010),
        c = i(98992)
      const d = { add: n.t(null, void 0, i(69207)), remove: n.t(null, void 0, i(85106)) }
      function h(e) {
        const { className: t, isFilled: i, isActive: n, onClick: h, ...u } = e
        return o.createElement(r.Icon, {
          ...u,
          className: s(c.favorite, 'apply-common-tooltip', i && c.checked, n && c.active, t),
          icon: i ? a : l,
          onClick: h,
    ...
    19785: (e, t, i) => {
      'use strict'
      i.d(t, { createRegExpList: () => r, getHighlightedChars: () => a, rankedSearch: () => s })
      var n,
        o = i(37265)
      function s(e) {
        const {
          ...
          .map((e) => {
            ...
            return (
              i.forEach((e) => {
                ...
                if (((p.lastIndex = 0), (0, o.isString)(t) && t && t.toLowerCase() === n.toLowerCase()))
                  return (u = 4), void (h = null === (i = t.match(m)) || void 0 === i ? void 0 : i.index)
                if ((0, o.isString)(t) && m.test(t))
                  return (u = 3), void (h = null === (r = t.match(m)) || void 0 === r ? void 0 : r.index)
                if ((0, o.isString)(s) && m.test(s))
                  return (u = 2), void (h = null === (a = s.match(m)) || void 0 === a ? void 0 : a.index)
                if ((0, o.isString)(s) && p.test(s))
                  return (u = 2), void (h = null === (l = s.match(p)) || void 0 === l ? void 0 : l.index)
                if (Array.isArray(d))
                  for (const e of d)
                    if (m.test(e))
                      return (u = 1), void (h = null === (c = e.match(m)) || void 0 === c ? void 0 : c.index)
              }),
      ...
      function r(e, t) {
        ...
        return (
          ...
          t && t.hasOwnProperty(n) && i.push({ fullMatch: t[n], re: t[n], fuzzyHighlight: !1 }),
          i
        )
      }
      function a(e, t, i) {
        ...
        return e && i
          ? (i.forEach((e) => {
              ...
              if (((e.fuzzyHighlight = !r), a))
                ...
                } else for (let e = 0; e < a[0].length; e++) n[a.index + e] = !0
            }),
            n)
          : n
      }
    ...
    24637: (e, t, i) => {
      ...
      function a(e) {
        const { queryString: t, rules: i, text: a, className: l } = e,
          c = (0, n.useMemo)(() => (0, s.getHighlightedChars)(t, a, i), [t, i, a])
        return n.createElement(
          n.Fragment,
          null,
          c.length
            ? a
                ...
                .map((e, t) =>
                  n.createElement(
                    ...
                    { key: t },
                    c[t]
                      ? n.createElement('span', { className: o(r.highlighted, l) }, e)
    ...
    1109: (e, t, i) => {
      ...
      var n = i(50959),
        ...
        s = i(47625)
      function r(e) {
        return n.createElement('div', { className: o(s.separator, e.className) })
      }
    },
    86431: (e, t, i) => {
      'use strict'
      ...
      function s(e, t) {
        return class extends n.PureComponent {
          render() {
            ...
            return 'parent' === s ? r : n.createElement(o.Portal, { shouldTrapFocus: t }, r)
          }
        }
      }
    },
    ...
    10381: (e, t, i) => {
      ...
      function l(e) {
        ...
        return n.createElement(s.Icon, { className: o(i, r.icon, { [r.dropped]: t }), icon: a })
      }
    },
    40173: (e, t, i) => {
      'use strict'
    ...
    39706: (e, t, i) => {
      ...
      const l = (0, n.forwardRef)(function (e, t) {
        const { open: i, summary: o, children: l, onStateChange: c, tabIndex: d, className: h, ...u } = e
        return n.createElement(
          n.Fragment,
          null,
          n.createElement(
            ...
            o,
            n.createElement(r.ToolWidgetCaret, { className: a.caret, dropped: Boolean(i) }),
          ),
          i && l,
        )
      })
      ...
      function c(e, t) {
        return (i) => {
          ...
          let w = null !== (c = t.verticalAttachEdge) && void 0 !== c ? c : l.verticalAttachEdge,
            y = null !== (d = t.verticalDropDirection) && void 0 !== d ? d : l.verticalDropDirection
          w === n.AutoStrict &&
            (p < m.y + m.height + _ + u
          ...
          const E = w === n.Top ? -1 * _ : _,
            ...
            S = { x: C - (f === r.FromRightToLeft ? h : 0) + v, y: b - (y === s.FromBottomToTop ? u : 0) + E }
    ...
    75556: (e, t, i) => {
      ...
      function a(e, t, a) {
        ...
        for (const e of v) {
          ...
          g.actions.push(
            (0, s.createAction)(
              ...
              () => c(e.id),
              m.has(e.id),
              () => r.favoriteCurrencyUnitConversionService.toggle('currencies', e.id),
            ),
          )
        }
        ...
        return (w.length > 0 || x.length > 0) && l.push({ id: 'second_section', actions: x.concat(w) }), l
      }
    },
    49992: (e, t, i) => {
      'use strict'
    ...
    59363: (e, t, i) => {
      ...
      function a(e, t, a) {
        ...
        ;(_.length > 0 || x.length > 0) &&
          g.actions.push(...x.sort((e, t) => e.label.toLowerCase().localeCompare(t.label.toLowerCase())), ..._),
          g.actions.length > 0 && l.push(g)
              ...
              i.id === d ||
                ...
                t.push(
                  (0, s.createAction)(
                    ...
                    () => c(i.id),
                    !1,
                    () => r.favoriteCurrencyUnitConversionService.toggle('units', i.id),
                  ),
                )
    ...
    8481: (e, t, i) => {
      ...
      function n(e, t, i, n, o, s, r, a) {
        return { id: e, label: t, icon: i, description: n, isActive: o, onClick: s, isFavorite: r, onFavoriteClick: a }
      }
