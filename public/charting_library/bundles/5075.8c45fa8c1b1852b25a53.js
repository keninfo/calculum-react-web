  ...
  [5075],
  {
    ...
    36383: (e, t, o) => {
      ...
      function s(e) {
        const { click: t, mouseDown: o, touchEnd: s, touchStart: a, handler: l, reference: c } = e,
          d = (0, n.useRef)(null),
          u = (0, n.useRef)('undefined' == typeof window ? 0 : new window.CustomEvent('timestamp').timeStamp)
        return (
          (0, r.useIsomorphicLayoutEffect)(() => {
    ...
    9745: (e, t, o) => {
      ...
      const r = n.forwardRef((e, t) => {
        const { icon: o = '', title: r, ariaLabel: i, ariaLabelledby: s, ariaHidden: a, ...l } = e,
          c = !!(r || i || s)
      ...
      const n = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            null === (t = o.parentNode) || void 0 === t || t.removeChild(o), (e = r - s)
          }
          return e
        }
      })()
      ...
      function c(e) {
        ...
        if (e && 1 == ++a) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (r(o, 'right', `${n()}px`), (t.style.paddingRight = `${a + n()}px`), (l = !0)),
    ...
    59695: (e, t, o) => {
      ...
      function a(e) {
        ...
        const i = (0, r.getStyleClasses)(e.size, e.className),
          s = null !== (o = null !== (t = e.alt) && void 0 !== t ? t : e.title) && void 0 !== o ? o : ''
    ...
    41590: (e, t, o) => {
      ...
      var p
      function h(e) {
        const { position: t = 'Bottom', onClose: o, children: d, reference: p, className: h, theme: v = u } = e,
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                m,
                { className: i(v.drawer, u[`position${t}`], h), ref: b, 'data-name': e['data-name'] },
                d,
              ),
            ),
          )
    ...
    16396: (e, t, o) => {
      'use strict'
      o.d(t, { DEFAULT_POPUP_MENU_ITEM_THEME: () => d, PopupMenuItem: () => p })
      var n = o(50959),
        r = o(97754),
        i = o(51768),
        s = o(59064),
      ...
      function p(e) {
        ...
        return n.createElement(
          Y,
          {
            ...
            id: t,
            role: o,
            className: r(d, R.item, b && R.withIcon, { [R.isActive]: y, [R.isDisabled]: E || _, [R.hovered]: x }),
            title: p,
            href: C,
            target: B,
            rel: O,
              ...
              j ||
                (e.currentTarget.dispatchEvent(
                  new CustomEvent('popup-menu-close-event', {
                    bubbles: !0,
                    detail: { clickType: (0, l.isKeyboardClick)(e) ? 'keyboard' : 'mouse' },
                  }),
                ),
                (0, s.globalCloseMenu)())
            },
            onContextMenu: function (e) {
              K && G && (0, i.trackEvent)(K.category, K.event, `${K.label}_rightClick`)
            },
          ...
          (void 0 !== f || g) &&
            n.createElement('span', { className: R.shortcut }, (X = f) && X.split('+').join(' + ')),
          void 0 !== M &&
            n.createElement(
              'span',
              { onClick: F ? u : void 0, className: r(v, R.toolbox, { [R.showOnHover]: k, [R.showOnFocus]: D }) },
              M,
            ),
        )
        var X
      ...
      class l extends n.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            r.createPortal(n.createElement(c.Provider, { value: this }, this.props.children), e)
          )
        }
        moveToTop() {
    ...
    10381: (e, t, o) => {
      ...
      function l(e) {
        ...
        return n.createElement(i.Icon, { className: r(o, s.icon, { [s.dropped]: t }), icon: a })
      }
    },
    86656: (e, t, o) => {
      'use strict'
              ...
              return (
                ...
                null !== c.current &&
                  (a
                    ...
                    : (0, r.disableBodyScroll)(c.current, { allowTouchMove: d(c) })),
                () => {
                  l--,
                    null !== c.current &&
                      (a
    ...
    20243: (e, t, o) => {
      ...
      function a(e, t) {
        var o
        if (!e.target) return
        const n = null === (o = e.relatedTarget) || void 0 === o ? void 0 : o.getAttribute('aria-activedescendant')
      ...
      function l(e) {
        ...
        const v = h(c),
          ...
          g = -1 !== f,
          b = (e) => {
            a && (0, r.becomeSecondaryElement)(a), (0, r.becomeMainElement)(e), e.focus()
          }
        switch ((0, n.mapKeyCodeToDirection)(o)) {
          case 'inlinePrev':
            if (!v.length) return
            e.preventDefault(), b(0 === f ? l[m] : g ? d(v, f, -1) : v[v.length - 1])
            break
          case 'inlineNext':
            if (!v.length) return
            e.preventDefault(), f === v.length - 1 ? b(l[m]) : b(g ? d(v, f, 1) : v[0])
            break
          case 'blockPrev': {
            e.preventDefault()
            const t = d(l, m, -1)
    ...
    78135: (e, t, o) => {
      ...
      function c(e, t) {
        return (o) => {
          ...
          let y = null !== (c = t.verticalAttachEdge) && void 0 !== c ? c : l.verticalAttachEdge,
            E = null !== (d = t.verticalDropDirection) && void 0 !== d ? d : l.verticalDropDirection
          y === n.AutoStrict &&
            (h < m.y + m.height + b + p
          ...
          const x = y === n.Top ? -1 * b : b,
            ...
            C = { x: _ - (f === s.FromRightToLeft ? u : 0) + g, y: T - (E === i.FromBottomToTop ? p : 0) + x }
    ...
    81348: (e, t, o) => {
      'use strict'
      o.d(t, { DEFAULT_TOOL_WIDGET_BUTTON_THEME: () => a, ToolWidgetButton: () => l })
      var n = o(50959),
        r = o(97754),
        i = o(9745),
        s = o(38177)
          ...
          const {
            ...
            D =
              ...
              ('string' == typeof a
                ...
                : n.cloneElement(a, { className: r(w.icon, a.props.className) }))
          return 'button' === o
            ? n.createElement(
                'button',
                {
                ...
                g && f && n.createElement('div', { className: r('js-button-text', w.text) }, f),
                D,
                !g && f && n.createElement('div', { className: r('js-button-text', w.text) }, f),
              )
            : n.createElement(
    ...
    56388: (e, t, o) => {
      ...
      const a = n.forwardRef(function (e, t) {
        ...
        return n.createElement(i.ToolWidgetButton, { id: a, 'data-name': a, ...l, ref: t, className: r(o, s.button) })
      })
    },
    16829: (e, t, o) => {
      'use strict'
      ...
      var n = o(50959),
        ...
        i = o(33532)
      function s(e) {
        return n.createElement('div', { className: r(e.className, i.title) }, e.children)
      }
    },
    20626: (e, t, o) => {
      'use strict'
      ...
      class g extends n.PureComponent {
          ...
          super(e),
            ...
            (this._handleMenuFocus = (e) => {
              ...
              e.relatedTarget === this._wrapperRef && this.setState((e) => ({ ...e, isOpenedByButton: !0 })),
                null === (o = (t = this.props).onMenuFocus) || void 0 === o || o.call(t, e)
            }),
            ...
            (this._handleClick = (e) => {
              ;(h.enabled('skip_event_target_check') || e.target instanceof Node) &&
            ...
            (this._handleKeyDown = (e) => {
              ...
              if (e.currentTarget.contains(e.target))
                ...
                switch (n) {
                  case 27: {
                    e.preventDefault()
                    const { shouldReturnFocus: o, isOpenedByButton: n } = this.state
                    this._handleToggleDropdown(!1),
                      o && n && (null === (t = this._wrapperRef) || void 0 === t || t.focus())
                    break
                  }
                }
              }
        ...
        render() {
          const {
            ...
            E = r(h, v.button, { 'apply-common-tooltip': d || !s, [v.isDisabled]: s, [v.isOpened]: y, [v.clicked]: w }),
          ...
          return 'button' === e
            ? n.createElement(
                ...
                this.state.isOpened &&
                  (f
                    ? n.createElement(p.MatchMedia, { rule: f }, (e) => this._renderContent(e))
        ...
        _renderContent(e) {
          ...
          return m
            ? n.createElement(
                ...
                n.createElement(
                  d.Drawer,
                  { reference: this.props.drawerReference, onClose: this._handleClose, position: a, 'data-name': t },
                  v,
                ),
              )
            : n.createElement(
    ...
    88811: (e, t, o) => {
      ...
      const c = (0, n.forwardRef)(function (e, t) {
          ...
          return n.createElement(a.ToolWidgetMenu, {
            ...
            onMenuFocus: (e) => (0, l.handleAccessibleMenuFocus)(e, null != s ? s : u),
          })
        }),
    ...
    77151: (e, t, o) => {
      'use strict'
      o.d(t, { RegistryProvider: () => l, registryContextType: () => c, validateRegistry: () => a })
      var n = o(50959),
        r = o(19036),
        i = o.n(r)
