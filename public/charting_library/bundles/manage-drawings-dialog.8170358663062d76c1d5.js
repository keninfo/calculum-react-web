;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1702],
  {
    ...
    64530: (e, t, n) => {
      ...
      function c(e) {
        const { url: t, ...n } = e
        return t ? i.createElement('a', { ...n, href: t }) : i.createElement('div', { ...n })
      }
      var u = n(60925),
        d = n(4914)
      function m(e) {
        ...
        return i.createElement(
          ...
          {
            ...E,
            className: l()(d.itemRow, f && !w && d.active, b && d.mobile, w && d.selected, y),
          ...
          p &&
            ...
            i.createElement(s.FavoriteButton, {
              className: l()(d.favoriteButton, C && d.favorite, o.CheckMobile.any() && d.mobile),
              isActive: f && !w,
              isFilled: C,
          ...
          i.createElement(
            ...
            i.createElement(
              'div',
              { className: l()(d.title, f && !w && d.active, b && d.mobile), 'data-name': 'list-item-title' },
              t,
            ),
            i.createElement('div', { className: l()(d.details, f && !w && d.active, b && d.mobile) }, n),
          ),
    ...
    11386: (e, t, n) => {
      ...
      const B = new c.TranslatedString('remove all line tools for {symbol}', r.t(null, void 0, n(58407))),
      ...
      function N(e) {
        ...
        return (
          i.useEffect(() => {
            ...
            return (
              e.withModel(null, () => {
                ;(t = e.model()), n(t), i(), t.mainSeries().symbolResolved().subscribe(null, i)
              }),
              () => {
                null == t || t.mainSeries().symbolResolved().unsubscribe(null, i), n(null)
              }
            )
          }, [e]),
          i.useEffect(() => {
      ...
      function _(e) {
        const { isMobile: t, isSmallWidth: a, chartWidget: l, onClose: c, onInitialized: u } = e,
          {
            currentSymbol: d,
          ...
          [S, k] = i.useMemo(() => {
            ...
            if (null !== d && null !== m) {
              ...
              let n = C
              if (null === n)
                for (n = 2; n > 0 && !(((null === (e = m[n].get(d)) || void 0 === e ? void 0 : e.size) || 0) > 0); ) n--
              return (
                m[n].forEach((e, n) => {
                  w.includes(n) ||
                    t.push({
        ...
        return (
          ...
          i.createElement(
            ...
            0 === S.length
              ...
              : S.map(({ symbol: e, drawingsCount: a, onRemove: l, onClick: o }) => {
                  return i.createElement(v.DialogContentItem, {
                    ...
                    subtitle:
                      ((s = a),
                      r
                        .t(null, { plural: '{drawingsCount} drawings', count: s }, n(90755))
