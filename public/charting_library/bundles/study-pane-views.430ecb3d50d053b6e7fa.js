...
;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [507],
  {
        ...
        _drawImpl(t) {
          ...
          if (
            ...
            if (this._data.leftend === a.LineEnd.Arrow) {
              ...
              ;(0, n.drawArrow)(t[0], t[1], s, s.lineWidth, f.dpr1PixelRatioInfo)
            }
    ...
    56208: (t, e, i) => {
        ...
        hitTest(t, e) {
          ...
          for (const s of i.histograms) {
            ...
            for (const a of s.bars) {
              ...
              if (o.location === n.HHistLocation.Absolute && (s.xRange.min >= t.x || t.x >= s.xRange.max)) continue
              null === r &&
                ((r = 0),
                s.bars.forEach((t) => {
              ...
              const l = _(s.xRange, o, e.mediaSize.width),
                ...
                f = Math.max((o.percentWidth * u) / 100 - a.subBarValues.length, 0)
              let p = h
              for (let e = 0; e < a.subBarValues.length; e++) {
                ...
                if (((p = o), ((t.x >= n && t.x <= o) || (t.x >= o && t.x <= n)) && t.y >= i && t.y <= s))
          ...
          t.save(),
            i.histograms.forEach((a) => {
              ...
              const h = d / a.bars.length,
                c = ((u = h), (f = r), Math.floor(u * f) >= 1 * f ? Math.floor(f) : 0)
              var u, f
              const p = []
              if (
                (a.bars.forEach((s) => {
                  ...
                  if (d.showValues && d.addToTotalValue)
                    for (let t = 0; t < s.subBarValues.length; t++) o[t] = (o[t] || 0) + s.subBarValues[t]
                  const h = _(a.xRange, d, e.mediaSize.width),
                    { xBasePoint: u, sign: f, xRangeWidth: m } = h
                  if (s.y > e.mediaSize.height || s.y + s.height < 0) return
                  const x = Math.max((d.percentWidth * m) / 100 - s.subBarValues.length, 0)
                  let y = u
      ...
      function v(t, e) {
        return e === n.HHistDirection.RightToLeft && (t = t.slice()).reverse(), t.map((t) => f.format(t)).join('x')
      }
      function g(t, e, i, s, r, a) {
        const { fontSize: l, verticalOffset: d } = (function (t, e, i) {
          ...
          f = c + 3 * u,
          p = e + d
        return { text: a, color: r.valuesColor, fontSize: l, align: h, point: new o.Point(f, p) }
      }
      function m(t, e, i) {
        ...
        ;(t.font = `${n}px ${c.CHART_FONT_FAMILY}`),
          (t.fillStyle = r),
          (t.textAlign = a),
          (0, l.drawScaled)(t, e.horizontalPixelRatio, e.verticalPixelRatio, () => t.fillText(s, o.x, o.y))
      }
      var x,
        y = i(19063)
      !(function (t) {
        ;(t.UpDominatePostfix = 'UpDominate'), (t.DownDominatePostfix = 'DownDominate')
      })(x || (x = {}))
      class w {
        ...
        _prepareStyles() {
          ...
          const i = (0, r.ensureDefined)(this._provider.graphicsInfo().hhists),
            s = Object.keys(i),
            a = (0, r.ensureDefined)(this._provider.properties().childs().graphics.childs().hhists),
            o =
              (null ===
                (e =
          ...
          for (const t of s) {
            ...
            if (o)
              ...
              const i = (0, y.generateColor)(e.colors[0].value(), e.transparencies[0].value()),
                r = e.colors[1] ? (0, y.generateColor)(e.colors[1].value(), e.transparencies[1].value()) : i
          ...
          if (this._histBoxBgStyle) {
            ...
            this._rendererData.histBoxBgColor = (0, y.generateColor)(t.color.value(), t.transparency.value())
          }
        }
        _updateViewInternal() {
        ...
        _updateDataForRenderers(t, e, i) {
          ...
          t.forEach((t) => {
            ...
            const n = (function (t, e, i) {
              return u(e.priceToCoordinate(t.priceHigh, i), e.priceToCoordinate(t.priceLow, i))
            })(t, e, c)
            f.push({ height: n.max - n.min, y: n.min, subBarValues: i, displayedValues: s, styleId: r })
          }),
            f.sort((t, e) => t.y - e.y),
    ...
    95258: (t, e, i) => {
      ...
      class o {
        ...
        _updateViewInternal() {
          ...
          const a = r.firstBar(),
            o = r.lastBar(),
            l = (0, s.ensureDefined)(this._provider.properties().childs().graphics.childs().horizlines)
          i.forEach((i, r) => {
            ...
            d.visible.value() &&
              i.forEach((i) => {
                const r = i.startIndex,
                  l = i.endIndex
                if ((!i.extendRight && Math.max(r, l) < a) || (!i.extendLeft && Math.min(r, l) > o)) return
                let h, c
                if (!i.extendLeft) {
