  ...
  [7078],
  {
      ...
      function u(e) {
        const {
          ...
          f = (function () {
            ...
            return a ? (null == i ? void 0 : i.bold) : null == i ? void 0 : i.default
          })()
        return l.createElement(
          ...
          !C &&
            l.createElement(
              ...
              l.createElement('span', { className: o()(m.titleText, 'apply-overflow-tooltip') }, n),
              _ && !T && l.createElement(s.Icon, { className: m.nested, icon: c }),
            ),
        )
      }
      !(function (e) {
    ...
    56080: (e, t, n) => {
      ...
      var C = n(50655),
        ...
        w = n(11559)
      function M(e) {
        const { themeName: t, chartWidgetCollection: n, onRemove: i, manager: a } = e,
          [o, s] = (0, A.useHover)(),
          r = l.useCallback(
            () =>
              (function (e, t, n) {
      ...
      class F extends l.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleApplyDefaults = () => {
              ...
              ;(0, T.loadTheme)(t, { themeName: n, standardTheme: !0, applyOverrides: !0, onlyActiveChart: !0 })
            }),
            (this._handleSaveAs = () => {
              if (R) {
                  ...
                  () =>
                    (async function (e, t, i) {
                      const [l, a] = await Promise.all([
                        Promise.all([n.e(6302), n.e(7648)]).then(n.bind(n, 57351)),
                        (0, T.getThemeNames)(),
                      ])
            ...
            (this._handleListboxFocus = (e) => {
              e.target instanceof HTMLElement && (0, B.handleAccessibleMenuFocus)(e, this._reference)
            }),
        ...
        render() {
          return l.createElement(
            ...
            (e) => (
              (this._manager = e),
              l.createElement(d.MatchMedia, { rule: 'screen and (max-width: 768px)' }, (e) =>
                l.createElement(
                  P.ControlDisclosure,
                  {
        ...
        _getPlaceHolderItem(e) {
          return e ? l.createElement(b.Icon, { className: w.themesButtonIcon, icon: I }) : x
        }
        _getThemeItems(e) {
      ...
      class ae extends l.PureComponent {
        constructor(e) {
          ...
          super(e),
            (this._renderChildren = ({ requestResize: e, isSmallWidth: t }) => (
              ...
              l.createElement('div', { className: ie.content }, this._renderTabs(t), this._renderTabContent(t))
            )),
            (this._renderApplyToAllButton = () =>
              l.createElement(d.MatchMedia, { rule: V.DialogBreakpoints.TabletNormal }, (e) =>
            ...
            (this._selectPage = (e, t) => {
              ...
              e !== n &&
                ...
                null !== e &&
                  (t || h().setValue(le, e.id), e.definitions.subscribe(this._onChangeActivePageDefinitions)),
          ...
          let o = null !== (t = a.find((e) => e.id === i)) && void 0 !== t ? t : null
          if (!o) {
            ...
            (r) =>
              l.createElement(s.AdaptiveConfirmDialog, {
                ...
                additionalHeaderElement:
                  null !== o && r ? l.createElement(te, { onClick: this._handleBackClick }) : void 0,
            ...
            return l.createElement(
              ...
              l.createElement(
                ...
                l.createElement(
                  ...
                  i.map((e) => l.createElement(o.Section, { key: e.id, definition: e })),
                ),
              ),
            )
          }
        ...
        _renderTabs(e) {
          ...
          return l.createElement(d.MatchMedia, { rule: V.DialogBreakpoints.TabletNormal }, (e) =>
            l.createElement(d.MatchMedia, { rule: V.DialogBreakpoints.TabletSmall }, (t) => {
        ...
        show(e) {
          this.visible().value() ||
            ...
            oe.emit('edit_object_dialog', {
              ...
              scriptTitle: this._model.mainSeries().title(re.TitleDisplayTarget.StatusLine),
            }))
        }
        _ensureCheckpoint(e) {
    ...
    38068: (e, t, n) => {
      ...
      function m(e) {
        ...
        return i.createElement(
          'button',
          { ref: m, tabIndex: h, onClick: n, className: a()(c.button, l.isActive && c.active), type: 'button' },
          i.createElement(s.RemoveButton, { 'aria-label': t, ...l, 'data-tooltip': t, icon: r }),
        )
      }
    },
    68648: (e) => {
