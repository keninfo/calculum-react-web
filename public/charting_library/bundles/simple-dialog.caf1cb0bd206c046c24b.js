;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8890],
  {
    ...
    70493: (e, t, n) => {
      'use strict'
      n.r(t),
        n.d(t, { confirmModule: () => L, renameModule: () => _, showSimpleDialog: () => I, warningModule: () => A })
      var o = n(50959),
        l = n(11542),
        a = n(97754),
        r = n(64388),
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                ...
                o.createElement(
                  'div',
                  { className: a(B.main, !N && B.marginWithoutCloseButton, i && B.small) },
                  t && o.createElement('div', { className: a(B.title, i && B.small) }, t),
                  (function (t) {
                    if ('html' in e)
                  ...
                  l &&
                    ...
                    o.createElement(
                      ...
                      l.map((e, t) => o.createElement(y, { ...e, key: e.name, reference: 0 === t ? T : void 0 })),
                    ),
                ),
                N &&
      ...
      function x(e) {
        ...
        return (
          ...
          o.createElement(
            ...
            null,
            (function () {
              if ('content' in e) return o.createElement('div', { className: U.label }, e.content)
              if ('html' in e)
                return o.createElement('div', { className: U.label, dangerouslySetInnerHTML: { __html: e.html } })
              return null
            })(),
      ...
      const L = function (e) {
          ...
          return o.createElement(N, {
            ...
            onClose: a,
            actions: [
              { name: 'yes', title: r || l.t(null, void 0, n(55512)), intent: i || 'success', handler: u },
              {
                name: 'no',
                type: 'button',
            ...
            actions: [
              {
                ...
                handler: ({ dialogClose: e, innerManager: t }) =>
                  v({ newValue: C, focusInput: B, dialogClose: e, innerManager: t }),
              },
              {
                name: 'cancel',
                type: 'button',
        ...
        I = function (e, t, n) {
          const { title: l } = e
          let a = `${l}_`
          if (((a += 'text' in e ? e.text : 'html' in e ? e.html : e.id), P.isOpened(a)))
            return (0, h.ensureDefined)(P.getDialogPayload(a)).closeHandler
          const r = document.createElement('div'),
            i = () => {
              var t
              null === (t = e.onClose) || void 0 === t || t.call(e), s.unmount(), P.setAsClosed(a)
            },
          ...
          (0, o.useLayoutEffect)(() => {
            if (r.CheckMobile.iOS())
              return (
                ...
                null !== c.current &&
                  (i
                    ? 1 === s && (document.body.style.overscrollBehavior = 'none')
                    : (0, l.disableBodyScroll)(c.current, { allowTouchMove: u(c) })),
                () => {
                  s--,
                    null !== c.current &&
                      (i
                        ? 0 === s && (document.body.style.overscrollBehavior = '')
