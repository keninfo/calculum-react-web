  ...
  [6014],
  {
    ...
    36383: (e, t, i) => {
      ...
      var n = i(50959),
        ...
        s = i(27267)
      function a(e) {
        const { click: t, mouseDown: i, touchEnd: a, touchStart: r, handler: l, reference: d } = e,
          u = (0, n.useRef)(null),
          c = (0, n.useRef)('undefined' == typeof window ? 0 : new window.CustomEvent('timestamp').timeStamp)
        return (
    ...
    9745: (e, t, i) => {
      ...
      const o = n.forwardRef((e, t) => {
        const { icon: i = '', title: o, ariaLabel: s, ariaLabelledby: a, ariaHidden: r, ...l } = e,
          d = !!(o || s || a)
      ...
      const n = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            null === (t = i.parentNode) || void 0 === t || t.removeChild(i), (e = o - a)
          }
          return e
        }
      })()
      ...
      function d(e) {
        ...
        if (e && 1 == ++r) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (o(i, 'right', `${n()}px`), (t.style.paddingRight = `${r + n()}px`), (l = !0)),
    ...
    28124: (e, t, i) => {
      ...
      var n = i(50959),
        o = i(32227),
        s = i(4237)
      const a = (0, n.createContext)({ isOnMobileAppPage: () => !1, isRtl: !1, locale: { language: 'en' } })
      var r = i(84015),
        l = i(63273),
        d = i(50151)
      const u = JSON.parse(
      ...
      const h = { iOs: 'old', android: 'new', old: 'old', new: 'new', any: 'any' }
      function g(e) {
    ...
    82206: (e, t, i) => {
      ...
      class u extends n.PureComponent {
        ...
        render() {
          const {
            ...
            h = o(r, d.dialog, e && d.rounded, t && d.shadowed, i && d.fullscreen, s && d.darker),
            g = (0, l.filterDataProps)(this.props),
            _ = this.props.style ? { ...this._createStyles(), ...this.props.style } : this._createStyles()
          return n.createElement(
            ...
            n.createElement(
              ...
              { value: this._manager },
              u && n.createElement('div', { onClick: this.props.onClickBackdrop, className: d.backdrop }),
              n.createElement(
                'div',
                {
                  ...g,
        ...
        _createStyles() {
          const { bottom: e, left: t, width: i, right: n, top: o, zIndex: s, height: a } = this.props
          return { bottom: e, left: t, right: n, top: o, zIndex: s, maxWidth: i, height: a }
        }
      }
      var c,
        h = i(86431),
      ...
      class A {
        ...
        dispatch(e) {
          if ('dialog-open' === e) {
            if (null !== this._openSessionId) return void M.logError('Multiple calls to open dialog')
                ...
                n.createElement(
                  ...
                  n.createElement(
                    u,
                    {
                      ...
                      className: o(
                        P.dialog,
                        (0, F.isOnMobileAppPage)('any') && !this.props.noMobileAppShadows && P.mobile,
          ...
          if (!n.contains(document.activeElement)) {
            const e = (function (e) {
              ...
              const i = (0, p.getActiveElementSelectors)(),
                n = Array.from(e.querySelectorAll(i)).filter((0, p.createScopedVisibleElementFilter)(e))
      ...
      ;(L.contextType = x.PortalContext),
        (L.defaultProps = { boundByScreen: !0, draggable: !0, centeredOnMount: !0, shouldReturnFocus: !0 })
      ...
      function s(e, t) {
        return class extends n.PureComponent {
          render() {
            ...
            return 'parent' === s ? a : n.createElement(o.Portal, { shouldTrapFocus: t }, a)
          }
        }
      }
    },
      ...
      class l extends n.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            o.createPortal(n.createElement(d.Provider, { value: this }, this.props.children), e)
          )
        }
        moveToTop() {
