;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6631],
  {
    ...
    57340: (e, t, n) => {
      ...
      const d = s.forwardRef((e, t) => s.createElement(o.NavButton, { ...e, ref: t, icon: u(e.size) }))
    },
    70673: (e, t, n) => {
      'use strict'
    ...
    15294: (e, t, n) => {
      ...
      class c extends s.PureComponent {
        render() {
          ...
          return (
            this.props.label &&
              (c = s.createElement('span', { className: r, title: this.props.title }, this.props.label)),
            s.createElement('label', { className: i }, s.createElement(a.CheckboxInput, { ...n, className: e }), c)
          )
        }
      }
    ...
    59416: (e, t, n) => {
      ...
      class a extends s.PureComponent {
        ...
        render() {
          return s.createElement(i.Provider, { value: this.state.switchGroupContext }, this.props.children)
        }
        ...
        constructor() {
          super(...arguments),
            ...
            (this._handleKeyDown = (e) => {
              ...
              13 === (0, u.hashFromEvent)(e) && s && (e.preventDefault(), n || t())
            })
        }
        render() {
          const {
                ...
                o.createElement(
                  ...
                  b &&
                    o.createElement(
                      ...
                      o.createElement(
                        r.Button,
                        { className: v, disabled: u, name: 'submit', onClick: d, 'data-name': 'submit-button' },
    ...
    79418: (e, t, n) => {
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            s.createElement(
              ...
              s.createElement('div', { className: a()(o ? C.textWrap : C.ellipsis) }, t),
              i && s.createElement('div', { className: a()(C.ellipsis, C.subtitle) }, i),
            ),
            d,
            r &&
              !w &&
      ...
      class k extends s.PureComponent {
          ...
          super(...arguments),
            ...
            (this._handleKeyDown = (e) => {
              if (!e.defaultPrevented) {
                if ((this.props.onKeyDown && this.props.onKeyDown(e), 27 === (0, r.hashFromEvent)(e))) {
                  ...
                  if (null !== n) {
                    ...
                    if (null !== s && (0, c.isTextEditingField)(n)) return void s.focus()
                ...
                ;(function (e) {
                  ...
                  ((n = e), [9, r.Modifiers.Shift + 9].includes((0, r.hashFromEvent)(n)) && n.stopPropagation())
              }
            }),
            (this._requestResize = () => {
        ...
        render() {
          ...
          return s.createElement(p.MatchMedia, { rule: h.DialogBreakpoints.SmallHeight }, (b) =>
            s.createElement(p.MatchMedia, { rule: h.DialogBreakpoints.TabletSmall }, (h) =>
              s.createElement(
                u.PopupDialog,
                {
                  ...
                  containerAriaLabel: H,
                  containerTabIndex: W,
                  calculateDialogPosition: T && Z ? this._calculatePositionWithOffsets : void 0,
                  shadowed: U,
                  fixedBody: j,
                  onClick: Q,
                  ...$,
                ...
                s.createElement(
                  'div',
                  { className: a()(y.wrapper, t), 'data-name': l, 'data-dialog-name': J },
                  void 0 !== i &&
                    s.createElement(w, {
                      draggable: B && !(h || T),
                  ...
                  N && s.createElement(d.Separator, { className: y.separator }),
                  s.createElement(m.PopupContext.Consumer, null, (e) => this._renderChildren(e, h || T)),
                ),
              ),
            ),
          )
    ...
    1109: (e, t, n) => {
      ...
      var s = n(50959),
        ...
        i = n(47625)
      function a(e) {
        return s.createElement('div', { className: o(i.separator, e.className) })
      }
    },
    77024: (e) => {
    ...
    3606: (e, t, n) => {
      ...
      class b extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(u.AdaptiveConfirmDialog, {
            ...
            submitButtonText: i.createElement(m, { isLoading: this.state.isLoading }),
        ...
        _renderDialogBody() {
          return () => i.createElement(d.SlotContext.Consumer, null, (e) => ((this._manager = e), this.props.children))
        }
      }
      var v = n(30575),
        g = n(85508),
        ...
        return (
          ...
          i.createElement(
            ...
            i.createElement(
              ...
              i.createElement('div', { className: a(f.indicators, E && f.withSuggestions) }, c),
            ),
          )
        )
      }
        ...
        return i.createElement(
          ...
          i.createElement(
            'button',
            {
              ...
              'aria-label': n,
              'data-tooltip': n,
              className: a(f.hintLabel, 'apply-common-tooltip', f.accessibleLabel),
              title: n,
              onFocus: () => (0, C.showOnElement)((0, s.ensureNotNull)(o.current)),
              onBlur: () => (0, C.hide)(),
            },
      ...
      class A {
        constructor(e) {
          ;(this._container = document.createElement('div')),
            ...
            (this.unmount = () => {
              var e
              B.unsubscribe(T.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.unmount, null),
      ...
      function W(e, t, n) {
        const s = () => {
          P.backend.invalidateStudyTemplatesList(), P.backend.getStudyTemplatesList().then(t)
        }
      ...
      class G {
        ...
        _doSave(e, t, n) {
          ...
          const a = n.manager() || void 0,
            r = (0, R.getStudyTemplateSaveData)(s, this._controller.model(), o, i)
        ...
        _getActualTemplateList() {
          return P.backend.invalidateStudyTemplatesList(), P.backend.getStudyTemplatesList()
        }
        _showTemplateSaveRenameDialog(e, t, n) {
          ...
          ;(this._dialog = new A({
            ...
            saveIntervalHintText: H.format({ interval: (0, L.translatedIntervalString)(n) }),
