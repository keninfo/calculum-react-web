;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7223],
  {
    ...
    93301: (e, t, n) => {
      ...
      function u(e) {
        ...
        return s.createElement(
          ...
          s.createElement(
            a.LightButton,
            { size: 'small', variant: 'ghost', 'aria-label': r, onClick: v, disabled: h, onKeyDown: y, reference: f },
            u,
          ),
          s.createElement(a.LightButton, {
            startSlot: s.createElement(o.Icon, { icon: i }),
      ...
      function y(e, t) {
        switch (e) {
          case g.Month: {
            const e = new Date(t)
            return e.setMonth(e.getMonth() - 1), `${f.prevMonth}, ${p()[e.getMonth()]} ${e.getFullYear()}`
          }
          case g.Year:
      ...
      function w(e, t) {
        switch (e) {
          case g.Month: {
            const e = new Date(t)
            return e.setMonth(e.getMonth() + 1), `${f.nextMonth}, ${p()[e.getMonth()]} ${e.getFullYear()}`
          }
          case g.Year:
      ...
      class C extends s.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._onPointerOver = () => {
              this.props.onHover && !this.props.isDisabled && this.props.onHover(new Date(this.props.day))
            }),
            (this._onPointerOut = () => {
              this.props.onHover && !this.props.isDisabled && this.props.onHover(null)
            })
        }
        render() {
          const e = r(
              ...
              !this.props.isDisabled && (this.props.isSelected || this._isOnHighlightedEdge()) && l['accent-color'],
        ...
        _isCurrentDay() {
          var e
          return (0, c.isSameDay)(null !== (e = this.props.todayDate) && void 0 !== e ? e : new Date(), this.props.day)
        }
      ...
      function M({
        ...
        const [d, h] = (0, k.useRefsMap)(),
          ...
          ),
          {
            ...
            return { currentlyFocused: i, setCurrentlyFocused: l, focusItem: u, bindings: { onKeyDown: d } }
          })({ refsMap: d, verticalOffset: l, getNextKeyToFocus: f, getFirstKey: m, getLastKey: g, onGridEnd: v })
        return (
        ...
        const {
          ...
          S = (0, s.useCallback)(
            (e) => {
              if (!e) return null
              let t = null
              return o.find(({ days: n }) => ((t = n.find((t) => (0, c.isSameDay)(t, e))), t)), t
            },
            [o],
          ),
          ...
          I = (0, s.useCallback)(
            (e) => y || (0, c.isDayDisabled)({ day: e, minDate: f, maxDate: p, disableWeekends: m }),
            [f, p, m, y],
          ),
          {
            itemsRefs: R,
      ...
      function x(e) {
        const {
          ...
          D = (0, s.useCallback)((e) => p || !(0, c.isInRange)(e, i, o, 'month'), [i, o, p]),
          y = (0, s.useCallback)(
            (e) => {
              if (!e) return null
              let n = null
      ...
      function I(e) {
        const {
          ...
          y = (0, s.useCallback)((e) => f || !(0, c.isInRange)(e, d, u, 'year'), [d, u, f]),
          w = (0, s.useCallback)((e) => (e && t.find((t) => (0, c.isSameYear)(e, t))) || null, [t]),
              ...
              t.map((e) => {
                ...
                return s.createElement(
                  a.LightButton,
                  {
                    ...
                    disabled: i,
                    isSelected: n,
                    className: r(l['decade-button'], !p && l['hide-focus-ring']),
                    onClick: () => g(e),
                    reference: C(e),
      ...
      function R({
        ...
        const [D, y] = (0, s.useState)(e),
          ...
          P = (0, s.useCallback)(
            (e) => {
              const t = new Date(D)
              t.setMonth(e.getMonth()), (0, c.isSameMonth)(t, e) || t.setMonth(e.getMonth(), 1), y(t)
              const n = new Date(F || D)
              n.setMonth(e.getMonth()), (0, c.isSameMonth)(n, e) || n.setMonth(e.getMonth(), 1), C(n), b(g.Month)
            },
            [D, i, R],
          ),
          Y = (0, s.useCallback)(
            ...
            () =>
              (function (e) {
                return [
                  ...
                  return s.setMonth(n), { title: t, ariaLabel: p()[n], date: s }
                })
              })(D),
            [D],
          ),
          ...
          O = (0, s.useMemo)(() => {
            switch (w) {
              ...
              case g.Year: {
                ...
                return e.setMonth(e.getMonth() + 1), !(0, c.isInRange)(e, a, o, 'month')
              }
              case g.Decades: {
                const e = new Date($[$.length - 1])
                return e.setFullYear(e.getFullYear() + 1), !(0, c.isInRange)(e, a, o, 'year')
              }
            }
          }, [w, a, o, H, z, $]),
          L = (0, s.useMemo)(() => {
      ...
      const Y = new (class {
        constructor() {
          ;(this.isInited = !1), (this._politeQueue = new P('polite')), (this._assertiveQueue = new P('assertive'))
        }
        renderTo(e, t = !1) {
      ...
      var H
      function z({ viewType: e, decadesStartYear: t, viewDate: n, setPrev: r, setNext: a, switchViewType: o }) {
        const [i, l] = (0, s.useState)(null),
          u = (0, s.useCallback)(
            (e) => {
            ...
            u(
              (function (e, t) {
                switch (e) {
                  case g.Month: {
                    const e = new Date(t)
                    return e.setMonth(e.getMonth() - 1), m.setMonth.format({ month: p()[e.getMonth()] })
                  }
                  case g.Year:
      ...
      function $(e) {
        ...
        const A = (0, s.useCallback)(
            (e) => {
              P && 38 === (0, S.hashFromEvent)(e) && (e.preventDefault(), e.stopPropagation(), V(!1), P())
            },
            [P],
          ),
          {
          ...
          de = (0, s.useMemo)(() => q[0], [q]),
          {
            ...
            onNextClick: pe,
            onSwitchViewType: fe,
          } = z({ viewType: Q, decadesStartYear: de, viewDate: j, setPrev: G, setNext: ee, switchViewType: te })
        return s.createElement(
          'div',
          { className: r(l.calendar, p && l.popupStyle, o), tabIndex: -1, onKeyDown: B },
          s.createElement(u, {
    ...
    85528: (e, t, n) => {
          ...
          return r.createElement(
            ...
            this.props.showPicker && !o
              ? r.createElement(
                  ...
                  r.createElement(m.OutsideEvent, { mouseDown: !0, handler: this.props.onHidePicker }, (t) =>
                    r.createElement(
                      'span',
              ...
              endSlot:
                s && s.length
                  ...
                  : r.createElement(
                      f.EndSlot,
                      null,
                      r.createElement(d.Icon, { icon: this.props.icon, className: a(D.icon, n && D.disabled) }),
                    ),
              className: e,
      ...
      class E extends r.PureComponent {
          ...
          super(e),
            ...
            (this._returnFocusToInput = (e) => {
              ...
              this.setState({ autofocusCalendar: !1 }),
                null === (t = this._pickerInpuRef.current) || void 0 === t || t.focus(),
            ...
            (this._getErrors = () => {
              ...
              return this.state.isInvalid && e.push(s.t(null, void 0, n(46420))), e
            }),
            (this.state = {
              pickerInputKey: 0,
              date: e.initial,
        ...
        _getFontSizeClassName(e) {
          return e ? ('large' === e ? F.InputClasses.FontSizeLarge : F.InputClasses.FontSizeMedium) : void 0
        }
      }
    ...
    76056: (e, t, n) => {
      ...
      const p = n(30029)
      function f(e) {
        const { hasErrors: t, onClick: l, errors: u, className: c, theme: f = p, ...m } = e
        return s.createElement(
          'div',
          ...
          t && s.createElement(d, { text: r.t(null, void 0, n(27254)), className: f.tooltip }),
        )
      }
    },
    23935: (e, t, n) => {
      ...
      function S({ dateFrom: e, offset: t, level: n = 'day', maxIterations: s = 6, isDisabledDate: r = () => !1 }) {
    ...
    70412: (e, t, n) => {
      'use strict'
      n.d(t, { hoverMouseEventFilter: () => a, useAccurateHover: () => o, useHover: () => r })
      var s = n(50959)
      function r() {
    ...
    36565: (e, t, n) => {
      ...
      function w(e, t, n) {
        ...
        for (; a < i && o < l; ) {
          ...
          l
            ? (i.match(l.pattern)
                ? (s.push(i),
                  l.recursive && (-1 === u ? (u = a) : a === h && a !== u && (a = u - 1), h === u && (a -= 1)),
                  (a += 1))
                : i === f
                  ? (c--, (f = void 0))
                  : l.optional
              ...
              (o += 1))
            : (t || s.push(n), i === n ? (d.push(o), (o += 1)) : ((f = n), d.push(o + c), c++), (a += 1))
        }
        const m = e.charAt(h)
        i !== l + 1 || y[m] || s.push(m)
        const g = s.join(''),
      ...
      function N(e) {
        ...
        const n = (0, r.useRef)(null),
          ...
          y = I(g) ? g : R(g),
          [w, b] = (0, r.useState)(y),
          F = c || L().some((e) => null !== e && e.contains(document.activeElement))
        ...
        return r.createElement(
          ...
          r.createElement(_, {
            disabled: e.disabled,
            name: e.name,
            endSlot: r.createElement(u.EndSlot, { icon: !0 }, r.createElement(f, null)),
            reference: s,
            ...
            onFocus: function (t) {
              var n
              setTimeout(V, 0), null === (n = e.onFocus) || void 0 === n || n.call(e, t)
            },
            onBlur: function (e) {
              $(e) || Y(h)
            },
            ...
            onKeyDown: function (e) {
              if (e.defaultPrevented) return
              const t = (0, C.hashFromEvent)(e.nativeEvent)
              13 === t && (e.preventDefault(), Y(w), (0, i.ensureNotNull)(s.current).blur())
        ...
        function $(e) {
          return c && (null !== O(document.activeElement) || null !== O(e.relatedTarget))
        }
        function O(e) {
      ...
      function R(e) {
        const [t, n] = e.split(':'),
          [s, r] = [(0, D.clamp)(parseInt(t), 0, 23), (0, D.clamp)(parseInt(n), 0, 59)],
