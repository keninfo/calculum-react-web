  ...
  [7271],
  {
      ...
      function s() {
        ...
        return null !==
          (o =
            ...
            void 0 === t
              ? void 0
              : t.map((e) => ({ ...e, country: '', providerId: '', flag: '' }))) && void 0 !== o
          ? o
          : []
      }
    ...
    58442: (e, t, o) => {
      ...
      !(function (e) {
        ...
        function o(e) {
          {
            const t = r.enabled('pay_attention_to_ticker_not_symbol') ? e.ticker : e.name
    ...
    81319: (e, t, o) => {
      ...
      class r {
        ...
        name() {
          return (0, n.isAllSearchSourcesSelected)(this) ? s.t(null, void 0, o(34040)) : this._exchange.name
        }
        description() {
    ...
    56217: (e, t, o) => {
      ...
      const h = (0, d.getExchanges)(),
        m = {}
      for (const e of h) m[e.value] = { country: e.country, providerId: e.providerId }
      var y = o(88145)
      function S(e) {
          ...
          }
        {
          ...
          t.logo_urls &&
            ...
            (t.logo_urls.length > 1
              ? ((r.baseCurrencyLogoId = t.logo_urls[0]), (r.currencyLogoId = t.logo_urls[1]))
      ...
      function p(e, t, o, s) {
        return { id: void 0 !== o ? o.id() : e, symbol: e, checked: t, title: e, study: o, description: s }
      }
      var f = o(56840),
        g = o(76422),
        b = o(18429)
      class v {
        constructor(e) {
          ;(this._contentItemList = new a.WatchedValue([])),
            ...
            (this.removeStudy = (e) => {
              ...
              s && s.length > 1 ? this._removeStudyIdFromCheckedSymbols(t, o.id()) : this._checkedSymbols.delete(t),
                this._updateContentItemList(this._contentItemList.value(), !0)
            }),
            (this._getResolveSymbolPromise = (e, t) =>
              new Promise((o) => {
                const n = (0, s.ensureNotNull)(this._chartSession).resolveSymbol(
          ...
          Promise.all(d).then((e) => {
            ...
            e.forEach((e, n) => {
              const r = s[n],
                i = r.id()
              this._addStudyIdToCheckedSymbols(e, i), this._idToStudyMap.set(i, r), t.has(e) ? o.add(e) : c.add(e)
            })
            ...
            const i = Array.from(new Set(n))
            {
              ...
              Promise.all(t).then((t) =>
                this._handleInitProcess(
                  ...
                  (e, t, o, s) =>
                    'symbol_resolved' === e.method ? _(e.params[1], o, s) : p(t, o, s, this._getSymbolDescription(t)),
                ),
              )
            }
          })
          ...
          ;(() => {
            ...
            Promise.all([this._getResolveSymbolPromise(e), r]).then((t) =>
              this._handleApplyProcess(
                ...
                (e, t, o) => ('symbol_resolved' === e.method ? _(e.params[1], !0, o) : p(t, !0, o)),
              ),
            ),
              g.emit('add_compare')
          })()
        ...
        _handleApplyProcess(e, t, o) {
          ...
          const r = n.id(),
            i = t(s),
            a = o(s, i, n)
          this._saveRecent(i), this._addStudyIdToCheckedSymbols(i, r), this._showNewItem(a, i, r)
        }
        _handleInitProcess(e, t, o, s) {
          ...
          for (const r of e) {
            ...
            if (void 0 === a || c) this._recentSymbolsEnabled && n.push(s(e, i, !1))
            else for (const t of a) n.push(s(e, i, !0, this._idToStudyMap.get(t)))
          }
          this._updateContentItemList(n), this._isDataReady.setValue(!0)
        }
        _showNewItem(e, t, o) {
          const s = this._contentItemList.value().map(this._updateChecked, this)
          s.unshift(e),
            this._recentSymbolsEnabled && s.unshift({ ...e, id: t, study: void 0, checked: !1 }),
        ...
        _updateContentItemList(e, t) {
          ...
          if (this._recentSymbolsEnabled) {
            const e = new Set(),
              t = o
                .reduce((t, o) => (o.checked || e.has(o.symbol) || (t.push(o), e.add(o.symbol)), t), [])
        ...
        _loadRecent() {
          ...
          return f.getJSON('CompareDialog.recent', []).filter((e) => 'string' == typeof e)
        }
        _saveRecent(e) {
          if (!this._recentSymbolsEnabled) return
          const t = new Set(this._loadRecent())
          t.has(e) && t.delete(e), t.add(e), f.setJSON('CompareDialog.recent', Array.from(t).slice(-this._recentLength))
        }
