      ...
      class g extends d.CustomSourceBase {
        constructor(e, s, t) {
          super(e, s),
            ...
            (this._properties = new h.DefaultProperty({ defaultName: 'sessions' })),
            (0, l.applyDefaultsOverrides)(this._properties.childs().graphics, void 0, !1, y),
            ...
            s
              .timeScale()
              .logicalRangeChanged()
              .subscribe(this, this.updateAllViews.bind(this, (0, _.viewportChangeEvent)())),
            s.mainSeries().sessionIdProxyProperty().subscribe(this, this._updateVisibleOfPreAndPostMarketBackground),
            s.mainSeries().properties().childs().interval.subscribe(this, this._processHibernate),
            this._updateVisibleOfPreAndPostMarketBackground(s.mainSeries().properties().childs().sessionId)
        }
        applyOverrides(e) {
          ;(0, l.applyPropertiesOverrides)(this._properties.childs().graphics, void 0, !1, e, y),
        ...
        restart() {
          this._clearData(), u.enabled('stop_study_on_restart') && this.stop(), this.start()
        }
        isStarted() {
        ...
        destroy() {
          ;(this._destroyed = !0),
            ...
            this._model.mainSeries().properties().childs().interval.unsubscribeAll(this),
        ...
        graphics() {
          return this._loadedGraphics || (0, i.ensureNotNull)(this._studySource).graphics()
        }
        valueAt(e, s) {
          return null
        }
        ...
        state(e) {
          ...
          return (
            e &&
              null !== this._metaInfo &&
              (s.data = {
                graphics: (0, o.saveStudyGraphics)(this.graphics(), this._model.timeScale().visibleBarsStrictRange()),
            ...
            (e = (function (e, s) {
              ...
              return (
                void 0 !== e.data &&
                  void 0 !== e.metaInfo &&
                  s &&
                  (t.data = { metaInfo: e.metaInfo, graphics: e.data.graphics }),
                t
              )
            })(e, s))
          ...
          this._destroyed ||
            (null === this._loadedGraphics &&
              ...
              null !== this._metaInfo &&
                ...
                this._studySource
                  .dataCleared()
                  .subscribe(this, this.updateAllViews.bind(this, (0, _.sourceChangeEvent)(this.id()))),
                this._studySource
                  .dataUpdated()
                  .subscribe(this, this.updateAllViews.bind(this, (0, _.sourceChangeEvent)(this.id()))),
        ...
        _setMetaInfo(e) {
          ...
          void 0 !== s && void 0 !== s.inSession && delete s.inSession, (this._metaInfo = e)
        }
        ...
        _onPropertiesChanged() {
          this._processHibernate(), this.updateAllViews((0, _.sourceChangeEvent)(this.id()))
        }
        _processHibernate() {
          if (null !== this._studySource) {
            ...
            !s && e && t ? this._studySource.stop() : !s || e || t || this._studySource.start()
          }
        }
        _canBeHibernated() {
        ...
        _migrateOutOfSessionProperty(e) {
          ...
          if (void 0 !== s) {
            ...
            t.color === (0, i.ensureDefined)(p.sessionsPreferencesDefault.graphics.backgrounds).outOfSession.color ||
              'postMarket' in s ||
