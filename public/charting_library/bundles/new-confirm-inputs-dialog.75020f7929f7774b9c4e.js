    ...
    29638: (t, e, n) => {
      ...
      function d(t) {
        ...
        function M() {
          ...
          for (const e of d) if ('symbol' === e.type && !e.optional && '' === t[e.id]) return !0
          return !1
        }
        function k(t, e) {
          null == b || b(t, e), E(M())
      ...
      class m extends f.DialogRenderer {
        constructor(t, e, n, i, o, s, l, r, u) {
          super(),
            (this._handleClose = () => {
              var t
              null === (t = this._rootInstance) || void 0 === t || t.unmount(), this._setVisibility(!1), this._onClose()
            }),
            (this._title = t),
      ...
      async function u(t, e, o, u, a) {
            ...
            if ((0, l.isInputInlines)(t)) {
              ...
              if (e) {
                const { time: i, price: o } = e,
                  l = i.inline
                    ? s.t(null, { replace: { inputInline: i.inline, studyShortDescription: u } }, n(10679))
                    : s.t(null, { replace: { studyShortDescription: u } }, n(92229)),
                  r = m(t.id)
        ...
        async function f(t) {
          const e = 'time' === t.type,
            ...
            o = (function () {
              ...
              const i = t.name
                  ? s.t(null, { replace: { inputTitle: t.name, studyShortDescription: u } }, n(59451))
                  : s.t(null, { replace: { studyShortDescription: u } }, n(60935)),
                o = t.name
                  ? s.t(null, { replace: { inputTitle: t.name, studyShortDescription: u } }, n(94238))
                  : s.t(null, { replace: { studyShortDescription: u } }, n(24404))
              return e ? i : o
            })(),
            l = e ? t.id : void 0,
            r = e ? void 0 : t.id
        ...
        async function h(e, n, s, l, u) {
          const a = await t.requestSelectPoint(
            { pointType: n, pane: c, lineColor: void 0, selectPointMode: r.SelectPointMode.Study },
            s,
          )
          void 0 === c && (c = a.pane)
          const p = o.childs().inputs
          p &&
            (l && (0, i.ensureDefined)(p.child(l)).setValue(1e3 * (a.point.time || 0)),
