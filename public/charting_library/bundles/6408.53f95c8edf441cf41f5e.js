;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6408],
  {
    ...
    41590: (e, t, n) => {
      ...
      var v
      function h(e) {
        const { position: t = 'Bottom', onClose: n, children: m, reference: v, className: h, theme: p = u } = e,
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              w === f.currentDrawer && o.createElement('div', { className: u.backdrop, onClick: n }),
              o.createElement(
                d,
                { className: a(p.drawer, u[`position${t}`], h), ref: g, 'data-name': e['data-name'] },
                m,
              ),
            ),
          )
    ...
    47291: (e, t, n) => {
      ...
      function d(e) {
        ...
        return o.createElement(
          h.Provider,
          { value: (0, o.useMemo)(() => ({ size: i, onSelect: l, ItemComponent: s, RowComponent: m }), [i, l, s, m]) },
      ...
      const p = o.memo((e) => {
        const { style: t, index: n, data: r } = e,
          a = r[n],
          { size: i, onSelect: l, ItemComponent: u, RowComponent: v = s.EmojisRow } = (0, m.useEnsuredContext)(h)
        return 'title' === a.type
          ? o.createElement('div', { style: t }, o.createElement(c, { title: a.relatedTitle }))
          : o.createElement(
              'div',
              { style: t },
              o.createElement(v, { emojis: a.content, itemSize: i, onEmojiClick: l, ItemComponent: u }),
            )
      })
    },
    38297: (e, t, n) => {
      ...
      function h(e) {
        ...
        const [y, I] = (0, o.useState)((null === (t = k[0]) || void 0 === t ? void 0 : t.relatedTitle) || ''),
          N = (0, o.useCallback)((e) => {
            E.current || I(e)
          }, [])
        return o.createElement(
          ...
          o.createElement(l.GroupTabs, {
            ...
            onTabClick: function (e) {
              ...
              S(
                (function (e) {
                  return k.findIndex(({ relatedTitle: t, type: n }) => 'title' === n && t === e)
                })(e),
              )
            },
          }),
        ...
        function S(e) {
          var t
          s.CheckMobile.iOS() && z.current && (z.current.style.overflow = 'hidden'),
            (E.current = !0),
            null === (t = b.current) || void 0 === t || t.scrollToItem(e, 'start'),
            requestAnimationFrame(() => {
              var t
              null === (t = b.current) || void 0 === t || t.scrollToItem(e, 'start'),
                s.CheckMobile.iOS() && z.current && (z.current.style.overflow = 'auto'),
                (E.current = !1)
            })
        }
      }
    ...
    26601: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        l = n(95702)
      const c = o.memo((e) => {
        const { emojis: t, itemSize: n, onEmojiClick: r, ItemComponent: c, className: s } = e
        return o.createElement(
          'div',
    ...
    85034: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        c = n(60621)
      function s(e) {
        const { tab: t, isActive: n, onTabClick: r, children: i, className: s } = e,
      ...
      var m = n(69412)
      function u(e) {
        const { activeTab: t, tabs: n, onTabClick: r, className: l, tabClassName: c } = e
        return o.createElement(
          i.Toolbar,
          { orientation: 'horizontal', className: a()(m.wrapper, l), blurOnEscKeydown: !1 },
          n.map(({ title: e, content: n }) =>
            o.createElement(s, { key: e, tab: e, className: c, isActive: t === e, onTabClick: r }, n),
          ),
        )
      }
    },
    ...
    83682: (e, t, n) => {
      ...
      const u = 34
      function v(e) {
        const { className: t, emoji: n, size: r = u, onClick: i, ItemComponent: l = c } = e,
    ...
    20243: (e, t, n) => {
      ...
      function c(e) {
        ...
        switch ((0, o.mapKeyCodeToDirection)(n)) {
          case 'inlinePrev':
            if (!p.length) return
            e.preventDefault(), g(0 === f ? c[d] : w ? m(p, f, -1) : p[p.length - 1])
            break
          case 'inlineNext':
            if (!p.length) return
            e.preventDefault(), f === p.length - 1 ? g(c[d]) : g(w ? m(p, f, 1) : p[0])
            break
          case 'blockPrev': {
            e.preventDefault()
            const t = m(c, d, -1)
          ...
          o.createElement('div', {
            ...
            onKeyDown: (0, a.createSafeMulticastEventHandler)(function (e) {
              ...
              const a = () => {
                  ...
                  ;(0, c.becomeSecondaryElement)(o[r]), (0, c.becomeMainElement)(o[e]), o[e].focus()
                },
                s = () => {
                  const e = (r + o.length + 1) % o.length
                  ;(0, c.becomeSecondaryElement)(o[r]), (0, c.becomeMainElement)(o[e]), o[e].focus()
