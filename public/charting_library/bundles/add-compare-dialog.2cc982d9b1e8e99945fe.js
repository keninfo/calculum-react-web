  ...
  [731],
  {
    59142: function (e, t) {
      ...
      ;(n = [t]),
                ...
                ;(r = [].concat(t(r), [m])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !d(o.target) &&
                        ((n && 0 === n.scrollTop && 0 < r) ||
                        ((a = n) && a.scrollHeight - a.scrollTop <= a.clientHeight && r < 0)
                          ? u(o)
                          : o.stopPropagation()))
                  }),
                  l || (document.addEventListener('touchmove', u, o ? { passive: !1 } : void 0), (l = !0))
              }
            } else {
              ;(h = n),
                setTimeout(function () {
            ...
            (e.clearAllBodyScrollLocks = function () {
              a
                ? (r.forEach(function (e) {
                  ...
                  l && (document.removeEventListener('touchmove', u, o ? { passive: !1 } : void 0), (l = !1)),
                  (r = []),
                  (i = -1))
                : (m(), (r = []))
            }),
            (e.enableBodyScroll = function (e) {
              if (a) {
                ...
                ;(e.ontouchstart = null),
                  ...
                  l &&
                    0 === r.length &&
                    (document.removeEventListener('touchmove', u, o ? { passive: !1 } : void 0), (l = !1))
              } else
        ...
        void 0 === (a = 'function' == typeof o ? o.apply(t, n) : o) || (e.exports = a)
    },
    57723: (e) => {
      e.exports = {
    ...
    14283: (e, t, o) => {
      ...
      function M(e) {
        ...
        return n.createElement(
          ...
          {
            type: 'button',
            className: s()(c, t.button, r && t.selected, l && !r && !i && t.bordersVisible),
            name: u,
            value: d,
            onClick: a,
          },
      ...
      var _ = o(46148)
      function B(e) {
        const { compareModel: t, selectedCompareOptionIndex: r } = (0, w.useEnsuredContext)(y),
          ...
          i = (0, n.useMemo)(
            () =>
              (function (e) {
                return [
                  {
                    label: e ? a.t(null, void 0, o(38137)) : a.t(null, void 0, o(56136)),
                    compareOption: e ? _.CompareOption.SameScale : _.CompareOption.SamePctScale,
                  },
                  { label: a.t(null, void 0, o(60126)), compareOption: _.CompareOption.NewPriceScale },
                  { label: a.t(null, void 0, o(63456)), compareOption: _.CompareOption.NewPane },
                ]
              })(l),
            [l],
          )
        return [
          (0, n.useMemo)(() => {
            var e, t
            return null !== (t = null === (e = i[r]) || void 0 === e ? void 0 : e.compareOption) && void 0 !== t
              ? t
              : i[0].compareOption
          }, [i, r]),
          i,
      ...
      var L = o(3273)
      function O(e) {
        const { fullSymbolName: t, isSelected: r, className: l, isYield: c } = e,
          { isMobile: d, searchRef: u, setMode: m } = (0, w.useEnsuredContext)(b.SymbolSearchItemsDialogContext),
          {
            compareModel: p,
            setHoveredItemId: h,
            clearInput: v,
        ...
        return d
          ? n.createElement(
              ...
              n.createElement(
                ...
                n.createElement('div', { className: L.header }, a.t(null, void 0, o(60085))),
                x.map(({ label: e, compareOption: t }) =>
                  n.createElement(C.PopupMenuItem, { key: t, className: L.item, onClick: M, onClickArg: t, label: e }),
                ),
              ),
            )
          : n.createElement(
              'div',
              { className: s()(L.wrap, l), 'data-name': 'compare-buttons-group' },
              x.map(({ label: e, compareOption: t }) =>
                n.createElement(
                  N,
                  { key: t, onClick: M, value: t, isItemSelected: Boolean(r), isSelected: r && S === t },
                  e,
                ),
              ),
            )
      ...
      function T(e) {
        const { isSelected: t, fullSymbolName: o, onExpandClick: a, actions: l, id: c, isOffset: s, isYield: d } = e,
          {
            isMobile: u,
            toggleExpand: m,
            searchSpreads: p,
        ...
        return n.createElement(
          ...
          n.createElement(S.SymbolSearchDialogContentItem, {
            ...
            reference: B,
            onClick: function (t) {
              if (Boolean(a) && c && !s) return null == t || t.preventDefault(), void m(c)
      ...
      var A = o(15550),
        ...
        H = o(11144)
      function V(e) {
        const { handleListWidth: t } = (0, d.ensureNotNull)((0, n.useContext)(b.SymbolSearchItemsDialogContext)),
          { compareModel: r, selectedCompareIndex: l, selectedItemRef: i } = (0, d.ensureNotNull)((0, n.useContext)(y)),
          c = (0, p.useWatchedValueReadonly)({ watchedValue: r.isDataReady() }),
          x = (0, p.useWatchedValueReadonly)({ watchedValue: r.studies() }),
          w = (0, p.useWatchedValueReadonly)({ watchedValue: r.highlightedSymbol() }),
          I = (0, n.useMemo)(() => x.filter((e) => e.checked), [x]),
          C = (0, n.useMemo)(() => x.filter((e) => !e.checked), [x])
        return (
          (0, n.useEffect)(
            () => (
              r.chartModel().dataSourceCollectionChanged().subscribe(r, r.handleSourcesChange),
              () => r.chartModel().dataSourceCollectionChanged().unsubscribe(r, r.handleSourcesChange)
            ),
            [r],
          ),
          n.createElement(
            ...
            (e) =>
              n.createElement(
                ...
                (function () {
                  if (!c) return n.createElement('div', { className: H.spinnerWrap }, n.createElement(h.Spinner, null))
                  if (!Boolean(I.length) && !Boolean(C.length)) {
                    ...
                    return n.createElement(
                      ...
                      n.createElement('div', { className: H.text }, a.t(null, void 0, o(37094))),
                    )
                  }
                  return n.createElement(
                    n.Fragment,
                    ...
                    Boolean(I.length) &&
                      n.createElement(
                        n.Fragment,
                        null,
                        n.createElement('div', { className: H.heading }, a.t(null, void 0, o(46622))),
                        I.map((e, t) =>
                          n.createElement(S.SymbolSearchDialogContentItem, {
                            ...
                            actions: n.createElement(
                              ...
                              n.createElement(
                                M,
                                { className: H.checkbox, onClick: E.bind(null, e), isSelected: k(e) },
                    ...
                    Boolean(C.length) &&
                      n.createElement(
                        n.Fragment,
                        null,
                        n.createElement('div', { className: H.heading }, a.t(null, void 0, o(8926))),
                        C.map((e) =>
                          n.createElement(T, {
        ...
        constructor(e) {
          super(e),
            ...
            (this._toggleAllowExtendTimeScale = () => {
              ...
              P.setValue('showAddSymbolDialog.extendCheckboxState', e), this.setState({ allowExtendTimeScale: e })
            }),
            (this.state = {
              selectedCompareOptionIndex: 0,
              selectedCompareIndex: -1,
              hoveredItemId: void 0,
              allowExtendTimeScale: Boolean(P.getBool('showAddSymbolDialog.extendCheckboxState')),
            })
        }
        render() {
          const { children: e } = this.props
          return n.createElement(y.Provider, { value: this._getContextValue() }, e)
        }
      }
      var K = o(68335),
        W = o(79418),
      ...
      function Y(e) {
        ...
        return (
          ...
          n.createElement(W.AdaptivePopupDialog, {
            ...e,
            className: c(X.dialog, !m && (h ? X.tabletDialog : X.desktopDialog)),
            onKeyDown: function (e) {
              ...
              switch (a) {
                case 13: {
                  if (T)
                    return void (function () {
                      if (-1 === k) return
                      const e = L[k]
                      e.checked ? S.removeStudy(e) : S.applyStudy(e.symbol, V, _)
                      D(-1)
                    })()
                  const t = G()
                  if (t) return e.preventDefault(), void l(t)
                  e.preventDefault()
                  const a = null === (n = null == o ? void 0 : o.current) || void 0 === n ? void 0 : n.value.trim()
                  return void (
                    a &&
                    N &&
                    (i([
                ...
                case 27:
                  return e.preventDefault(), A ? void d('symbolSearch') : void v()
              }
              if (!T && 'good' !== g) return
        ...
        function Y() {
          var e
          null === (e = M.current) || void 0 === e || e.scrollIntoView({ block: 'nearest' })
        }
        function G() {
          if (!O) return
      ...
      class Q extends U.DialogRenderer {
        ...
        show(e) {
          ...
          ;(this._rootInstance = (0, Z.createReactRoot)(t, this._container)), this._setVisibility(!0)
        }
        hide() {
          var e, t, o
          null === (e = this._rootInstance) || void 0 === e || e.unmount(),
            this._visibility.setValue(!1),
            null === (o = (t = this._props).onClose) || void 0 === o || o.call(t)
        }
      }
      var $ = o(81319),
        q = o(69654),
        J = o(70613)
      function ee(e) {
        const { searchRef: t, setMode: o } = (0, w.useEnsuredContext)(b.SymbolSearchItemsDialogContext),
          { currentMode: a } = (0, w.useEnsuredContext)(J.SymbolSearchDialogBodyContext)
        return (
          (0, n.useEffect)(() => {
            const e = t.current
            if (e)
        ...
        function r() {
          ...
          t.current &&
            ...
            ('compare' !== a.current ||
            '' ===
              (null === (n = null === (e = null == t ? void 0 : t.current) || void 0 === e ? void 0 : e.value) ||
              void 0 === n
                ? void 0
                : n.trim())
              ? 'symbolSearch' === a.current &&
                '' ===
                  (null === (l = null === (r = null == t ? void 0 : t.current) || void 0 === r ? void 0 : r.value) ||
                  void 0 === l
                    ? void 0
                    : l.trim()) &&
                o('compare')
      ...
      var te = o(70673),
        ...
        ne = o(45128)
      function ae(e) {
        const { allowExtendTimeScale: t, toggleAllowExtendTimeScale: r } = (0, d.ensureNotNull)((0, n.useContext)(y))
        return n.createElement(
          ...
          n.createElement(
            ...
            n.createElement(te.CheckboxInput, { checked: t, value: t ? 'on' : 'off', onChange: r }),
            n.createElement('span', { className: ne.label }, a.t(null, void 0, o(1048))),
          ),
        )
      }
      ...
      function le(e) {
        return new Q({
          wrapper: ((t = e), (e) => n.createElement(F, { ...e, compareModel: t })),
          dialog: Y,
          contentItem: T,
          initialScreen: V,
          searchInput: ee,
    ...
    41590: (e, t, o) => {
      ...
      var m
      function p(e) {
        const { position: t = 'Bottom', onClose: o, children: d, reference: m, className: p, theme: v = u } = e,
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              g === f.currentDrawer && n.createElement('div', { className: u.backdrop, onClick: o }),
              n.createElement(
                h,
                { className: r(v.drawer, u[`position${t}`], p), ref: b, 'data-name': e['data-name'] },
                d,
              ),
            ),
          )
      ...
      const h = (0, n.forwardRef)((e, t) => {
        ...
        return n.createElement(d.TouchScrollContainer, { className: r(u.drawer, o), tabIndex: -1, ref: t, ...a })
      })
    },
    70412: (e, t, o) => {
      'use strict'
      o.d(t, { hoverMouseEventFilter: () => r, useAccurateHover: () => l, useHover: () => a })
      var n = o(50959)
      function a() {
          ...
          (0, n.useLayoutEffect)(() => {
            if (l.CheckMobile.iOS())
              return (
                ...
                null !== s.current &&
                  (i
                    ? 1 === c && (document.body.style.overscrollBehavior = 'none')
                    : (0, a.disableBodyScroll)(s.current, { allowTouchMove: d(s) })),
                () => {
                  c--,
                    null !== s.current &&
                      (i
                        ? 0 === c && (document.body.style.overscrollBehavior = '')
