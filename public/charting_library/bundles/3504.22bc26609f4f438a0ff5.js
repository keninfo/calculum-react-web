  ...
  [3504],
  {
    ...
    36383: (e, t, o) => {
      ...
      var n = o(50959),
        ...
        l = o(27267)
      function r(e) {
        const { click: t, mouseDown: o, touchEnd: r, touchStart: a, handler: s, reference: c } = e,
          d = (0, n.useRef)(null),
    ...
    9745: (e, t, o) => {
      ...
      const i = n.forwardRef((e, t) => {
        const { icon: o = '', title: i, ariaLabel: l, ariaLabelledby: r, ariaHidden: a, ...s } = e,
          c = !!(i || l || r)
      ...
      const n = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            null === (t = o.parentNode) || void 0 === t || t.removeChild(o), (e = i - r)
          }
          return e
        }
      })()
      ...
      function c(e) {
        ...
        if (e && 1 == ++a) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (i(o, 'right', `${n()}px`), (t.style.paddingRight = `${a + n()}px`), (s = !0)),
            t.classList.add('i-no-scroll')
        } else if (!e && a > 0 && 0 == --a && (t.classList.remove('i-no-scroll'), s)) {
          i(o, 'right', '0px')
          let e = 0
          0, t.scrollHeight <= t.clientHeight && (e -= n()), (t.style.paddingRight = (e < 0 ? 0 : e) + 'px'), (s = !1)
        }
      }
    },
    24437: (e, t, o) => {
    ...
    59369: (e, t, o) => {
        ...
        return (
          (0, n.useLayoutEffect)(() => {
            const e = (0, i.ensureNotNull)(t.current),
              o = () => {
                const o = (0, l.queryTabbableElements)(e).sort(l.navigationOrderComparator)
                if (0 === o.length || (o[0].parentElement && !u(o[0].parentElement, (0, i.ensureNotNull)(t.current)))) {
                  const n = (function (e) {
                    const o = h(e)
                  ...
                  if (null === n) return
                  if (((0, a.becomeMainElement)(n), o.length > 0)) for (const e of o) (0, a.becomeSecondaryElement)(e)
                }
              }
            return (
          ...
          [
            ...
            function (t) {
              ...
              if (e) {
                ...
                (a = ((u = i),
                Array.from(u.querySelectorAll('button:not([disabled]):not([aria-disabled])')).filter(
                  (0, l.createScopedVisibleElementFilter)(u),
                )).sort(l.navigationOrderComparator)),
                  (c = a.indexOf(n))
              var u
              ...
              switch (g) {
                ...
                case 'blockNext':
                  ;((o) => {
                    ...
                    if (!l) return
                    const r = Array.from(l.children).indexOf(document.activeElement)
                    if (-1 === r) return
                    const a = n['blockNext' === o ? n.indexOf(l) + 1 : n.indexOf(l) - 1]
                    if (!a) return
                    t.preventDefault()
      ...
      function h(e) {
        return Array.from(e.querySelectorAll('[data-role="row"]')).filter((0, l.createScopedVisibleElementFilter)(e))
      }
      function u(e, t) {
    ...
    59695: (e, t, o) => {
      ...
      function a(e) {
        ...
        const l = (0, i.getStyleClasses)(e.size, e.className),
          r = null !== (o = null !== (t = e.alt) && void 0 !== t ? t : e.title) && void 0 !== o ? o : ''
    ...
    16396: (e, t, o) => {
      'use strict'
      o.d(t, { DEFAULT_POPUP_MENU_ITEM_THEME: () => d, PopupMenuItem: () => u })
      var n = o(50959),
        i = o(97754),
        l = o(51768),
        r = o(59064),
      ...
      function u(e) {
        ...
        return n.createElement(
          X,
          {
            ...
            id: t,
            role: o,
            className: i(d, K.item, w && K.withIcon, { [K.isActive]: L, [K.isDisabled]: T || y, [K.hovered]: b }),
            title: u,
            href: A,
            target: E,
            rel: k,
            ...
            onContextMenu: function (e) {
              W && J && (0, l.trackEvent)(W.category, W.event, `${W.label}_rightClick`)
            },
            onMouseUp: function (e) {
              if (1 === e.button && A && W) {
                let e = W.label
                q && (e += '_mouseWheelClick'), (0, l.trackEvent)(W.category, W.event, e)
              }
            },
            onMouseOver: D,
            onMouseOut: F,
          ...
          B &&
            n.createElement(a.CircleLogo, {
              ...
              size: 'xxxsmall',
              logoUrl: B.logoUrl,
              placeholderLetter: 'placeholderLetter' in B ? B.placeholderLetter : void 0,
            }),
          w &&
          ...
          (void 0 !== f || p) &&
            n.createElement('span', { className: K.shortcut }, (Y = f) && Y.split('+').join(' + ')),
          void 0 !== P &&
            n.createElement(
              'span',
              { onClick: _ ? h : void 0, className: i(m, K.toolbox, { [K.showOnHover]: M, [K.showOnFocus]: C }) },
              P,
            ),
        )
        var Y
      ...
      class s extends n.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            i.createPortal(n.createElement(c.Provider, { value: this }, this.props.children), e)
          )
        }
        moveToTop() {
    ...
    2627: (e, t, o) => {
      ...
      const u = (0, d.humanReadableModifiers)(d.Modifiers.Shift, !1),
        ...
        w = {
          ...
          LineToolGannFixed: {},
          LineToolGannFan: {},
          LineToolGannSquare: { hotKey: (0, l.hotKeySerialize)({ keys: [u], text: i.t(null, void 0, o(83042)) }) },
          LineToolHeadAndShoulders: {},
          LineToolHorzLine: { hotKey: (0, l.hotKeySerialize)({ keys: [v, 'H'], text: '{0} + {1}' }) },
          LineToolHorzRay: {},
          LineToolIcon: {},
          LineToolImage: {},
          LineToolEmoji: {},
          ...
          LineToolProjection: {},
          LineToolRay: {},
          LineToolRectangle: { hotKey: (0, l.hotKeySerialize)({ keys: [u], text: i.t(null, void 0, o(10539)) }) },
          LineToolCircle: {},
          ...
          LineToolVertLine: { hotKey: (0, l.hotKeySerialize)({ keys: [v, 'V'], text: '{0} + {1}' }) },
          LineToolCrossLine: {},
          LineToolHighlighter: {},
          LineToolGhostFeed: {},
          ...
          hideAllDrawings: {
            ...
            hotKey: (0, l.hotKeySerialize)({ keys: [g, v, 'H'], text: '{0} + {1} + {2}' }),
          },
          lockAllDrawings: { iconActive: a.drawingToolsIcons.lockAllDrawingsActive },
          magnet: { hotKey: (0, l.hotKeySerialize)({ keys: [g], text: '{0}' }) },
          measure: { hotKey: (0, l.hotKeySerialize)({ keys: [u], text: i.t(null, void 0, o(92949)) }) },
      ...
      Object.entries(w)
        .map(([e, t]) => {
          var o, i
          const l = null !== (o = r.lineToolsIcons[e]) && void 0 !== o ? o : a.drawingToolsIcons[e]
          ;(0, n.assert)(!!l, `Icon is not defined for drawing "${e}"`)
          const d = null !== (i = c.lineToolsLocalizedNames[e]) && void 0 !== i ? i : s[e]
          ;(0, n.assert)(!!d, `Localized name is not defined for drawing "${e}"`)
          return { ...t, name: e, icon: l, localizedName: d, selectHotkey: h.lineToolsSelectHotkeys[e] }
        })
        .forEach((e) => {
          x[e.name] = e
        })
    ...
    26744: (e, t, o) => {
      ...
      !(function (e) {
        function t() {
          ...
          e.favorites = []
          let s = !1
          const c = Boolean(void 0 === (0, l.getValue)('chart.favoriteDrawings')),
            d = (0, l.getJSON)('chart.favoriteDrawings', [])
          if (0 === d.length && c && 'undefined' != typeof window) {
            const e = JSON.parse(
              null !== (n = null === (t = window.urlParams) || void 0 === t ? void 0 : t.favorites) && void 0 !== n
                ? n
                : '{}',
            ).drawingTools
          ...
          ;(e.favoriteAdded = new n.Delegate()),
            ...
            (e.addFavorite = function (o, n) {
              return (
                ...
                (s.favorites.push(o), s.saveFavorites(n), e.favoriteAdded.fire(o), !0)
              )
            }),
