...
;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    98653: (e, t, i) => {
      i.r(t), i.d(t, { SavingLineToolsError: () => o, SavingLineToolsLibraryError: () => n })
    ...
    49053: (e, t, i) => {
      ...
      const h = function e(t, i, o, s, r) {
        ...
        for (o || (o = d), r || (r = []); ++l < a; ) {
          var h = t[l]
          i > 0 && o(h) ? (i > 1 ? e(h, i - 1, o, s, r) : (0, n.default)(r, h)) : s || (r[r.length] = h)
        }
        return r
      }
      const u = function (e) {
      ...
      class m {
        constructor(e, t, i) {
          ;(this._pendingRequests = new Map()),
            (this._startRequestingDebounced = (0, o.default)(() => this._startNextRequest(), 500)),
            (this._layoutId = e),
            (this._chartId = t),
        ...
        resolveLinkKey(e, t, i) {
          ...
          const n = (function (e, t) {
            ...
            s = null !== (o = this._pendingRequests.get(n)) && void 0 !== o ? o : new Map()
          if (s.has(t)) return s.get(t).promise
          const r = (0, y.createDeferredPromise)()
          return s.set(t, r), this._pendingRequests.set(n, s), this._startRequestingDebounced(), r.promise
        }
        async _startNextRequest() {
          ...
          try {
            const t = await e.loadLineToolsAndGroups(this._layoutId, this._chartId, s, i)
            null !== t &&
              null !== t.sources &&
      ...
      class w extends I.StudyStub {
        constructor(e, t, i) {
          ...
          super(e, { ...t, ownFirstValue: null }, i),
            (this._linkKey = new b.WatchedValue(null !== (o = t.linkKey) && void 0 !== o ? o : null))
        }
        linkKey() {
      ...
      !(function (e) {
        ;(e[(e.AutosaveDebounce = 500)] = 'AutosaveDebounce'), (e[(e.BanCoolingTimeout = 3e5)] = 'BanCoolingTimeout')
      })(R || (R = {}))
      const F = /(\w+)\/(\w+)\/(\w+)/
      class V {
        constructor(e, t, i) {
          ;(this._invalidatedLineToolsAndStudyStubs = new Map()),
            ...
            (this._debouncedSave = (0, o.default)(() => this._saveInvalidatedIfRequired(!1), 500)),
        ...
        resetInvalidated(e, t, i) {
          ...
          const { groups: n, sources: s, lineToolsToValidate: r, groupsToValidate: l } = t,
            a = N(this._invalidatedLineToolsAndStudyStubs, e, new Set(null != r ? r : s.keys()))
          ;(this._invalidatedLineToolsAndStudyStubs = a.stillInvalidated),
            a.validated.forEach(
              o.bind(this, this._originalLineToolSharingMode, this._setOriginalLineToolSharingMode.bind(this), s),
            )
          const d = N(this._invalidatedLineToolGroups, e, new Set(null != l ? l : n.keys()))
          a.validated.forEach(
            o.bind(
              this,
        ...
        applyLineToolUpdateNotification(e, t) {
          ...
          ;(o.clientId === this._origin.clientId && o.chartId === this._origin.chartId) ||
            (void 0 !== e.symbol && null === e.sources
              ? this._withoutInvalidating(() => {
                  const i = this._chartModel
                    .dataSources()
                    .filter(S.isLineTool)
                    .filter((i) => i.sharingMode().value() === t && i.symbol() === e.symbol)
        ...
        flushPendingSavings() {
          return this._invalidatedLineToolGroups.size || this._invalidatedLineToolsAndStudyStubs.size
        ...
        _processDataSourceCollectionChanged(e) {
          ...
          if (this._allLineToolsAndStudyStubs.has(e.id())) {
            const i = (0, c.ensureDefined)(this._allLineToolsAndStudyStubs.get(e.id()))
            ;(n = t.filter((e) => !i.has(e.id()))),
              n.forEach((e) => this._invalidateLineToolOrStudyStub(e.id(), s)),
              Array.from(i.entries())
                .filter((e) => !o.has(e[0]))
                .forEach((e) => {
                  null !== e[1] && this._debouncedSave(), this._invalidateLineToolOrStudyStub(e[0], s)
                })
          } else (n = t), t.forEach((e) => this._invalidateLineToolOrStudyStub(e.id(), s))
          n.forEach((e) => {
            if ((0, S.isLineTool)(e)) {
        ...
        _unloadLineTools(e, t, i) {
          ...
          this._withoutInvalidating(() => {
            o.forEach((e) => {
              ...
              ;(null !== (t = this._allLineToolsAndStudyStubs.get(i.id())) && void 0 !== t ? t : new Map()).delete(
                e.id(),
              )
            }),
        ...
        _unloadLinesOnSeries(e, t, i) {
          ...
          this._unloadLineTools(n, (e) => e.boundToSymbol() && e.ownerSource() === o, t)
        }
        _isAutosaveEnabled() {
          return !1
        }
          ...
          const o = this.prepareDTO(e),
            n = k
              .map((e) => {
                ...
                const r = null !== (t = s.lineToolsToValidate) && void 0 !== t ? t : Array.from(s.sources.keys()),
                  l = null !== (n = s.groupsToValidate) && void 0 !== n ? n : Array.from(s.groups.keys())
                  ...
                  return (
                    ...
                    (0, c.ensureNotNull)(this._saveChartService)
                      ...
                      .catch(async (t) => {
                        ...
                        {
                          const { SavingLineToolsLibraryError: e } = await Promise.resolve().then(i.bind(i, 98653))
                          if (t instanceof e && t.safe) return
                        }
                        if (!(0, E.isAbortError)(t)) throw t
                        G.logDebug(`Save request has been aborted. ChartId: ${this._origin.chartId} sharingMode: ${e}`)
                      })
                  )
                }
        ...
        async _savePromise(e, t) {
          ...
          return this._isAutosaveEnabled()
            ? null !== (o = null === (i = this._debouncedSave) || void 0 === i ? void 0 : i.flush()) && void 0 !== o
              ? o
              : Promise.resolve()
        ...
        _seriesLineToolsUnloader(e, t, i) {
          ...
          'mainSeriesLineTools' === e.requestType &&
            ...
            (this._unloadLinesOnSeries(i, e.sharingMode, t), this._currentlyLoadedSymbol.set(e.sharingMode, e.symbol))
        }
        ...
        _onSymbolResolved(e) {
          const t = k.map((t) => {
            const i = {
              ...
              o = this._seriesLineToolsUnloader.bind(this, i, this._mainPaneLineToolsAndStubs())
            return this._makeLoadRequestAndMerge(i, o, e.pro_name || e.ticker || e.full_name)
          })
          Promise.all(t).then(() => {
            this._withoutInvalidating(() => {
              this._chartModel
        ...
        async _makeLoadRequestAndMerge(e, t, i) {
          ...
          const n = this._chartModel.mainSeries(),
            s = null !== (o = this._currentlyLoadedSymbol.get(e.sharingMode)) && void 0 !== o ? o : ''
          ...
          return this._savePromise('mainSeriesLineTools' === e.requestType)
            .catch(() => {})
            .then(() => r.loadLineToolsAndGroups(this._origin.layoutId, this._origin.chartId, e, i))
            .catch(() => null)
            .then(async (i) => {
              ...
              if (null === t) {
                if (r) {
                  ...
                  r.lineTools()[0].sharingMode().value() === i &&
                    ((e && 0 !== i) ||
                      (new M.ExcludeLineToolsFromGroupUndoCommand(this._chartModel, r, r.lineTools()).redo(),
        ...
        _createNewLineTool(e) {
          ...
          if (null !== n) {
            ...
            e.set(n.id(), n.linkKey().value()), this._allLineToolsAndStudyStubs.set(i.id(), e)
          }
          return n
        }
        ...
        _restoreLineTool(e, t, i, o) {
          var n
          if ((null !== (n = t.state.points) && void 0 !== n ? n : []).some((e) => !(0, T.isNumber)(e.time_t)))
            return null
          let s = this._chartModel.dataSourceForId(t.id)
          if (
            (null === s && t.state.linkKey && (s = (0, S.lineToolByLinkKey)(this._chartModel, t.state.linkKey)),
            null !== s && !(0, S.isLineTool)(s))
          )
            return null
          if (this._origin.clientId === (null == o ? void 0 : o.clientId) && !s) return null
          if (s && t.serverUpdateTime) {
            const n = t.serverUpdateTime,
              r = s.serverUpdateTime()
            if ((null !== e && e >= n) || (null !== r && r >= n))
              return (
                0 !== i && (s.share(i), this._setOriginalLineToolSharingMode(s.id(), i)),
            ...
            this._origin.clientId !== (null == o ? void 0 : o.clientId) &&
              ...
              s.sharingMode().value() !== i && (s.share(i), this._setOriginalLineToolSharingMode(s.id(), i)),
        ...
        _removeLineTool(e) {
          const t = this._chartModel.dataSourceForId(e)
          null !== t && new L.RemoveSourcesUndoCommand(this._chartModel, [t], null).redo()
        }
        _removeTextLineToolIfEmpty(e) {
          return (
            !(!e.removeIfEditableTextIsEmpty() || 0 !== e.editableTextProperties().text.value().length) &&
            (this._chartModel.removeSource(e), this._invalidateLineToolOrStudyStub(e.id(), performance.now(), !0), !0)
          )
        }
        ...
        async _applyLineToolsAndGroupsDTO(e, t, i) {
          const o = this._chartModel.chartSaveTime(),
            n = this._withoutInvalidating(() => this._restoreGroups(o, e, t, i)),
                ...
                ;(e.sources || new Map()).forEach((e, s) => {
                  try {
                    if (e && (0, O.isMtpPredictorToolName)(e.state.type))
                      return void G.logWarn(`No longer supported tool ${e.state.type} is skipped while restoring state`)
        ...
        _invalidateLineToolOrStudyStub(e, t, i) {
          ...
          const n =
              null === (o = this._invalidatedLineToolsAndStudyStubs.get(e)) || void 0 === o
                ? void 0
                : o.invalidatedViaSyncOnly,
            s = (void 0 === n || n) && this.invalidateViaSync()
          this._invalidatedLineToolsAndStudyStubs.set(e, { timestamp: t, invalidatedViaSyncOnly: s }),
        ...
        _prepareDTOItem(e, t) {
          ...
          return (
            this._invalidatedLineToolsAndStudyStubs.forEach((s, r) => {
              ...
              if (!A(l))
                if (null === l) {
                  this._originalLineToolSharingMode.get(r) === t && i.set(r, null)
                } else {
                  if (
                  ...
                  if (s) {
                    ...
                    if (a)
                      ...
                      n === t && i.set(r, null), null !== e && n === t && o.set(e.id, null)
                    }
                  }
                }
            }),
            this._invalidatedLineToolGroups.forEach((e, i) => {
              if (0 !== t && e.invalidatedViaSyncOnly) s.push(i)
                ...
                } else e.sharingMode().value() === t && o.set(i, D(e, this._chartModel))
              }
            }),
            {
              sources: i,
        ...
        _loadAndMergeLineToolsOnStudies(e, t) {
          ...
          this._makeLoadRequestAndMerge(i, (i) => {
            const n = t
              ? u(Array.from(this._allLineToolsAndStudyStubs.values()).map((e) => Array.from(e.keys()))).filter(
                  (e) => !i(e),
                )
              : []
        ...
        _loadAndMergeLineToolsWithoutSymbol(e, t) {
          ...
          this._makeLoadRequestAndMerge(i, (i) => {
            ...
            this._unloadLineTools(n, (e) => !e.boundToSymbol() && e.ownerSource() === o, e)
          })
        }
