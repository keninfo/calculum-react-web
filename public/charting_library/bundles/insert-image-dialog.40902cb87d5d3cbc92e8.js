;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7038],
  {
    ...
    94720: (e, t, n) => {
      ...
      function b(e) {
        const { startIcon: t, icon: n, iconOnly: r, children: o, endIcon: a, primaryText: i, secondaryText: s } = e,
          l = null != t ? t : n,
          d = !(t || n || a || r) && !o && i && s
        return c.createElement(
          c.Fragment,
          null,
          l && c.createElement(p.Icon, { icon: l, className: h().startIconWrap }),
          o && c.createElement('span', { className: h().content }, o),
          a && !r && c.createElement(p.Icon, { icon: a, className: h().endIconWrap }),
          d &&
            (function (e) {
              return (
                e.primaryText &&
                ...
                c.createElement(
                  ...
                  c.createElement('span', { className: h().primaryText }, ' ', e.primaryText, ' '),
                  'string' == typeof e.secondaryText
                    ? c.createElement('span', { className: h().secondaryText }, ' ', e.secondaryText, ' ')
                    : c.createElement(
                        'span',
      ...
      function x(e) {
        ...
        return { ...m, ...(0, y.filterDataProps)(e), ...(0, y.filterAriaProps)(e) }
      }
      function E(e) {
        const { reference: t, tooltipText: n, ...r } = e,
          { isGrouped: o, cellState: a, disablePositionAdjustment: i } = (0, c.useContext)(C.ControlGroupContext),
          s = f({ ...r, isGrouped: o, cellState: a, disablePositionAdjustment: i })
        return c.createElement(
          'button',
          {
            ...x(r),
      ...
      n(78572)
      function w(e) {
        const { intent: t, size: n, appearance: r, useFullWidth: o, icon: a, ...c } = e
        return { ...c, color: s(t), size: l(n), variant: i(r), stretch: o, startIcon: a }
      }
      function _(e) {
    ...
    57340: (e, t, n) => {
      ...
      const d = r.forwardRef((e, t) => r.createElement(o.NavButton, { ...e, ref: t, icon: u(e.size) }))
    },
    64388: (e, t, n) => {
      'use strict'
      n.d(t, { NavButton: () => c })
      ...
      function s(e) {
        ...
        return o(i['nav-button'], i[`size-${t}`], n && i['preserve-paddings'], a && i['flip-icon'], r && i.link, s)
      }
      function l(e) {
        ...
        return r.createElement(
          ...
          r.createElement(a.Icon, { icon: n, className: i.icon, 'aria-hidden': !0 }),
          t && r.createElement('span', { className: i['visually-hidden'] }, t),
        )
      }
      const c = (0, r.forwardRef)((e, t) => {
        const { icon: n, type: o = 'button', preservePaddings: a, flipIconOnRtl: i, size: c, 'aria-label': u, ...d } = e
        return r.createElement(
          'button',
      ...
      ;(0, r.forwardRef)((e, t) => {
        ...
        return r.createElement(
          c,
          { ...i, className: s({ ...e, children: a, isLink: !0 }), reference: (0, d.isomorphicRef)(t) },
        ...
        constructor() {
          super(...arguments),
            ...
            (this._handleKeyDown = (e) => {
              ...
              13 === (0, u.hashFromEvent)(e) && r && (e.preventDefault(), n || t())
            })
        }
        render() {
          const {
                ...
                o.createElement(
                  ...
                  g &&
                    o.createElement(
                      ...
                      o.createElement(
                        s.Button,
                        { className: f, disabled: u, name: 'submit', onClick: d, 'data-name': 'submit-button' },
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement('div', { className: i()(o ? y.textWrap : y.ellipsis) }, t),
              a && r.createElement('div', { className: i()(y.ellipsis, y.subtitle) }, a),
            ),
            d,
            s &&
              !x &&
      ...
      class P extends r.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._embedResizerOverridesEnabled = _.enabled('embed_resizer_overrides')),
              ...
              if (!e.defaultPrevented) {
                if ((this.props.onKeyDown && this.props.onKeyDown(e), 27 === (0, s.hashFromEvent)(e))) {
                  ...
                  if (null !== n) {
                    ...
                    if (null !== r && (0, c.isTextEditingField)(n)) return void r.focus()
        ...
        render() {
          ...
          return r.createElement(m.MatchMedia, { rule: p.DialogBreakpoints.SmallHeight }, (g) =>
            r.createElement(m.MatchMedia, { rule: p.DialogBreakpoints.TabletSmall }, (p) =>
              r.createElement(
                u.PopupDialog,
                {
                  ...
                  containerAriaLabel: F,
                  containerTabIndex: K,
                  calculateDialogPosition: R && G ? this._calculatePositionWithOffsets : void 0,
                  shadowed: q,
                  fixedBody: Q,
                  onClick: V,
                  ...J,
                ...
                r.createElement(
                  'div',
                  { className: i()(S.wrapper, t), 'data-name': l, 'data-dialog-name': $ },
                  void 0 !== a &&
                    r.createElement(x, {
                      draggable: D && !(p || R),
                  ...
                  _ && r.createElement(d.Separator, { className: S.separator }),
                  r.createElement(h.PopupContext.Consumer, null, (e) => this._renderChildren(e, p || R)),
                ),
              ),
            ),
          )
    ...
    54368: (e, t, n) => {
      ...
      class c extends r.PureComponent {
        ...
        render() {
          const { color: e, opacity: t, hideInput: n, disabled: a } = this.props,
          ...
          return r.createElement(
            ...
            !n &&
              r.createElement(
                ...
                r.createElement('span', { className: l.opacityInputPercent }, '%'),
              ),
          )
        }
        _dragSubscribe() {
    ...
    14653: (e, t, n) => {
      ...
      function g(e, t = null, o, a, s, l) {
        const [c, u] = (0, r.useState)({ imgUrl: t, error: null, isLoading: !1, isDragging: !1 })
        return (
          (0, r.useEffect)(() => {
            null === t && null !== c.imgUrl && u((e) => ({ ...e, imgUrl: null })),
            ...
            const t = (function (e, t, r) {
              ...
              const {
                ...
                p = new (m())(e, {
                  ...
                  previewTemplate: '<div>',
                  dictFileTooBig: i.t(null, { replace: { value: u } }, n(93738)),
                  dictResponseError: h,
              ...
              e.current,
              {
                onAddedFile: () => u({ error: null, imgUrl: null, isLoading: !0, isDragging: !1 }),
                onSuccess: (e, t) => {
                  a && a(t)
                  const n = t ? t.url : URL.createObjectURL(e)
                  u({ error: null, imgUrl: n, isLoading: !1, isDragging: !1 })
                },
                onError: (e) => u({ error: e, imgUrl: null, isLoading: !1, isDragging: !1 }),
                onQueuedFile: s,
                onSending: l,
              },
              o,
        ...
        return r.createElement(
            ...
            : r.createElement(
                ...
                !x || h
                  ? r.createElement(
                      ...
                      (function (e) {
                        return Boolean(e)
                          ? r.createElement('span', { className: o(b.textBlockHeadline, b.textBlockError) }, e)
                          : r.createElement('span', { className: b.textBlockHeadline }, i.t(null, void 0, n(32910)))
                      })(null != h ? h : E),
                      r.createElement('span', null, i.t(null, void 0, n(46280))),
                      r.createElement('span', null, i.t(null, { replace: { value: s } }, n(7654))),
                    )
          ...
          _ &&
            r.createElement(
              ...
              r.createElement('p', { className: b.mainText }, i.t(null, void 0, n(98918))),
            ),
          r.createElement('div', { ref: C, className: b.dropzone }),
          x && a && r.createElement(u.Icon, { className: b.remove, icon: f, onClick: a }),
        )
      }
      var C = n(28124),
        y = n(80256)
      ...
      function B(e) {
          ...
          render: function () {
            return r.createElement(
              ...
              r.createElement(
                ...
                r.createElement('span', { className: a()(y.transparencyTitle, y.column) }, E),
        ...
        async function w(e, t) {
          ...
          if ((g(void 0), !(await (0, l.checkImageSize)(e))))
            return g(i.t(null, void 0, n(73007))), t.cancelUpload(e), void m(void 0)
            ...
            (0, l.generateLink)(e)
              ...
              .then((e) => {
                ...
                const { data: n, filepath: o } = e,
                  { url: a } = n
                ;(t.options.url = a), (f.current = e.data.fields), (b.current = a + o), t.processQueue()
              })
        }
        function _() {
        ...
        function B() {
          p && C.current
            ? (h && g(void 0), t({ blobUrl: C.current, url: Promise.resolve(p), transparency: u }))
