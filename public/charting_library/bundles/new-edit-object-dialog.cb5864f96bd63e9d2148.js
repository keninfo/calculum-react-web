  ...
  [6265],
  {
    ...
    81346: (e, t, l) => {
        ...
        constructor(e) {
          ...
          super(e),
            ...
            (this._handleSaveAsDefaults = () => {
              ...
              ;(0, v.isStudy)(e) && (e.properties().saveDefaults(), d.emit('study_dialog_save_defaults', e.id()))
            }),
            (this._renderFooterLeft = (e) => {
              const { source: t, model: l } = this.props
              if ((0, g.isLineTool)(t)) return n.createElement(b.FooterMenu, { sources: [t], chartUndoModel: l })
              if ((0, v.isStudy)(t))
          ...
          const { pages: l, initialActiveTab: r } = this.props,
            i = null !== (t = l.find((e) => e.id === r)) && void 0 !== t ? t : l[0]
          this.state = { activeTabId: i.id }
        }
        render() {
          const { title: e, onCancel: t, onClose: l, shouldReturnFocus: r } = this.props
        ...
        _renderChildren() {
          return ({ requestResize: e }) => {
            ...
            const { pages: l, source: r, model: i } = this.props,
              ...
              s = null !== (t = l.find((e) => e.id === o)) && void 0 !== t ? t : l[0],
            ...
            return n.createElement(
              ...
              n.createElement(
                ...
                'Component' in s
                  ...
                  : n.createElement(y.PropertiesEditorTab, { page: a, tableKey: s.id }),
              ),
            )
          }
        }
      ...
      var x = l(22064),
        ...
        R = l(30582),
        D = l(49794)
      const L = new o.TranslatedString('change visibility', i.t(null, void 0, l(1924)))
      ...
      const J = {
        ...
        $ = Object.values(J)
          ...
          .map((e) => ({
            ...
            content: n.createElement(A.DropItem, { icon: e.icon, label: e.label }),
          })),
      ...
      var Q = l(14118),
        ee = l(47159)
      const te = new o.TranslatedString('change plot type', i.t(null, void 0, l(43439))),
        le = new o.TranslatedString('change price line visibility', i.t(null, void 0, l(8662)))
            ...
            !o &&
              n.createElement(
                ...
                n.createElement(
                  ...
                  a ? n.createElement('div', null, h) : n.createElement(V, { id: m, title: h, visible: s.visible }),
                ),
              ),
            ie(m, l, i, s, v, d),
      ...
      class ae extends n.PureComponent {
        constructor(e) {
          super(e), (this._visible = new se.StudyPlotVisibleProperty(e.styleProp.display))
        }
        render() {
          const {
            title: e,
      ...
      class ce extends n.PureComponent {
        constructor(e) {
          super(e), (this._visible = new se.StudyPlotVisibleProperty(e.display))
        }
        render() {
          const { id: e, title: t, disabled: l } = this.props
          return n.createElement(V, { id: e, title: t, disabled: l, visible: this._visible })
        }
        componentWillUnmount() {
          this._visible.destroy()
        }
      ...
      var de = l(50890)
      const pe = new o.TranslatedString('change plot type', i.t(null, void 0, l(43439))),
        ue = new o.TranslatedString('change price line visibility', i.t(null, void 0, l(8662)))
      class he extends n.PureComponent {
        ...
        render() {
          const {
            ...
            isRGB: l,
            isFundamental: r,
            property: { color: i, plottype: o, linewidth: s, transparency: a, trackPrice: c, display: d },
          } = this.props
          return n.createElement(
            B.InputRow,
      ...
      class ve extends n.PureComponent {
        render() {
          ...
          return n.createElement(
            B.InputRow,
            { label: c ? n.createElement(V, { id: e, title: l, visible: r, disabled: u }) : l, offset: d, grouped: p },
            t
              ? null
              : n.createElement(Q.ColorWithThicknessSelect, {
                  disabled: u || (r && !(Array.isArray(r) ? r[0].value() : r.value())),
                  color: i,
                  transparency: o,
                  thickness: s,
                }),
            ...
            n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(
                  ...
                  n.createElement(ce, { id: e, title: it((0, r.ensureNotNull)(a), e), display: s }),
                ),
              ),
              !t &&
                n.createElement(
      ...
      const Te = {
          ...
          [Ee.MarkLocation.Top]: { value: Ee.MarkLocation.Top, content: i.t(null, void 0, l(97118)), order: 2 },
          [Ee.MarkLocation.Bottom]: { value: Ee.MarkLocation.Bottom, content: i.t(null, void 0, l(27567)), order: 3 },
      ...
      const _e = new o.TranslatedString('change char', i.t(null, void 0, l(86955))),
        Ie = new o.TranslatedString('change location', i.t(null, void 0, l(6834)))
      class Re extends n.PureComponent {
        ...
        render() {
          var e
          const { id: t, title: l, char: i, isRGB: o, property: s, hasPalette: a } = this.props,
            { color: c, transparency: d, char: p, location: u, display: h } = s.childs()
          return n.createElement(
            B.InputRow,
            { grouped: a, label: n.createElement(ce, { id: t, title: l, display: h }) },
            !a &&
              !o &&
              n.createElement(Q.ColorWithThicknessSelect, { disabled: 0 === h.value(), color: c, transparency: d }),
            n.createElement(Pe.InputControl, {
              disabled: void 0 === p || 0 === h.value(),
              className: ee.smallStyleControl,
              value: (0, r.ensureDefined)(null !== (e = null == p ? void 0 : p.value()) && void 0 !== e ? e : i),
      ...
      Object.keys(Le.plotShapesData).forEach((e) => {
        ...
        Xe.push({
          ...
          content: n.createElement(A.DropItem, { icon: je(t.icon), label: t.guiName }),
        })
      })
      class qe extends n.PureComponent {
        render() {
          const { id: e, shapeStyleId: t, className: l, shapeStyleChange: r, disabled: i } = this.props
          return n.createElement(A.IconDropdown, {
            id: e,
            disabled: i,
            className: l,
      ...
      const Je = new o.TranslatedString('change shape', i.t(null, void 0, l(83468))),
        $e = new o.TranslatedString('change location', i.t(null, void 0, l(6834)))
      class Ze extends n.PureComponent {
        ...
        render() {
          const { id: e, title: t, isRGB: l, hasPalette: r, property: i } = this.props,
            { color: o, transparency: s, plottype: a, location: c, display: d } = i.childs()
          return n.createElement(
            B.InputRow,
            { grouped: r, label: n.createElement(ce, { id: e, title: t, display: d }) },
            !r &&
              !l &&
              n.createElement(Q.ColorWithThicknessSelect, { disabled: 0 === d.value(), color: o, transparency: s }),
            n.createElement(qe, {
        ...
        render() {
          ...
          if ('line' === u || 'bar_colorer' === u || 'bg_colorer' === u)
            return h && h.palette && h.paletteProps
              ? n.createElement(ae, {
                  title:
                    null !== (t = null === (e = null == d ? void 0 : d[a]) || void 0 === e ? void 0 : e.title) &&
                    void 0 !== t
                      ? t
                      : a,
                  plot: i,
              ...
              : n.createElement(he, {
                  ...
                  title: (0, r.ensureDefined)(
                    null === (l = null == d ? void 0 : d[a]) || void 0 === l ? void 0 : l.title,
                  ),
                  property: p,
                  isRGB: m,
                  isFundamental: false,
          ...
          if ('arrows' === u) {
            ...
            return t || l
              ...
              : n.createElement(ge, { id: a, property: p, isRGB: m, plot: i, palettes: o, styleProp: p })
          }
          if ('chars' === u || 'shapes' === u) {
            ...
            return n.createElement(
              ...
              'chars' === u
                ...
                : n.createElement(Ze, { id: a, title: t, property: p, hasPalette: Boolean(h && h.palette), isRGB: m }),
              h &&
                h.palette &&
                h.paletteProps &&
                n.createElement(ae, {
      ...
      var ot = l(91699),
        st = l(53598)
      const at = new o.TranslatedString('change line style', i.t(null, void 0, l(28818)))
      ...
      const dt = new o.TranslatedString('change value', i.t(null, void 0, l(21333)))
      class pt extends n.PureComponent {
        ...
        render() {
          const {
            id: e,
            name: t,
            property: { color: l, linestyle: r, linewidth: i, transparency: o, value: s, visible: a },
          } = this.props
          return n.createElement(
            B.InputRow,
            { labelAlign: 'adaptive', label: n.createElement(V, { id: e, title: t, visible: a }) },
            n.createElement(
              'div',
              { className: ee.block },
              n.createElement(
              ...
              n.createElement(
                'div',
                { className: we(ee.wrapGroup, ee.defaultSelect, ee.additionalSelect) },
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                re.PropertyTable.Cell,
                { placement: 'first', colSpan: 2 },
                n.createElement(V, { id: 'chart-orders-switch', title: i.t(null, void 0, l(6532)), visible: e }),
              ),
            ),
            n.createElement(
              re.PropertyTable.Row,
            ...
            n.createElement(
              ...
              n.createElement(
                re.PropertyTable.Cell,
                { placement: 'first', colSpan: 2 },
                n.createElement(V, { id: 'chart-orders-qty-switch', title: i.t(null, void 0, l(98721)), visible: r }),
              ),
            ),
          )
        }
      ...
      var ht = l(9233),
        mt = l(55297)
      const vt = new o.TranslatedString('change percent width', i.t(null, void 0, l(62294))),
        yt = new o.TranslatedString('change placement', i.t(null, void 0, l(81891))),
        gt = new o.TranslatedString('change values visibility', i.t(null, void 0, l(9344))),
        bt = [
          { value: ht.HHistDirection.LeftToRight, content: i.t(null, void 0, l(11626)) },
          { value: ht.HHistDirection.RightToLeft, content: i.t(null, void 0, l(50421)) },
        ],
      ...
      class St extends n.PureComponent {
        ...
        render() {
          const { hHistInfo: e, property: t } = this.props,
            { percentWidth: l, direction: r, showValues: i, valuesColor: o, visible: s } = t.childs(),
            { title: a } = e
          return n.createElement(
            n.Fragment,
            null,
            ...
            n.createElement(
              B.InputRow,
              { label: n.createElement('div', { className: ee.childRowContainer }, ft), grouped: !0 },
            ...
            n.createElement(
              B.InputRow,
              { label: n.createElement('div', { className: ee.childRowContainer }, wt), grouped: !0 },
            ...
            n.createElement(
              ...
              n.createElement(
                re.PropertyTable.Cell,
                { className: ee.childRowContainer, placement: 'first', colSpan: 2, grouped: !0 },
            ...
            n.createElement(
              B.InputRow,
              { label: n.createElement('div', { className: ee.childRowContainer }, Pt), grouped: !0 },
              n.createElement(Q.ColorWithThicknessSelect, { disabled: s && !s.value(), color: o }),
            ),
            this._renderColors(),
            n.createElement(re.PropertyTable.GroupSeparator, null),
          )
        ...
        _renderColors() {
          ...
          return l
            ...
            .map((e) =>
              n.createElement(
                B.InputRow,
                { key: e, grouped: !0, label: n.createElement('div', { className: ee.childRowContainer }, o[+e]) },
                n.createElement(Q.ColorWithThicknessSelect, {
                  disabled: !i.value(),
                  color: l[+e],
                  transparency: r[+e],
      ...
      class kt extends n.PureComponent {
        render() {
          ...
          return Object.keys(s).map((t, i) => {
            var s, a, c, d
            const p = (0, r.ensureDefined)(null === (s = o[e]) || void 0 === s ? void 0 : s.childs()[t])
            return 'horizlines' === e || 'vertlines' === e
              ? n.createElement(Et, {
                  key: t,
                  title: (0, r.ensureDefined)(null === (a = l.graphics[e]) || void 0 === a ? void 0 : a[t]).name,
                  property: p,
                })
              : 'lines' === e
                ? n.createElement(Et, {
                    key: t,
                    title: (0, r.ensureDefined)(null === (c = l.graphics.lines) || void 0 === c ? void 0 : c[t]).title,
                    property: p,
                  })
                : 'hhists' === e
                  ? n.createElement(St, {
                      key: t,
                      hHistInfo: (0, r.ensureDefined)(null === (d = l.graphics.hhists) || void 0 === d ? void 0 : d[t]),
                      property: p,
                    })
                  : null
          })
      ...
      var _t = l(66045)
      const It = new o.TranslatedString('change font size', i.t(null, void 0, l(27745))),
        Rt = [10, 11, 12, 14, 16, 20, 24, 28, 32, 40].map((e) => ({ value: e, title: e.toString() }))
      ...
      const Lt = new o.TranslatedString('change visibility', i.t(null, void 0, l(1924))),
      ...
      class zt extends n.PureComponent {
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(
              B.InputRow,
              { labelAlign: 'adaptive', label: n.createElement('span', null, Vt) },
              n.createElement(
                'div',
                { className: ee.block },
                n.createElement(
                  ...
                  n.createElement(Dt, { id: 'pivot-points-standard-font-size-select', fontSize: e }),
                ),
              ),
            ),
            n.createElement(
      ...
      const At = i.t(null, void 0, l(10783)),
        ...
        Wt = new o.TranslatedString('change visibility', i.t(null, void 0, l(1924))),
      ...
      class jt extends n.PureComponent {
        ...
        render() {
          ...
          const { metaInfo: d } = this.props,
            { graphics: p, styles: u, showLabelsOnPriceScale: h, showLegendValues: m } = this.props.property.childs(),
            ...
            k = null === (t = d.graphics.horizlines) || void 0 === t ? void 0 : t.vahLines,
            _ = null === (o = y.childs()) || void 0 === o ? void 0 : o.valLines,
            I = null === (s = d.graphics.horizlines) || void 0 === s ? void 0 : s.valLines,
            D = y.childs().pocLines,
            L = (0, r.ensureDefined)(null === (a = d.graphics.horizlines) || void 0 === a ? void 0 : a.pocLines),
            N = u.childs().developingPoc,
            z = new se.StudyPlotVisibleProperty(N.childs().display),
            A = (0, r.ensureDefined)(null === (c = d.styles) || void 0 === c ? void 0 : c.developingPoc),
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                re.PropertyTable.Cell,
                { placement: 'last' },
                n.createElement(Q.ColorWithThicknessSelect, { disabled: !C.value() || !P[0].value(), color: T }),
              ),
            ),
            n.createElement(
              re.PropertyTable.Row,
                    ...
                    return n.createElement(
                      B.InputRow,
                      {
                        ...
                        label: n.createElement(
                          ...
                          (o && i.t(o.titles[r], { context: 'input' }, l(32856))) || '',
                        ),
                      },
                      n.createElement(Q.ColorWithThicknessSelect, {
                        disabled: !C.value(),
                        color: v.childs()[e].childs().colors.childs()[r],
                        transparency: v.childs()[e].childs().transparencies.childs()[r],
                      }),
                    )
                  }),
              ),
            ...
            N &&
              n.createElement(
                ...
                {
                  id: 'developingPoc',
                  title: (A.title && i.t(A.title, { context: 'input' }, l(32856))) || '',
            ...
            g &&
              n.createElement(
                B.InputRow,
                { label: n.createElement('div', null, (O && i.t(O.name, { context: 'input' }, l(32856))) || '') },
                n.createElement(Q.ColorWithThicknessSelect, {
              ...
              n.createElement(
                ...
                h &&
                  n.createElement(
                    re.PropertyTable.Cell,
                    { placement: 'first', colSpan: 2 },
                    n.createElement(V, { id: 'showLabelsOnPriceScale', title: Yt, visible: h }),
                  ),
                m &&
                  n.createElement(
                    re.PropertyTable.Cell,
                    { placement: 'first', colSpan: 2 },
                    n.createElement(V, { id: 'showLegendValues', title: Gt, visible: m }),
                  ),
              ),
          )
        }
      ...
      var Zt = l(65388)
      const Kt = new o.TranslatedString('change precision', i.t(null, void 0, l(61863))),
      ...
      const nl = new o.TranslatedString('change min tick', i.t(null, void 0, l(26476))),
      ...
      for (let e = 0; e < ol.length; e++) {
        const t = ol[e]
        sl.push({ value: t.priceScale + ',' + t.minMove + ',' + t.frac, content: t.minMove + '/' + t.priceScale })
      }
      ...
      class pl extends n.PureComponent {
        render() {
          ...
          return n.createElement(
            B.InputRow,
            { label: c ? n.createElement(V, { id: e, title: l, visible: r }) : l, offset: d, grouped: p },
            t
              ? null
              : n.createElement(
                  n.Fragment,
      ...
      class yl extends n.PureComponent {
        ...
        render() {
          const { study: e } = this.props,
            t = e.metaInfo()
          if ((0, Zt.isCustomStudy)(t.shortId)) return n.createElement($t, null)
          const l = e.properties(),
            { precision: r, strategy: i, minTick: o, showLabelsOnPriceScale: s, showLegendValues: a } = l,
            c = t.plots.length > 0,
          ...
          return n.createElement(
            ...
            u && n.createElement(al, { id: (0, x.createDomId)(t.id, 'min-tick-select'), minTick: o }),
            _.StudyMetaInfo.isScriptStrategy(t) && n.createElement(ut, { orders: i.orders }),
            (p || d) &&
              n.createElement(
                re.PropertyTable.Row,
                null,
                ...
                p && n.createElement(ll, { id: (0, x.createDomId)(t.id, 'precision-select'), precision: r }),
                d &&
                  n.createElement(
                    n.Fragment,
                    null,
                    n.createElement(
                      re.PropertyTable.Cell,
                      { placement: 'first', colSpan: 2 },
                      n.createElement(V, { id: 'showLabelsOnPriceScale', title: ml, visible: s }),
                    ),
                    n.createElement(
                      re.PropertyTable.Cell,
                      { placement: 'first', colSpan: 2 },
                      n.createElement(V, { id: 'showLegendValues', title: hl, visible: a }),
                    ),
                  ),
              ),
          )
        ...
        _plotsElement() {
          ...
          return new E.MetaInfoHelper(t)
            ...
            .map((t) => {
              ...
              return n.createElement(rt, { key: t.id, plot: t, palettes: r, study: e })
            })
        }
        _bandsElement() {
          const { study: e } = this.props,
          ...
          return (
            ...
            l &&
            t.map((e, t) => {
              if (!e.isHidden) return n.createElement(pt, { key: t, id: e.name, name: e.name, property: l[t] })
            })
          )
        }
                ...
                if (l.hasChild('fillType') && 'gradient' === l.childs().fillType.value()) {
                  ...
                  if (t.palette) {
                    ...
                    return n.createElement(oe, {
                      ...
                      secondaryPaletteProps: null == o ? void 0 : o.paletteProps,
                      styleProp: l,
                    })
                  }
                  return null
        ...
        _graphicsElement() {
          ...
          return t && Object.keys(t).map((t, l) => n.createElement(kt, { key: t, graphicType: t, study: e }))
        }
        _findPalettesByTargetId(e) {
          const { study: t } = this.props,
            ...
            o = {}
          for (const l of n) {
            if (((0, k.isPaletteColorerPlot)(l) || (0, k.isOhlcColorerPlot)(l)) && l.target === e) {
              if (o.main) {
                o.secondary = { palette: i[l.palette], paletteProps: t.properties().palettes[l.palette] }
                continue
              }
              o.main = { palette: i[l.palette], paletteProps: t.properties().palettes[l.palette] }
            }
            ;(0, k.isUpColorerPlot)(l) &&
              l.target === e &&
              (o.up = { palette: i[l.palette], paletteProps: t.properties().palettes[l.palette] }),
              (0, k.isDownColorerPlot)(l) &&
                l.target === e &&
                (o.down = { palette: i[l.palette], paletteProps: t.properties().palettes[l.palette] }),
              (0, k.isCandleWickColorerPlot)(l) &&
                l.target === e &&
                (o.wick = { palette: i[l.palette], paletteProps: t.properties().palettes[l.palette] }),
              (0, k.isCandleBorderColorerPlot)(l) &&
                l.target === e &&
                (o.border = { palette: i[l.palette], paletteProps: t.properties().palettes[l.palette] })
          }
          return o
        }
      }
      function gl(e) {
        return (0, I.bindPropertyContext)(yl, { ...e, property: e.study.properties() })
      }
      ...
      class El extends wl.DialogRenderer {
        ...
        show(e = {}) {
          ...
          if (
            ((0, g.isLineTool)(this._source) && (0, p.trackEvent)('GUI', 'Drawing Properties', this._source.name()),
            (0, v.isStudy)(this._source))
          ) {
            const e = !this._source.isPine() || this._source.isStandardPine() ? r.description : 'Custom Pine'
            ;(0, p.trackEvent)('GUI', 'Study Properties', e)
          }
          let o = []
          const u = new E.MetaInfoHelper(r)
          u.hasUserEditableInputs() && o.push({ id: 'inputs', label: i.t(null, void 0, l(21429)), Component: T }),
            u.hasUserEditableProperties(),
            u.hasUserEditableStyles() && o.push({ id: 'style', label: i.t(null, void 0, l(92516)), Component: bl }),
            this._propertyPages ||
              o.push({
                id: 'visibilities',
          ...
          const h = e.initialTab || a.getValue(this._activeTabSettingsName()) || 'inputs'
          let m = (0, s.clean)(r.shortDescription, !0)
          const y = null !== (t = o.find((e) => e.id === h)) && void 0 !== t ? t : o[0]
        ...
        _createVisibilitiesPropertyPage() {
          ...
          return (0, fl.createPropertyPage)(
            (0, Cl.getIntervalsVisibilitiesPropertiesDefinitions)(
              this._model,
              e,
              new o.TranslatedString(this._source.name(!0), this._source.title(Pl.TitleDisplayTarget.StatusLine, !0)),
            ),
            'visibility',
    ...
    78890: (e, t, l) => {
      ...
      class m extends n.PureComponent {
        ...
        _getPlaceHolderItem(e) {
          return e ? n.createElement(o.Icon, { className: p.defaultsButtonIcon, icon: d }) : u.defaults
        }
      }
    },
    48531: (e, t, l) => {
      ...
      function g(e) {
        ...
        return n.createElement(
          ...
          n.createElement(u.PopupMenuItem, {
            ...
            label: t,
            onClick: s,
            toolbox: l && n.createElement(h.RemoveButton, { hidden: !v.mobiletouch && !i, onClick: c, icon: y }),
          }),
        )
      }
      function b(e) {
    ...
    93081: (e, t, l) => {
      ...
      const m = (0, r.createContext)({ size: 'small', overflowBehaviour: void 0 })
      var v = l(17946),
        y = l(24554)
      function g(e) {
        const {
      ...
      const b = (0, r.forwardRef)((e, t) => {
        ...
        return r.createElement(
          ...
          u && 'string' == typeof h
            ? r.createElement('span', { className: o()(y['ellipsis-children'], 'apply-overflow-tooltip') }, h)
            : h,
        )
      })
      b.displayName = 'UnderlineTabsBaseButton'
      const f = (0, r.forwardRef)((e, t) => {
        const { item: l, highlighted: n, handleItemRef: i, onClick: o, 'aria-disabled': s, ...a } = e,
          c = (0, r.useCallback)(() => {
            o && o(l)
          }, [o, l]),
          d = (0, r.useCallback)(
            (e) => {
              i && i(l, e), t && 'object' == typeof t ? (t.current = e) : 'function' == typeof t && t(e)
            },
            [l, i, t],
          )
        return r.createElement(b, { ...a, id: l.id, onClick: c, ref: d }, l.label)
      })
      ...
      function R(e) {
        ...
        return r.createElement(S.Icon, { icon: I(t), className: i(_['arrow-icon'], _[`size-${t}`], l && _.dropped) })
      }
      var D = l(456)
      function L(e) {
        const {
          ...
          S = (function (e, t) {
            ...
            return (
              ...
              (0, r.useCallback)(() => {
                const n = (0, w.ensureNotNull)(t.current).getBoundingClientRect(),
                  r = l.current[e]
                return {
                  x: n.left,
      ...
      function W(e) {
        ...
        return i(M['scroll-wrap'], M[`size-${t}`], 'scroll' === l && M['enable-scroll'], n)
      }
      function F() {
      ...
      function Y(e) {
        ...
        return r.createElement(
          'div',
          {
            ...
            style: { transform: `translateX(${l}px) scaleX(${o})`, transitionDuration: `${n}ms` },
          },
          r.createElement('div', { className: G().corner, style: { transform: `scaleX(${1 / o})` } }),
          r.createElement('div', { className: G().center, style: { transform: `scaleX(${1 - 30 / e.scale})` } }),
          r.createElement('div', { className: G().corner, style: { transform: `scaleX(${1 / o})` } }),
        )
      }
      function j(e) {
        const {
          ...
          D = F(),
          V = (function (e) {
            const t = (0, z.useSafeMatchMedia)(A['media-mf-phone-landscape'], !0),
              l = F()
          ...
          { isOpened: ne, open: re, close: ie, onButtonClick: oe } = (0, p.useDisclosure)({ id: t, disabled: y }),
          ...
          ge = (0, r.useCallback)(
            (e) => {
              var t
              return null !== (t = ae.find((t) => t.id === e.id)) && void 0 !== t ? t : {}
            },
            [ae],
          ),
          be = (0, r.useCallback)(() => {
        ...
        const Pe = (function (e, t, l = []) {
          const [n, i] = (0, r.useState)(),
            ...
            a = (e) => {
              var t
              const l = null !== (t = e.parentElement) && void 0 !== t ? t : void 0
              if (void 0 === l) return
            ...
            (0, r.useEffect)(() => {
              ...
              return void 0 !== n
                ? (a(n),
                  ...
                  () => {
                    var e
                    return null === (e = o.current) || void 0 === e ? void 0 : e.disconnect()
                  })
                : void 0
            }, l),
            n
          )
        })(le.current, null != me ? me : ve, [null != me ? me : ve, Q, b, U, V])
        return r.createElement(
          m.Provider,
          { value: { size: b, overflowBehaviour: V } },
          r.createElement(
            'div',
            { ...de, className: W({ size: b, overflowBehaviour: V, className: P }), style: S, 'data-name': _ },
            r.createElement(
              'div',
              {
                ...ce,
              ...
              ee.map((e) => r.createElement(f, { ...ge(e), ref: K(N(e)), key: e.id, item: e, fake: !0 })),
              'collapse' === V &&
                r.createElement(L, {
                  size: b,
                  disabled: y,
              ...
              Pe ? r.createElement(Y, { ...Pe, disabled: y }) : r.createElement('div', null),
            ),
          ),
        )
      }
      ...
      ;(0, r.forwardRef)((e, t) => {
        ...
        const { size: n, overflowBehaviour: i } = (0, r.useContext)(m),
          ...
          S = (0, r.useCallback)(
            (e) => {
              c && c(s, e), t && 'object' == typeof t ? (t.current = e) : 'function' == typeof t && t(e)
            },
            [s, c, t],
          ),
    ...
    10428: (e, t, l) => {
      'use strict'
      l.d(t, { DEFAULT_MENU_ITEM_SWITCHER_THEME: () => f, MenuItemSwitcher: () => w })
      var n,
        r = l(50959),
        i = l(97754),
        o = l.n(i),
      ...
      function m(e) {
        ...
        return r.createElement(
          ...
          r.createElement('input', {
            ...
            onKeyDown: (e) => {
              var t
              13 === (0, p.hashFromEvent)(e) && (null === (t = e.currentTarget) || void 0 === t || t.click())
            },
            onChange: m,
            disabled: u,
            'aria-disabled': C,
      ...
      function w(e) {
        const {
          ...
          E = o()(t, h.wrapper, l && h.wrapperWithOnLabel, s && h.wrapperWithDescription)
        return r.createElement(
          'label',
          {
            ...
            onKeyDown: function (e) {
              ...
              ;(13 !== t && 32 !== t) || (e.preventDefault(), C.current instanceof HTMLElement && C.current.click())
            },
            tabIndex: P,
            'data-role': 'menuitem',
            'aria-disabled': e.disabled || void 0,
          },
          void 0 !== w && r.createElement(v.Icon, { className: h.icon, icon: w }),
          r.createElement(
            'div',
    ...
    57717: (e, t, l) => {
      ...
      function r(e, t, l, r = null) {
        ...
        const o = {
          ...
          visible: null !== (i = e.visible) && void 0 !== i ? i : new n.WatchedValue(!0).readonly(),
        }
    ...
    26434: (e, t, l) => {
      ...
      var n = l(11542),
        ...
        c = l(73305),
        d = l(46112)
      const p = new r.TranslatedString('change {title} visibility on ticks', n.t(null, void 0, l(98596))),
        u = new r.TranslatedString('change {title} visibility on seconds', n.t(null, void 0, l(41315))),
        h = new r.TranslatedString('change {title} seconds from', n.t(null, void 0, l(86780))),
        m = new r.TranslatedString('change {title} seconds to', n.t(null, void 0, l(6573))),
        v = new r.TranslatedString('change {title} visibility on minutes', n.t(null, void 0, l(78219))),
        y = new r.TranslatedString('change {title} minutes from', n.t(null, void 0, l(59820))),
        g = new r.TranslatedString('change {title} minutes to', n.t(null, void 0, l(38011))),
        b = new r.TranslatedString('change {title} visibility on hours', n.t(null, void 0, l(68715))),
        f = new r.TranslatedString('change {title} hours from', n.t(null, void 0, l(8306))),
        w = new r.TranslatedString('change {title} hours to', n.t(null, void 0, l(67233))),
        C = new r.TranslatedString('change {title} visibility on days', n.t(null, void 0, l(56402))),
        P = new r.TranslatedString('change {title} days from', n.t(null, void 0, l(91201))),
        S = new r.TranslatedString('change {title} days to', n.t(null, void 0, l(96135))),
        E = new r.TranslatedString('change {title} visibility on weeks', n.t(null, void 0, l(71084))),
        T = new r.TranslatedString('change {title} weeks from', n.t(null, void 0, l(32481))),
        x = new r.TranslatedString('change {title} weeks to', n.t(null, void 0, l(18678))),
        k = new r.TranslatedString('change {title} visibility on months', n.t(null, void 0, l(67583))),
        _ = new r.TranslatedString('change {title} months from', n.t(null, void 0, l(99122))),
        I = new r.TranslatedString('change {title} months to', n.t(null, void 0, l(10518))),
        R =
      ...
      function ae(e, t, l) {
        ...
        if (i.enabled('tick_resolution')) {
          const r = (0, o.createCheckablePropertyDefinition)(
            { checked: (0, o.convertToDefinitionProperty)(e, t.ticks, p.format({ title: l })) },
        ...
        if ((0, a.isSecondsEnabled)()) {
          const r = (0, o.createRangePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(e, t.seconds, u.format({ title: l })),
              from: (0, o.convertToDefinitionProperty)(e, t.secondsFrom, h.format({ title: l })),
              to: (0, o.convertToDefinitionProperty)(e, t.secondsTo, m.format({ title: l })),
            },
            {
        ...
        const r = (0, o.createRangePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(e, t.minutes, v.format({ title: l })),
              from: (0, o.convertToDefinitionProperty)(e, t.minutesFrom, y.format({ title: l })),
              to: (0, o.convertToDefinitionProperty)(e, t.minutesTo, g.format({ title: l })),
            },
            {
          ...
          c = (0, o.createRangePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(e, t.hours, b.format({ title: l })),
              from: (0, o.convertToDefinitionProperty)(e, t.hoursFrom, f.format({ title: l })),
              to: (0, o.convertToDefinitionProperty)(e, t.hoursTo, w.format({ title: l })),
            },
            {
          ...
          d = (0, o.createRangePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(e, t.days, C.format({ title: l })),
              from: (0, o.convertToDefinitionProperty)(e, t.daysFrom, P.format({ title: l })),
              to: (0, o.convertToDefinitionProperty)(e, t.daysTo, S.format({ title: l })),
            },
            {
        ...
        const A = (0, o.createRangePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(e, t.weeks, E.format({ title: l })),
              from: (0, o.convertToDefinitionProperty)(e, t.weeksFrom, T.format({ title: l })),
              to: (0, o.convertToDefinitionProperty)(e, t.weeksTo, x.format({ title: l })),
            },
            {
          ...
          M = (0, o.createRangePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(e, t.months, k.format({ title: l })),
              from: (0, o.convertToDefinitionProperty)(e, t.monthsFrom, _.format({ title: l })),
              to: (0, o.convertToDefinitionProperty)(e, t.monthsTo, I.format({ title: l })),
            },
            {
      ...
      function ce(e, t) {
        ...
        if (i.enabled('tick_resolution')) {
          const n = (0, o.createCheckablePropertyDefinition)(
            { checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.ticks), A, t) },
            { id: 'IntervalsVisibilitiesTicks', title: R },
          )
          l.push(n)
        }
        if ((0, a.isSecondsEnabled)()) {
          const n = (0, o.createRangePropertyDefinition)(
            {
              checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.seconds), M, t),
              from: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.secondsFrom), W, t),
              to: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.secondsTo), F, t),
            },
            {
              id: 'IntervalsVisibilitiesSecond',
              title: D,
        ...
        const n = (0, o.createRangePropertyDefinition)(
            {
              checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.minutes), H, t),
              from: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.minutesFrom), O, t),
              to: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.minutesTo), U, t),
            },
            {
              id: 'IntervalsVisibilitiesMinutes',
              title: L,
          ...
          r = (0, o.createRangePropertyDefinition)(
            {
              checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.hours), G, t),
              from: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.hoursFrom), Y, t),
              to: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.hoursTo), j, t),
            },
            {
              id: 'IntervalsVisibilitiesHours',
              title: V,
          ...
          p = (0, o.createRangePropertyDefinition)(
            {
              checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.days), X, t),
              from: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.daysFrom), q, t),
              to: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.daysTo), J, t),
            },
            {
              id: 'IntervalsVisibilitiesDays',
              title: B,
        ...
        const u = (0, o.createRangePropertyDefinition)(
            {
              checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeks), $, t),
              from: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeksFrom), Z, t),
              to: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeksTo), K, t),
            },
            {
              id: 'IntervalsVisibilitiesWeeks',
              title: N,
          ...
          h = (0, o.createRangePropertyDefinition)(
            {
              checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.months), Q, t),
              from: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.monthsFrom), ee, t),
              to: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.monthsTo), te, t),
            },
            {
              id: 'IntervalsVisibilitiesMonths',
              title: z,
    ...
    46112: (e, t, l) => {
      ...
      var n = l(50151),
        ...
        i = l(45126),
        o = l(12988)
      const s = new i.TranslatedString('change {propertyName} property', r.t(null, void 0, l(25167)))
