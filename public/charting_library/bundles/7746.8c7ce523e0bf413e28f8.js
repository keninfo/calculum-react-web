;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7746],
  {
    43705: (e, t, r) => {
      ...
      function T(e, t) {
        ...
        return (
          r.forEach(function (e) {
            var r = function (r, i) {
              o || (i || w(r) ? (t.cancel(), t(r, i)) : ((a[e] = r), ++s === n && ((o = !0), t(a))))
            }
            ;(r.cancel = c), (u[e] = r)
          }),
          (t.cancel = function () {
      ...
      function J(e, t) {
        return (0, i.undef)(t) && ((t = e), (e = void 0)), X(_, { channel: e, action: t })
      }
      function Q(e) {
        var t = X(j, e)
    ...
    46212: (e, t, r) => {
      ...
      var L =
        (((x = {})[a.T] = function (e, t, r) {
          var o = t.channel,
            ...
            c = t.maybe,
            u = function (e) {
              e instanceof Error ? r(e, !0) : !D(e) || c ? r(e) : r(n.TERMINATE)
            }
          try {
        ...
        (x[a.C] = function (e, t, r, n) {
          ...
          try {
            ...
            if ((0, s.iterator)(l)) return void K(e, l, u.context, M, (0, a.j)(i), !1, r)
            r(l)
          } catch (e) {
            r(e, !0)
          }
        ...
        (x[a.b] = function (e, t, r, o) {
          var i = o.task
          t === n.SELF_CANCELLATION ? R(i) : (0, s.array)(t) ? t.forEach(R) : R(t), r()
        }),
        ...
        B = function () {
          var e = U[0],
            ...
            r = e.crashedEffect
              ...
              : null
          return ['The above error occurred in task ' + j(e.meta) + (r ? ' \n when executing effect ' + r : '')]
            .concat(
              t.map(function (e) {
      ...
      function q(e, t, r, o, i, s, c) {
        ...
        var S =
          ...
          (l.toPromise = function () {
            return g || ((g = u()), 2 === h ? g.reject(f) : 0 !== h && g.resolve(d)), g.promise
          }),
      ...
      function G(e, t) {
        ...
        var O = { channel: n, dispatch: (0, a.E)(o), getState: i, sagaMonitor: u, onError: f, finalizeRunEffect: m }
        return g(function () {
    ...
    29885: (e, t, r) => {
      ...
      function u(e, t, r) {
        for (var i = arguments.length, s = new Array(i > 3 ? i - 3 : 0), u = 3; u < i; u++) s[u - 3] = arguments[u]
        var l,
          d,
          f = function () {
        ...
        return (
          ...
          c(
            {
              q1: function () {
                return { nextState: 'q2', effect: { done: !1, value: (0, o.U)(t, (0, o.V)(1)) }, stateUpdater: v }
              },
              q2: function () {
    ...
    6047: (e, t, r) => {
      ...
      r.d(t, { applyMiddleware: () => m, bindActionCreators: () => v, combineReducers: () => g, createStore: () => h })
      ...
      function h(e, t, r) {
        ...
        return y({ type: d.INIT }), ((n = { dispatch: y, subscribe: v, getState: p, replaceReducer: m })[u] = S), n
      }
      function g(e) {
        ...
        try {
          !(function (e) {
            Object.keys(e).forEach(function (t) {
              var r = e[t]
              if (void 0 === r(void 0, { type: d.INIT })) throw new Error(c(12))
              if (void 0 === r(void 0, { type: d.PROBE_UNKNOWN_ACTION() })) throw new Error(c(13))
            })
          })(r)
        } catch (e) {
          i = e
      ...
      function m() {
        ...
        return function (e) {
          return function () {
            ...
            return (n = y.apply(void 0, i)(r.dispatch)), a(a({}, r), {}, { dispatch: n })
          }
        }
      }
    },
    ...
    94212: (e, t, r) => {
      ...
      function u(e, t, r) {
        ...
        return y({ type: a.INIT }), ((n = { dispatch: y, subscribe: v, getState: p, replaceReducer: m })[i] = S), n
      }
      var l = r(6346)
      function d(e) {
      ...
      const f = 'dnd-core/INIT_COORDS',
        ...
        y = 'dnd-core/END_DRAG'
      function m(e, t) {
        return { type: f, payload: { sourceClientOffset: t || null, clientOffset: e || null } }
      }
      const S = { type: f, payload: { clientOffset: null, sourceClientOffset: null } }
      function b(e) {
        return function (t = [], r = { publishSource: !0 }) {
          const { publishSource: n = !0, clientOffset: o, getSourceClientOffset: i } = r,
            s = e.getMonitor(),
            a = e.getRegistry()
          e.dispatch(m(o)),
            (function (e, t, r) {
              ;(0, l.invariant)(!t.isDragging(), 'Cannot call beginDrag while dragging.'),
                e.forEach(function (e) {
                  ;(0, l.invariant)(r.getSource(e), 'Expected sourceIds to be registered.')
                })
            })(t, s, a)
      ...
      function w(e) {
        return function (t = {}) {
          const r = e.getMonitor(),
            n = e.getRegistry()
          !(function (e) {
            ;(0, l.invariant)(e.isDragging(), 'Cannot call drop while not dragging.'),
              (0, l.invariant)(!e.didDrop(), 'Cannot call drop twice during one drag operation.')
          })(r)
          const o = (function (e) {
          ...
          o.forEach((o, i) => {
            const s = (function (e, t, r, n) {
                ...
                ;(function (e) {
                  ;(0, l.invariant)(void 0 === e || d(e), 'Drop result must either be an object or undefined.')
                })(i),
      ...
      function T(e) {
        return function () {
          const t = e.getMonitor(),
            r = e.getRegistry()
          !(function (e) {
            ;(0, l.invariant)(e.isDragging(), 'Cannot call endDrag while not dragging.')
          })(t)
      ...
      function C(e) {
        return function (t, { clientOffset: r } = {}) {
          !(function (e) {
            ;(0, l.invariant)(Array.isArray(e), 'Expected targetIds to be an array.')
          })(t)
          const n = t.slice(0),
            o = e.getMonitor(),
            i = e.getRegistry()
          return (
            ...
            (function (e, t, r) {
              ;(0, l.invariant)(t.isDragging(), 'Cannot call hover while not dragging.'),
                (0, l.invariant)(!t.didDrop(), 'Cannot call hover after drop.')
              for (let t = 0; t < e.length; t++) {
                const n = e[t]
                ;(0, l.invariant)(e.lastIndexOf(n) === t, 'Expected targetIds to be unique in the passed array.')
      ...
      class N {
        ...
        getActions() {
          ...
          const r = (function (e) {
            return { beginDrag: b(e), publishDragSource: I(e), hover: C(e), drop: w(e), endDrag: T(e) }
          })(this)
      ...
      class A {
        subscribeToStateChange(e, t = {}) {
          ...
          ;(0, l.invariant)('function' == typeof e, 'listener must be a function.'),
            (0, l.invariant)(
            ...
            try {
              const i =
                ...
                (o === n + 1 &&
                  !(function (e, t) {
                    return (
                      e !== x && (e === M || void 0 === t || ((r = e), t.filter((e) => r.indexOf(e) > -1)).length > 0)
                    )
                    var r
                  })(t.dirtyHandlerIds, r))
              i || e()
        ...
        canDragSource(e) {
          ...
          return (
            (0, l.invariant)(t, `Expected to find a valid source. sourceId=${e}`),
        ...
        canDropOnTarget(e) {
          ...
          if (
            ((0, l.invariant)(t, `Expected to find a valid target. targetId=${e}`),
        ...
        getSourceClientOffset() {
          return (function (e) {
            ...
            return t && r && n ? P(((i = n), { x: (o = t).x + i.x, y: o.y + i.y }), r) : null
            var o, i
        ...
        U = new (class {
          create(e) {
            const t = this.freeTasks,
              r = t.length ? t.pop() : new k(this.onError, (e) => (t[t.length] = e))
            return (r.task = e), r
          }
          constructor(e) {
      ...
      class V {
        addSource(e, t) {
          K(e),
            (function (e) {
              ;(0, l.invariant)('function' == typeof e.canDrag, 'Expected canDrag to be a function.'),
                (0, l.invariant)('function' == typeof e.beginDrag, 'Expected beginDrag to be a function.'),
                (0, l.invariant)('function' == typeof e.endDrag, 'Expected endDrag to be a function.')
            })(t)
        ...
        addTarget(e, t) {
          K(e, !0),
            (function (e) {
              ;(0, l.invariant)('function' == typeof e.canDrop, 'Expected canDrop to be a function.'),
                (0, l.invariant)('function' == typeof e.hover, 'Expected hover to be a function.'),
                (0, l.invariant)('function' == typeof e.drop, 'Expected beginDrag to be a function.')
            })(t)
        ...
        getTarget(e) {
          return (0, l.invariant)(this.isTargetId(e), 'Expected a valid target ID.'), this.dropTargets.get(e)
        }
        getSourceType(e) {
          return (0, l.invariant)(this.isSourceId(e), 'Expected a valid source ID.'), this.types.get(e)
        }
        getTargetType(e) {
          return (0, l.invariant)(this.isTargetId(e), 'Expected a valid target ID.'), this.types.get(e)
        }
        isSourceId(e) {
          return z(e) === G.SOURCE
        }
        ...
        pinSource(e) {
          ...
          ;(0, l.invariant)(t, 'Expected an existing source.'), (this.pinnedSourceId = e), (this.pinnedSource = t)
        }
        unpinSource() {
          ;(0, l.invariant)(this.pinnedSource, 'No source is pinned at the time.'),
        ...
        addHandler(e, t, r) {
          ...
          return (
            this.types.set(n, t),
            e === G.SOURCE ? this.dragSources.set(n, r) : e === G.TARGET && this.dropTargets.set(n, r),
            n
          )
        }
        constructor(e) {
      ...
      const ee = { initialSourceClientOffset: null, initialClientOffset: null, clientOffset: null }
      function te(e = ee, t) {
        const { payload: r } = t
        switch (t.type) {
          case f:
        ...
        switch (t.type) {
          ...
          case q:
            return -1 === e.targetIds.indexOf(r.targetId)
              ? e
              : ne({}, e, { targetIds: ((n = e.targetIds), (o = r.targetId), n.filter((e) => e !== o)) })
          case v:
            return ne({}, e, { dropResult: r.dropResult, didDrop: !0, targetIds: [] })
          case y:
            return ne({}, e, {
              itemType: null,
              item: null,
      ...
      function de(e, t, r = {}, n = !1) {
        const o = (function (e) {
            ...
            return u(le, e && t && t({ name: 'dnd-core', instanceId: 'dnd-core' }))
          })(n),
          i = new A(o, new V(o)),
          s = new N(o, i),
          a = e(s, t, r)
