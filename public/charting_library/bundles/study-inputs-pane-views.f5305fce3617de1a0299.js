  ...
  [2183],
  {
    36036: (e, t, i) => {
      ...
      class v extends h.BitmapCoordinatesPaneRenderer {
          ...
          for (let o = 0; o < r.length; ++o) {
            ...
            if (a.subtract(e).length() <= n + s)
              return new d.HitTestResult(null !== (t = a.hitTarget) && void 0 !== t ? t : d.HitTarget.ChangePoint, {
                ...
                cursorType: null !== (i = a.cursorType) && void 0 !== i ? i : u.PaneCursorType.Default,
        ...
        _drawImpl(e) {
          ...
          t.length && this._drawPoints(e, t, i, y, P), n.length && this._drawPoints(e, n, r, m, f)
        }
        _drawPoints(e, t, i, n, r) {
          ...
          for (let e = 0; e < t.length; ++e) {
            const o = t[e]
            s.fillStyle = i[e]
            if (!((0, l.isInteger)(o.pointIndex) && u.linePointBeingEdited === o.pointIndex)) {
              if (
                (n(s, _({ ...o, x: Math.round(o.x * a) + y, y: Math.round(o.y * d) + y }), P / 2, p),
                ...
                if (o.subtract(u.currentPoint).length() <= h + f) {
                  ...
                  t % 2 != g % 2 && (t += 1)
                  r(s, _({ ...o, x: Math.round(o.x * a) + y, y: Math.round(o.y * d) + y }), t / 2, e)
                }
              }
            }
          }
    ...
    35581: (e, t, i) => {
      ...
      class s extends r.TimeAxisView {
        ...
        _getIndex() {
          ...
          return null === e ? null : this._model.timeScale().timePointToIndex(e / 1e3)
        }
        _isVisible() {
          return !0
        }
      ...
      class h extends d.StudyInputsPaneView {
        ...
        _fillCompositeRendrer(e, t) {
          this._fillInformationAboutPointsAndCursors(e, t),
            this._renderer.append(this._createStudyAnchor({ points: this._points }, e, 0))
        }
        _fillInformationAboutPointsAndCursors(e, t) {
          if (((this._points = []), this._inputs.find((e) => Array.isArray(e) || 'price' === e.type))) {
          ...
          this._inputs.forEach((i, r) => {
            ...
            if (Array.isArray(i)) {
              ...
              null !== n &&
                null !== r &&
                ((d = this._convertTimeToCoordinate(n)), (u = this._convertPriceToCoordinate(r)), (c = !1))
            } else {
              const n = this._getInputValue(i.id)
              null !== n &&
                ('time' === i.type
                  ? ((d = this._convertTimeToCoordinate(n)), (u = e / 2), (s = a.PaneCursorType.HorizontalResize))
                  : ((d = t / 2), (u = this._convertPriceToCoordinate(n)), (s = a.PaneCursorType.VerticalResize)))
            }
            if (null !== d && null !== u) {
              ...
              ;(e.activeItem = h),
                ...
                this._points.push(
                  (0, l.anchor)({
                    ...
                    cursorType: s,
                    possibleMovingDirections: ((p = Array.isArray(i) ? i[0].type : i.type), 'price' === p ? 2 : 1),
                  }),
                )
            }
            var p
        ...
        _createStudyAnchor(e, t, i) {
          const n = (0, s.lastMouseOrTouchEventInfo)().isTouch,
            ...
            l = (this._isHovered() || this._isSelected()) && !this._model.isSnapshot(),
            d = {
              ...e,
          ...
          return this._editable || (d.disableInteractions = !0), r.setData(d), r
        }
        _studyAnchorColors(e, t) {
          return e.map((e) => this._model.backgroundColorAtYPercentFromTop(e.y / t))
        }
        _getStudyAnchorRenderer(e) {
          for (; this._studyAnchorRenderers.length <= e; ) this._studyAnchorRenderers.push(new l.LineAnchorRenderer())
    ...
    98255: (e, t, i) => {
      ...
      var n = i(19625),
        ...
        l = i(95173),
        d = i(50546)
      const u = { color: n.colorsPalette['color-cold-gray-500'], linewidth: 1, linestyle: r.LINESTYLE_SOLID }
          ...
          this._inputs.forEach((e) => {
            if (Array.isArray(e)) {
              ...
              if (null !== n && null !== r) {
                ...
                null !== e && null !== s && (this._renderer.append(e), this._renderer.append(s))
              }
            } else {
    ...
    50546: (e, t, i) => {
      ...
      class s {
        ...
        addInput(e) {
          ;(0, n.assert)(-1 === this._inputs.indexOf(e), 'Pane view already contains specified input'),
            this._inputs.push(e),
            this.update()
        }
        update(e) {
        ...
        renderer(e) {
          return (
            this._invalidated && (this._updateImpl(e.mediaSize.height, e.mediaSize.width), (this._invalidated = !1)),
            this._renderer
          )
        }
        _updateImpl(e, t) {
          this._renderer.clear()
          this._model.timeScale().isEmpty() || 0 === this._inputs.length || this._fillCompositeRendrer(e, t)
        }
