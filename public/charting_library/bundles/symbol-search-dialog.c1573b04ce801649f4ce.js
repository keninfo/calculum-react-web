  ...
  [1754],
  {
    89324: (e, o, t) => {
      ...
      var a = t(82992),
        ...
        i = t(84015)
      t(56570), t(49483)
      !(0, i.isOnMobileAppPage)('any') && window.matchMedia('(min-width: 602px) and (min-height: 445px)').matches
      function c(e) {
        new r.WatchedValue({})
        const o = (0, n.getSymbolSearchCompleteOverrideFunction)(),
          { defaultValue: t, showSpreadActions: i, source: c, onSearchComplete: h, trackResultsOptions: m, ...d } = e,
          u = {
            ...d,
            ...
            onSearchComplete: (e, t) => {
              ...
              o(e[0].symbol, e[0].result).then((e) => {
                a.linking.setSymbolAndLogInitiator(e.symbol, 'symbol search'), null == h || h(e.symbol)
              })
            },
    ...
    1861: (e, o, t) => {
      ...
      function i(e) {
        ...
        function W() {
          V.unmount(), n.dialogsOpenerManager.setAsClosed('SymbolSearch'), w && w()
        }
        return n.dialogsOpenerManager.setAsOpened('SymbolSearch'), C && C(), { close: W }
      }
    },
    51826: (e, o, t) => {
