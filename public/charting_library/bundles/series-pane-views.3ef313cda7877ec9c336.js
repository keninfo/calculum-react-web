    ...
    40481: (t, e, i) => {
      ...
      class m extends h.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(t) {
          const e = this._data
          if (null === e) return
          const { dateString: i, timeString: r, eod: l, point: n, direction: h } = e,
            T = Math.round(4.5),
            m = t.context
          let f,
            x = 0,
          ...
          if (e.eod) {
            ...
            if ((m.fillText((0, a.ensureDefined)(e.dateString), t + i, B + T + 8), e.timeString)) {
      ...
      class f {
        ...
        _updateImpl() {
          ...
          let T, m
          if (!t) {
            const t = (0, a.ensureNotNull)(e.timeScale().indexToUserTime((0, a.ensureNotNull)(o)))
            ;(T = e.dateFormatter().format(t)), this._series.isDWM() || (m = e.timeFormatter().format(t))
          }
          ;(this._data = { point: g, direction: u, eod: t, dateString: T, timeString: m }),
        ...
        _getTargetBar(t) {
          ...
          return (
            t < i && null !== e.first()
              ...
              : t > r && null !== e.last()
                ? ((n = (0, a.ensureNotNull)(e.lastIndex())), (l = (0, a.ensureNotNull)(e.last()).value))
