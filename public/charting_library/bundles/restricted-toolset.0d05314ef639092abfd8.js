  ...
  [5516, 9685],
  {
    ...
    36189: (e, t, a) => {
      ...
      var i = a(11542),
        ...
        r = a(48010),
        h = a(98992)
      const c = { add: i.t(null, void 0, a(69207)), remove: i.t(null, void 0, a(85106)) }
      function d(e) {
        const { className: t, isFilled: a, isActive: i, onClick: d, ...u } = e
        return n.createElement(s.Icon, {
          ...u,
          className: o(h.favorite, 'apply-common-tooltip', a && h.checked, i && h.active, t),
          icon: a ? l : r,
          onClick: d,
    ...
    70412: (e, t, a) => {
      'use strict'
      a.d(t, { hoverMouseEventFilter: () => o, useAccurateHover: () => s, useHover: () => n })
      var i = a(50959)
      function n() {
    ...
    96040: (e, t, a) => {
      ...
      function h(e) {
        ...
        return n.createElement(s.Icon, {
          ...g,
          'data-name': m,
          className: o(r.button, 'apply-common-tooltip', h && r.active, v && r.hidden, t),
          icon: p || l,
          onClick: c,
          onMouseDown: d,
    ...
    39706: (e, t, a) => {
      ...
      const r = (0, i.forwardRef)(function (e, t) {
        const { open: a, summary: n, children: r, onStateChange: h, tabIndex: c, className: d, ...u } = e
        return i.createElement(
          ...
          i.createElement(
            ...
            n,
            i.createElement(s.ToolWidgetCaret, { className: l.caret, dropped: Boolean(a) }),
          ),
          a && r,
        )
      })
    ...
    40894: (e, t, a) => {
      ...
      function h(e) {
        ...
        return i.createElement(
          'button',
          { ref: h, tabIndex: c, onClick: a, className: o()(r.button, n.isActive && r.active), type: 'button' },
          i.createElement(l.FavoriteButton, { 'aria-label': t, ...n, 'data-tooltip': t }),
        )
      }
    },
    10428: (e, t, a) => {
      'use strict'
      a.d(t, { DEFAULT_MENU_ITEM_SWITCHER_THEME: () => S, MenuItemSwitcher: () => _ })
      var i,
        n = a(50959),
        o = a(97754),
        s = a.n(o),
      ...
      function m(e) {
        ...
        return n.createElement(
          ...
          n.createElement('input', {
            ...
            onKeyDown: (e) => {
              var t
              13 === (0, d.hashFromEvent)(e) && (null === (t = e.currentTarget) || void 0 === t || t.click())
            },
            onChange: m,
            disabled: u,
            'aria-disabled': y,
      ...
      function _(e) {
        const {
          ...
          k = s()(t, v.wrapper, a && v.wrapperWithOnLabel, l && v.wrapperWithDescription)
        return n.createElement(
          'label',
          {
          ...
          void 0 !== _ && n.createElement(p.Icon, { className: v.icon, icon: _ }),
          n.createElement(
            'div',
    ...
    38068: (e, t, a) => {
      ...
      function c(e) {
        ...
        return i.createElement(
          'button',
          { ref: c, tabIndex: d, onClick: a, className: o()(h.button, n.isActive && h.active), type: 'button' },
          i.createElement(l.RemoveButton, { 'aria-label': t, ...n, 'data-tooltip': t, icon: r }),
        )
      }
    },
    34009: (e, t, a) => {
      ...
      const p = n.forwardRef((e, t) => {
        ...
        return n.createElement('div', { className: u(i, m.wrap), ref: t, ...o }, a)
      })
      var g = a(20792),
        b = a(6993)
      ...
      function I(e) {
        ...
        return n.createElement('div', {
          ...
          onKeyDown: (0, E.createSafeMulticastEventHandler)(function (e) {
            ...
            Array.from(n.querySelectorAll('[role="radio"]:not([disabled]):not([aria-disabled])')).filter(
              (0, T.createScopedVisibleElementFilter)(n),
            )).sort(T.navigationOrderComparator)
            var n
            ...
            const s = () => {
                ...
                i[o].dispatchEvent(new CustomEvent('roving-tabindex:secondary-element')),
                  i[e].dispatchEvent(new CustomEvent('roving-tabindex:main-element')),
                  i[e].focus()
              },
              l = () => {
                const e = (o + i.length + 1) % i.length
      ...
      class D extends n.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._handleChangeStyle = (e) => {
              const { favorites: t, lastSelectedNotFavorite: a, activeStyle: i } = this.state
              this.setState({ activeStyle: e, lastSelectedNotFavorite: t.includes(i) ? a : i })
            }),
        ...
        render() {
          const { isShownQuicks: e, displayMode: t = 'full', id: i } = this.props,
            { activeStyle: o, favorites: r, styles: u, lastSelectedNotFavorite: v } = this.state,
            m = 'small' !== t && e && 0 !== r.length,
            g = [...r]
          g.includes(o) ? void 0 !== v && g.push(v) : g.push(o)
          const b = m && g.length > 1
          return n.createElement(_.MatchMedia, { rule: y.DialogBreakpoints.TabletSmall }, (e) => {
            const t = u.map((t, a) =>
              t === O
                ? n.createElement(S.PopupMenuSeparator, { key: `separator-${a}` })
            ...
            return n.createElement(
              ...
              n.createElement(
                ...
                {
                  arrow: Boolean(b),
                  content: b ? void 0 : n.createElement(p, null, n.createElement(s.Icon, { icon: c.SERIES_ICONS[o] })),
                  tooltip: b ? l.t(null, void 0, a(27246)) : (0, M.getTranslatedChartStyleName)(o),
                  className: N.menu,
                  isDrawer: e,
        ...
        _renderPopupMenuItem(e, t, a) {
          ...
          return n.createElement(R.AccessibleMenuItem, {
            ...
            isActive: t,
            isDisabled: H(e),
            label: n.createElement('div', { className: N.label }, (0, M.getTranslatedChartStyleName)(e) || '', !1, !1),
      ...
      const B = ['medium', 'small'],
        V = (0, n.forwardRef)(function (e, t) {
          const { text: a, className: i, displayMode: o, collapseWhen: s = B, ...l } = e,
            r = !s.includes(o)
      ...
      function z(e) {
        ...
        return n.createElement(V, { 'aria-label': t, ...a, tag: 'button', tabIndex: o, ref: i, 'data-tooltip': t })
      }
      var Z = a(51768),
        K = a(76460),
        q = a(1393)
      ...
      class G extends n.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (0, f.validateRegistry)(t, { chartWidgetCollection: o.any.isRequired }),
                ...
                .then((e) => {
                  const t = (function (e, t) {
                    ...
                    return (
                      e.forEach((e, i) => {
                        const n = t.get(i)
                        void 0 !== n ? a.items.push({ item: e, info: n }) : a.notFoundItems.push(e)
                      }),
                      a
                    )
                  })(n, e)
                  if (0 !== t.notFoundItems.length) {
                    ...
                    re.logWarn(`Cannot find java scripts: ${JSON.stringify(e)}`)
                  }
                  return t.items
                }),
            ),
          Promise.all(t).then(
            (e) => (re.logNormal('Requesting favorites info finished'), e.reduce((e, t) => e.concat(t), [])),
          )
        )
      }
      var ce = a(630),
      ...
      function me(e) {
        const { className: t } = e
        return n.createElement('div', { className: v()(ve.spinnerWrap, t) }, n.createElement(ue.Loader, null))
      }
      var pe = a(16829),
        ge = a(76422),
        be = a(39681),
      ...
      class ye extends n.PureComponent {
          ...
          super(e, t),
            ...
            (this._handleClick = (e) => {
              ...
              this.setState({ isActive: !0 }, () => {
                t.visible().value() ? t.hide() : t.show({ shouldReturnFocus: (0, K.isKeyboardClick)(e) })
              }),
                this._trackClick()
            }),
            (this._handleSelectIndicator = (e) => {
              ...
              ;(async () => {
                ...
                const { chartWidgetCollection: t } = this.context
                if ('java' === e.type) {
                  const t = (0, ce.tryFindStudyLineToolNameByStudyId)(e.studyId)
                  if (null !== t) return await (0, ce.initLineTool)(t), void de.tool.setValue(t)
                }
            ...
            (0, f.validateRegistry)(t, { favoriteScriptsModel: o.any, chartWidgetCollection: o.any.isRequired })
          const { favoriteScriptsModel: a } = t,
            i = void 0 !== a ? a.favorites() : []
          this.state = { isActive: !1, isLoading: !1, favorites: i, favoriteFundamentals: void 0, infos: [] }
        }
        componentDidMount() {
        ...
        render() {
          const { isActive: e, favorites: t, favoriteFundamentals: i, isLoading: o } = this.state,
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              Boolean(t.length > 0 || (null == i ? void 0 : i.size)) &&
                n.createElement(_.MatchMedia, { rule: 'screen and (max-width: 430px)' }, (e) =>
                  n.createElement(
                    d.ToolbarMenuButton,
                    {
      ...
      function we(e) {
        return e.info.localizedName || l.t(e.info.name, { context: 'study' }, a(83477))
      }
      ye.contextType = _e
      var fe = a(10074),
        ke = a(85049),
        Me = a(53658)
      function Ee(e) {
        return n.createElement('div', { className: u(Me.value, { [Me.selected]: e.isSelected }) }, e.value, e.metric)
      }
      var xe = a(90186),
        Te = a(70412),
        Ie = a(32563),
      ...
      function Ne(e) {
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(R.AccessibleMenuItem, {
              ...m,
              className: v()(Ae.menuItem, u && Ae.smallWidthMenuItem, r && Ae.signal),
              ...
              toolbox: (function () {
                const { isRemovable: t, isFavoritingAllowed: a } = e,
                  ...
                  s = n.createElement(A.MenuFavoriteButton, { key: 'favorite', isActive: i, isFilled: l, onClick: C })
                return [t && o, a && s]
              })(),
      ...
      const Fe = {
        [ke.ResolutionKind.Ticks]: l.t(null, { context: 'interval_group_name' }, a(49512)),
        [ke.ResolutionKind.Seconds]: l.t(null, { context: 'interval_group_name' }, a(32116)),
        [ke.ResolutionKind.Minutes]: l.t(null, { context: 'interval_group_name' }, a(21551)),
        [ke.SpecialResolutionKind.Hours]: l.t(null, { context: 'interval_group_name' }, a(18817)),
        [ke.ResolutionKind.Days]: l.t(null, { context: 'interval_group_name' }, a(57252)),
        [ke.ResolutionKind.Weeks]: l.t(null, { context: 'interval_group_name' }, a(41815)),
        [ke.ResolutionKind.Months]: l.t(null, { context: 'interval_group_name' }, a(89506)),
        [ke.ResolutionKind.Range]: l.t(null, { context: 'interval_group_name' }, a(22163)),
      ...
      var Be = a(34585),
        Ve = a(69397),
        ze = a(6198)
      const Ze = { openDialog: l.t(null, void 0, a(46311)), timeInterval: l.t(null, void 0, a(41173)) },
        Ke = (0, X.hotKeySerialize)({ keys: [','], text: l.t(null, void 0, a(92969)) }),
      ...
      class je extends n.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (this._renderChildren = (e, t) => [...this._createIntervalItem(t), ...this._createMenuItems(e, t)]),
            ...
            (this._handleSelectInterval = (e) => {
              void 0 !== e && e !== r.linking.interval.value() && this.context.chartWidgetCollection.setResolution(e),
            ...
            (this._handleAddInterval = (e, t) => {
              const { intervalService: a, intervalsMenuViewStateService: i } = this.context,
                { menuViewState: n } = this.state,
                o = a.add(e, t)
              if (o) {
                this.setState({ lastAddedInterval: o })
                const e = ke.Interval.parseExt(o)
                if (e.interval.isMinuteHours()) return void i.set({ ...n, [ke.SpecialResolutionKind.Hours]: !1 })
                const t = e.guiResolutionKind
                if (t === ke.ResolutionKind.Days || t === ke.ResolutionKind.Weeks || t === ke.ResolutionKind.Months)
        ...
        componentDidMount() {
          ...
          e.getOnChange().subscribe(this, this._handleChangeFavorites),
            ...
            r.linking.dataFrequencyResolution.subscribe(this._bindedForceUpdate),
        ...
        componentWillUnmount() {
          ...
          e.getOnChange().unsubscribe(this, this._handleChangeFavorites),
            ...
            r.linking.dataFrequencyResolution.unsubscribe(this._bindedForceUpdate),
            De.globalCloseDelegate.unsubscribe(this, this._handleGlobalClose)
        }
        componentDidUpdate(e, t) {
          this.state.lastAddedInterval && setTimeout(() => this.setState({ lastAddedInterval: void 0 }), 1600)
        }
        render() {
          const { isShownQuicks: e, id: t } = this.props,
            { activeInterval: a, customs: i, lastNotQuicked: o, isAddIntervalDialogOpened: s } = this.state,
            l = this._getQuicks(),
            r = (0, fe.sortResolutions)([...l])
          void 0 !== a && r.includes(a) ? void 0 !== o && r.push(o) : void 0 !== a && r.push(a)
          ...
          return n.createElement(
              ...
              n.createElement(
                ...
                r.map((e, t) => {
                  ...
                  return n.createElement(C, {
                    key: t,
                    role: 'radio',
                    className: u(Ve.button, { [Ve.first]: 0 === t, [Ve.last]: t === r.length - 1 }),
            ...
            n.createElement(_.MatchMedia, { rule: y.DialogBreakpoints.TabletSmall }, (e) =>
              n.createElement(
                n.Fragment,
                null,
                n.createElement(
                  ...
                  n.createElement(
                    ...
                    n.createElement('div', { className: Ve.dropdown }, this._renderChildren(v, e)),
                  ),
                ),
                s &&
                  n.createElement(
        ...
        _createMenuItems(e, t) {
          ...
          })(e).map((e, a, i) => this._renderResolutionsGroup(e, 1 === i.length, t))
          return (function (e) {
            let t = !1
            return e.filter((e, a, i) => {
              let n = !0
              return (
                e.type === S.PopupMenuSeparator && ((0 !== a && a !== i.length - 1) || (n = !1), t && (n = !1)),
        ...
        _createIntervalItem(e) {
          return this._customIntervals
            ? [
                ...
                n.createElement(S.PopupMenuSeparator, { key: 'custom-interval-separator' }),
              ]
            : []
        }
        _renderResolutionsGroup(e, t = !1, a) {
          ...
          return (
            (!e.mayOmitSeparator || e.items.length > 1) &&
              (i.unshift(n.createElement(S.PopupMenuSeparator, { key: `begin-${e.name}` })),
              i.push(n.createElement(S.PopupMenuSeparator, { key: `end-${e.name}` }))),
            i
          )
        }
        ...
        constructor(e, t) {
          super(e, t),
            ...
            (this._handleClick = (e) => {
              ...
              ;(0, Z.trackEvent)('GUI', 'Chart Header Toolbar', 'chart properties'),
                a.showGeneralChartProperties(void 0, { shouldReturnFocus: (0, K.isKeyboardClick)(e) })
            }),
            (0, f.validateRegistry)(t, { chartWidgetCollection: o.any.isRequired }),
      ...
      function ut(e) {
        ...
        return n.createElement(
          ...
          i
            ? n.createElement(ue.Loader, { className: dt.loader, size: 'small', staticPosition: !0 })
      ...
      const bt = i.enabled('widget'),
        ...
        St = (0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, { shortcut: pt.shortcut, withIcon: pt.withIcon }),
        _t =
          ((0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, { toolbox: pt.toolbox }),
          (0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, { toolbox: pt.toolboxSmall }),
      ...
      class Mt extends n.PureComponent {
        ...
        render() {
          ...
          vt.showFavoriteLayouts &&
            C &&
            S &&
            (k = C.filter((e) => S[e.id]).sort((e, t) => e.name.localeCompare(t.name)))
          const M = !(h || !r || this.state.isSaving),
            E = n.createElement(
              'div',
              { className: pt.textWrap },
              n.createElement('span', { className: pt.text }, r || l.t(null, void 0, a(64e3))),
              n.createElement(ut, { isSaving: this.state.isSaving, wasChanges: h }),
            )
          return n.createElement(
            p,
            null,
            t
              ...
              : n.createElement(
                  ...
                  n.createElement(z, {
                    ...
                    collapseWhen: wt,
                    isOpened: b,
                    tooltip: M ? l.t(null, void 0, a(89771)) : l.t(null, void 0, a(15356)),
        ...
        _renderMenuItems(e) {
          ...
          return (
            ...
            x.push(
              n.createElement(S.PopupMenuSeparator, { key: 'all-layouts-separator' }),
              n.createElement(R.AccessibleMenuItem, {
                key: 'all-layouts',
      ...
      ;(0, n.forwardRef)((e, t) => {
        ...
        return n.createElement(
          ...
          {
            ref: s,
            className: u(pt.copyLink, i && pt.copyLinkMobile, pt.accessibleLabel),
            onClick: o,
            tabIndex: r,
            onKeyDown: function (e) {
              if (e.target !== e.currentTarget) return
              const t = (0, $.hashFromEvent)(e)
              ;(13 !== t && 32 !== t) || (e.preventDefault(), s.current instanceof HTMLElement && s.current.click())
            },
            'data-role': 'menuitem',
          },
      ...
      class xt extends n.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (this._requestRecentLayouts = () => {
              var e
              null === (e = this._recentLayoutsAbortController) || void 0 === e || e.abort()
            }),
            (this._updateState = (e) => {
              this.setState((t) => ({ ...t, ...e }))
            }),
        ...
        componentDidMount() {
          ...
          t
            ...
            : (o.getOnChange().subscribe(this, this._onChangeHasChanges),
              ...
              this._hotkeys.add({ desc: l.t(null, void 0, a(29517)), handler: this._handleHotkey, hotkey: 190 }),
        ...
        render() {
          const { isReadOnly: e, displayMode: t, id: a, isFake: i } = this.props,
            {
              isProcessing: o,
              isAuthenticated: s,
              title: l,
          ...
          return n.createElement(_.MatchMedia, { rule: y.DialogBreakpoints.TabletSmall }, (e) =>
            n.createElement(Mt, { ...g, isTabletSmall: e }),
          )
        }
        _onLoginStateChange() {
          const e = window.is_authenticated
          this.setState({ isAuthenticated: e }),
            vt.showFavoriteLayouts && this.context.loadChartService.refreshChartList()
        }
        _trackEvent(e) {
          0
        }
      ...
      var Tt = a(7986),
        It = a(52388),
        Rt = a(13665)
      const At = new It.DateTimeFormatter({ dateTimeSeparator: '_', timeFormat: '%h-%m-%s' }),
      ...
      function Lt(e) {
        ...
        return n.createElement(
          ...
          n.createElement('span', { className: a }, n.createElement(ue.Loader, null)),
        )
      }
      var Wt = a(76974),
        Pt = a(67487),
      ...
      function Qt(e) {
        const { serverSnapshot: t, clientSnapshot: i, hideShortcuts: o } = e,
          ...
          S = (0, n.useCallback)(async () => {
            ...
            try {
              await (0, Ot.writePromiseUsingApi)(a, 'image/png'), ge.emit('onClientScreenshotCopiedToClipboard')
            } catch (a) {
            ...
            async (e = !1) => {
              ...
              try {
                if (e) await y(a)
                  ...
                  await (0, Ot.writePromiseUsingApi)(e, 'text/plain'), ge.emit('onServerScreenshotCopiedToClipboard')
                }
                return !0
              } catch (e) {
                return y(a), !0
          ...
          f =
                  ...
                  a = e.then(async (e) => {
                    ...
                    const o = await snapshoter().getSnapshot(e.symbol, new Set(['description'])),
                      ...
                      l =
                        null !==
                          (i =
                            null === (a = e.imageUrl.match(/\/x\/([0-9a-zA-Z]{8})/)) || void 0 === a ? void 0 : a[1]) &&
                        void 0 !== i
                          ? i
                          : '',
                      r = null === (n = createSnapshotImageUrls(l)) || void 0 === n ? void 0 : n.url
                    return new Blob(
                      [
            ...
            (0, n.useCallback)(async () => {
              p(!0)
              const [e, i] = await Promise.all([a.e(4665).then(a.bind(a, 66921)), t()])
              e.Twitter.shareSnapshotInstantly(i.symbol, i.imageUrl), C.current && (p(!1), (0, De.globalCloseMenu)())
            }, [t]))
        return n.createElement(
          n.Fragment,
          null,
          n.createElement(pe.ToolWidgetMenuSummary, null, l.t(null, void 0, a(58425))),
          n.createElement(R.AccessibleMenuItem, {
          ...
          !(0, lt.onWidget)() &&
            n.createElement(R.AccessibleMenuItem, {
              ...
              label: n.createElement(Lt, { isLoading: s }, l.t(null, void 0, a(81939))),
              icon: zt,
              onClick: () => {
                r(!0), w(!1)
              },
          ...
          !(0, lt.onWidget)() &&
            ...
            n.createElement(R.AccessibleMenuItem, {
              ...
              label: n.createElement(Lt, { isLoading: h }, l.t(null, void 0, a(19159))),
              icon: Zt,
              onClick: () => {
                c(!0), w(!0)
              },
          ...
          !(0, lt.onWidget)() &&
            ...
            n.createElement(R.AccessibleMenuItem, {
              ...
              label: n.createElement(Lt, { isLoading: m }, l.t(null, void 0, a(28239))),
              icon: Pt,
              onClick: f,
              dontClosePopup: !0,
              isDisabled: m,
            ...
            super(e, t),
              ...
              (this._serverSnapshot = async () => {
                const e = this.context.chartWidgetCollection.activeChartWidget
                  ...
                  a =
                    i.enabled('charting_library_base') && void 0 !== this.context.snapshotUrl
                      ? t
      ...
      class ia {
        async show(e) {
          if (null !== ia._provider) {
            ...
            return r.linking.setSymbolAndLogInitiator(e.symbol, 'symbol search UI'), e
          }
          if (ia._currentShowingInstance) throw new DOMException('SymbolSearchUI is already shown', 'InvalidStateError')
          try {
      ...
      class la extends n.PureComponent {
        constructor(e) {
          super(e),
                  ...
                  try {
                    ;(0, Z.trackEvent)('GUI', 'SS', 'main search'),
                      await new ia().show({
                        ...
                        showSpreadActions: (0, ea.canShowSpreadActions)() && this.props.isActionsVisible,
                        source: 'searchBar',
                        footer: Ie.mobiletouch
                          ? void 0
                          : n.createElement(ta.SymbolSearchDialogFooter, null, l.t(null, void 0, a(50021))),
                      })
                  } catch (e) {}
            ...
            (this.state = { symbol: r.linking.proSymbol.value(), shortName: ra(), isOpened: !1 })
        }
        componentDidMount() {
        ...
        render() {
          ...
          return n.createElement(g.ToolbarButton, {
            id: e,
            className: v()(t, i.enabled('uppercase_instrument_names') && oa.uppercase, oa.smallLeftPadding),
            theme: sa,
            icon: na,
      ...
      function ra() {
        return r.linking.seriesShortSymbol.value() || r.linking.proSymbol.value() || ''
      }
      var ha = a(89452)
      function ca(e) {
        return n.createElement('div', { className: u(ha.description, e.className) }, e.children)
      }
      var da = a(76032),
        ua = a(37926)
      const va = (0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, {
        ...
        pa = (0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, { item: ua.item }),
        ga = (0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, { item: ua.itemTabletSmall })
      function ba(e) {
        const {
            className: t,
            item: a,
        ...
        return n.createElement(
          ...
          n.createElement(R.AccessibleMenuItem, {
            ...
            toolbox: n.createElement(
              ...
              Boolean(s) &&
                r &&
                n.createElement(A.MenuFavoriteButton, { key: 'favorite', isFilled: Boolean(l), onClick: S }),
            ),
          }),
          m &&
            n.createElement(oe.PopupMenuItem, {
              theme: g,
              label: n.createElement(ca, { className: v()(ua.description, h && ua.descriptionTabletSmall) }, m),
              onClick: b,
              isHovered: c,
            }),
        )
        ...
        return n.createElement(R.AccessibleMenuItem, {
          ...
          label: n.createElement(
            ...
            n.createElement(
              ...
              n.createElement('div', { className: Sa.text }, (0, Be.appendEllipsis)(l.t(null, void 0, a(26869)))),
            ),
          ),
          onClick: t,
        })
      ...
      function Ea(e) {
        ...
        return n.createElement(
          ...
          h &&
            n.createElement(n.Fragment, null, n.createElement(S.PopupMenuSeparator, null), n.createElement(me, null)),
          !h &&
            (r
              ? n.createElement(xa, { defaults: c, customs: d, render: b })
              : n.createElement(Ta, { defaults: c, customs: d, render: b, state: m })),
        )
      }
      function xa(e) {
        ...
        return n.createElement(
          ...
          i.length > 0 &&
            n.createElement(
              ...
              null,
              n.createElement(S.PopupMenuSeparator, null),
              n.createElement(pe.ToolWidgetMenuSummary, { className: Ma.menuItemHeader }, l.t(null, void 0, a(83300))),
              i.map(o),
            ),
          i.length > 0 &&
            t.length > 0 &&
          ...
          0 === i.length &&
            ...
            n.createElement(
              ...
              null,
              n.createElement(S.PopupMenuSeparator, null),
              n.createElement(pe.ToolWidgetMenuSummary, { className: Ma.menuItemHeader }, l.t(null, void 0, a(46838))),
              t.map(o),
            ),
        )
      }
      ...
      class Aa {
        constructor(e) {
          ;(this._isFavoriteEnabled = i.enabled('items_favoriting')),
            (this.handleFavorTemplate = (e) => {
              ...
              null !== i ? this._removeFavoriteTemplate(t, a) : this._addFavoriteTemplate(t, a)
            }),
          ...
          ;(this._state = new Ia.WatchedValue({ isLoading: !1, studyTemplatesList: t })),
        ...
        getSortedFavoritesStudyTemplates(e) {
          return e
            ...
            .sort((e, t) =>
              null !== e.favorite_date && null !== t.favorite_date && e.favorite_date > t.favorite_date ? 1 : -1,
            )
        }
        _setState(e) {
        ...
        _removeFavoriteTemplate(e, t) {
          const a = t ? Ra.backend.favorStandardStudyTemplate : Ra.backend.favorStudyTemplate
          this._replaceOldFavoriteStudyTemplate(e, null, t), a(e, !1)
        }
        _addFavoriteTemplate(e, t) {
          const a = this.getSortedFavoritesStudyTemplates(this._state.value().studyTemplatesList),
            i = a.length ? a[a.length - 1].favorite_date : 0,
            n = window.is_authenticated ? Date.now() : i + 1,
            o = t ? Ra.backend.favorStandardStudyTemplate : Ra.backend.favorStudyTemplate
          this._replaceOldFavoriteStudyTemplate(e, n, t), o(e, !0)
        }
        _replaceOldFavoriteStudyTemplate(e, t, a) {
          const i = this._state
            .value()
            .studyTemplatesList.map((i) => (i.id === e && i.is_default === a ? { ...i, favorite_date: t } : i))
      ...
      function Ha(e) {
        var t
        const { className: a, name: i, onApply: o, isActive: s, href: l, target: r } = e,
        ...
        return n.createElement(
          d,
          {
            ...
            className: u(a, Fa.item, o && Fa.accessible, 'apply-common-tooltip'),
            onClick: function (e) {
          ...
          n.createElement(
            ...
            null !== (t = (0, Na.getFirstSegmentOrCodePointString)(i)) && void 0 !== t ? t : ' ',
          ),
        )
      }
      var Oa = a(21233),
      ...
      class La extends n.PureComponent {
        constructor(e, t) {
          ...
          ;(this._model = new Aa(a)), (this.state = { ...this._model.state().value(), isActive: !1 })
        }
        componentDidMount() {
        ...
        render() {
          const { studyTemplatesList: e } = this.state,
            { isShownQuicks: t, className: a, displayMode: i, id: o } = this.props,
      ...
      function Wa(e) {
        const {
          ...
          b = (0, n.useRef)(null),
          C = (0, n.useRef)(null),
          S = v()(i, Ua.wrap, { [Ua.full]: 'full' === o, [Ua.medium]: 'medium' === o }),
          w = 'small' !== o && m && r.length > 0
        return n.createElement(
          p,
          { id: t, className: S },
          n.createElement(_.MatchMedia, { rule: y.DialogBreakpoints.TabletSmall }, (t) =>
            n.createElement(
              d.ToolbarMenuButton,
              {
                ref: b,
        ...
        function f(e, t) {
          if (t && (0, K.isKeyboardClick)(t) && C.current) {
            ...
            g(e, () => {
              var e, i
              if (-1 !== a && C.current) {
                const n = null !== (e = t[a + 1]) && void 0 !== e ? e : t[a - 1]
        ...
        return n.createElement(
          ...
          e.favorites.map((t, a, i) =>
            n.createElement(Ha, {
              ...
              className: v()({ [Ua.first]: 0 === a, [Ua.last]: a === i.length - 1 }),
            }),
          ),
        )
      }
      ...
      class Qa extends n.PureComponent {
        ...
        render() {
          const { id: e } = this.props,
            { isEnabledRedo: t, isEnabledUndo: i, redoStack: o, undoStack: s } = this.state
          return n.createElement(
            p,
            { id: e },
            n.createElement(g.ToolbarButton, {
              ...
              theme: Ka,
              tooltip: i ? l.t(null, { replace: { hint: s } }, a(66020)) : void 0,
            ...
            n.createElement(g.ToolbarButton, {
              ...
              theme: Ka,
              tooltip: t ? l.t(null, { replace: { hint: o } }, a(11304)) : void 0,
      ...
      function oi() {
        return {
          ...
          OpenPopup: tt,
          Properties: i.enabled('header_settings') && i.enabled('show_chart_property_page') ? nt : void 0,
    ...
    23076: (e, t, a) => {
      ...
      var i = a(94670),
        ...
        v = a(71705),
        m = a(9450)
      const p = { 3: i, 16: n, 0: o, 1: s, 8: l, 9: r, 2: h, 14: c, 15: d, 10: u, 12: v, 13: m }
    },
    7986: (e, t, a) => {
      'use strict'
      a.d(t, {
