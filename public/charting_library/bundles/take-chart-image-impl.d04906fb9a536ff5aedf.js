      ...
      function w(e, t = {}) {
        return new Promise((a, n) => {
          !(async function (e, t, a, n = {}) {
            ...
            const w = null !== (i = s.model().model().timezoneExceptExchange().value()) && void 0 !== i ? i : 'exchange'
            r.append('timezone', w), r.append('symbol', s.model().mainSeries().symbol())
            const p = await e.clientSnapshot({ showHeaderMainSymbol: n.showHeaderMainSymbol }),
