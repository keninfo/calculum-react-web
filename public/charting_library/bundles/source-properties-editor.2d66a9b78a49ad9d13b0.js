  ...
  [6780],
  {
    ...
    78890: (e, t, i) => {
      ...
      class p extends s.PureComponent {
        ...
        _getPlaceHolderItem(e) {
          return e ? s.createElement(l.Icon, { className: d.defaultsButtonIcon, icon: u }) : m.defaults
        }
      }
    },
    48531: (e, t, i) => {
      ...
      function d(e) {
        return s.createElement(o.MatchMedia, { rule: 'screen and (max-width: 768px)' }, (t) =>
          s.createElement(
            l.ControlDisclosure,
            {
      ...
      function v(e) {
        ...
        return s.createElement(
          ...
          s.createElement(m.PopupMenuItem, {
            ...
            label: t,
            onClick: o,
            toolbox: i && s.createElement(h.RemoveButton, { hidden: !g.mobiletouch && !a, onClick: c, icon: b }),
          }),
        )
      }
      function f(e) {
          ...
          s.createElement(
            ...
            t &&
              s.createElement(
                o.PropertyTable,
                { reference: i, key: c },
                t.definitions.value().map((e) => s.createElement(r.Section, { key: e.id, definition: e })),
              ),
          ),
        )
      }
    ...
    75892: (e, t, i) => {
      ...
      var s = i(50959),
        ...
        I = i(56570),
        A = i(78746)
      const P = new T.TranslatedString('change {sourceTitle} title to {newSourceTitle}', c.t(null, void 0, i(23687)))
        ...
        constructor(e) {
          super(e),
            ...
            (this._getTranslatedStringForSource = (e) =>
              new T.TranslatedString(e.name(), e.title(g.TitleDisplayTarget.StatusLine))),
            (this._setTitle = (e) => {
              ...
              i.setProperty(t.properties().title, e, s, x.lineToolsDoNotAffectChartInvalidation && (0, b.isLineTool)(t))
            }),
            ...
            (this._renderFooterLeft = () => {
              ...
              return (0, b.isLineTool)(e)
                ? s.createElement(m.FooterMenu, { sources: [e], chartUndoModel: t })
                : s.createElement(
                    S.MatchMedia,
          ...
          const { pages: t } = this.props
          let i
          if (this._getActionPageById(this.props.activePageId)) i = (0, a.ensureDefined)(this.props.activePageId)
          else {
        ...
        _renderChildren(e) {
          return ({ requestResize: t }) => {
            ...
            const { pages: i, source: n } = this.props,
              a = i.find((t) => t.id === e),
              l = (0, v.isStudy)(n) ? 'indicator-properties-dialog-tabs' : 'source-properties-editor-tabs',
              o = i.map(({ title: e, id: t }) => ({ label: e, id: t, dataId: `${l}-${t}` }))
            return s.createElement(
              s.Fragment,
              null,
    ...
    68495: (e, t, i) => {
      ...
      var s = i(50959),
        ...
        d = i(52088)
      function m(e) {
        const { isRenaming: t, onChangeMode: i, setTitle: m, defaultTitle: h, canBeRenamed: p } = e,
          g = (0, s.useRef)(null),
          [b, v] = (0, s.useState)(h),
          [f, C] = (0, s.useState)(h)
        return (
          (0, s.useEffect)(() => {
            t && g.current && (g.current.focus(), g.current.setSelectionRange(0, b.length))
          }, [t]),
          s.createElement(
            s.Fragment,
            null,
              ...
              p &&
                s.createElement(
                  ...
                  s.createElement(l.Icon, {
                    ...
                    icon: u,
                    onClick: function () {
                      ;(0, c.trackEvent)('GUI', 'Rename', 'Drawing settings'), v(f), i(!0)
                    },
                    'data-name': 'edit',
                    'data-role': 'button',
                  }),
                  s.createElement('div', { className: n(d.empty, !t && d.hideEmpty) }),
                ),
            ),
            p &&
              s.createElement(
                ...
                s.createElement(a.InputControl, {
                  ...
                  onKeyDown: function (e) {
                    27 === (0, r.hashFromEvent)(e) && (e.preventDefault(), v(h), i(!1))
      ...
      function b(e) {
        const {
          ...
          S = !!(
            ...
            v.every((e) => {
              ...
              return (
                (null == x ? void 0 : x.id) ===
                (null === (t = f.model().lineToolsGroupModel().groupForLineTool(e)) || void 0 === t ? void 0 : t.id)
              )
            })
          ),
          [T, w] = (0, s.useState)(_),
        ...
        return s.createElement(r.AdaptiveConfirmDialog, {
          ...
          footerLeftRenderer: function () {
            return s.createElement(c.FooterMenu, { sources: v, chartUndoModel: f })
          },
          render: function () {
    ...
    93081: (e, t, i) => {
      ...
      const p = (0, n.createContext)({ size: 'small', overflowBehaviour: void 0 })
      var g = i(17946),
        b = i(24554)
      function v(e) {
        const {
      ...
      const f = (0, n.forwardRef)((e, t) => {
        ...
        return n.createElement(
          ...
          m && 'string' == typeof h
            ? n.createElement('span', { className: l()(b['ellipsis-children'], 'apply-overflow-tooltip') }, h)
            : h,
        )
      })
      f.displayName = 'UnderlineTabsBaseButton'
      const C = (0, n.forwardRef)((e, t) => {
        const { item: i, highlighted: s, handleItemRef: a, onClick: l, 'aria-disabled': o, ...r } = e,
          c = (0, n.useCallback)(() => {
            l && l(i)
          }, [l, i]),
          u = (0, n.useCallback)(
            (e) => {
              a && a(i, e), t && 'object' == typeof t ? (t.current = e) : 'function' == typeof t && t(e)
            },
            [i, a, t],
          )
        return n.createElement(f, { ...r, id: i.id, onClick: c, ref: u }, i.label)
      })
      ...
      function k(e) {
        ...
        return n.createElement(T.Icon, { icon: P(t), className: a(A['arrow-icon'], A[`size-${t}`], i && A.dropped) })
      }
      var B = i(456)
      function z(e) {
        const {
          ...
          T = (function (e, t) {
            ...
            return (
              ...
              (0, n.useCallback)(() => {
                const s = (0, _.ensureNotNull)(t.current).getBoundingClientRect(),
                  n = i.current[e]
                return {
                  x: s.left,
      ...
      function H(e) {
        ...
        return a(Y['scroll-wrap'], Y[`size-${t}`], 'scroll' === i && Y['enable-scroll'], s)
      }
      function L() {
      ...
      function V(e) {
        ...
        return n.createElement(
          'div',
          {
            ...
            style: { transform: `translateX(${i}px) scaleX(${l})`, transitionDuration: `${s}ms` },
          },
          n.createElement('div', { className: W().corner, style: { transform: `scaleX(${1 / l})` } }),
          n.createElement('div', { className: W().center, style: { transform: `scaleX(${1 - 30 / e.scale})` } }),
          n.createElement('div', { className: W().corner, style: { transform: `scaleX(${1 / l})` } }),
        )
      }
      function q(e) {
        const {
          ...
          B = L(),
          R = (function (e) {
            const t = (0, M.useSafeMatchMedia)(F['media-mf-phone-landscape'], !0),
              i = L()
          ...
          { isOpened: se, open: ne, close: ae, onButtonClick: le } = (0, d.useDisclosure)({ id: t, disabled: b }),
          ...
          ve = (0, n.useCallback)(
            (e) => {
              var t
              return null !== (t = re.find((t) => t.id === e.id)) && void 0 !== t ? t : {}
            },
            [re],
          ),
          fe = (0, n.useCallback)(() => {
        ...
        const Se = (function (e, t, i = []) {
          const [s, a] = (0, n.useState)(),
            ...
            r = (e) => {
              var t
              const i = null !== (t = e.parentElement) && void 0 !== t ? t : void 0
              if (void 0 === i) return
            ...
            (0, n.useEffect)(() => {
              ...
              return void 0 !== s
                ? (r(s),
                  ...
                  () => {
                    var e
                    return null === (e = l.current) || void 0 === e ? void 0 : e.disconnect()
                  })
                : void 0
            }, i),
            s
          )
        })(ie.current, null != pe ? pe : ge, [null != pe ? pe : ge, Q, f, O, R])
        return n.createElement(
          p.Provider,
          { value: { size: f, overflowBehaviour: R } },
          n.createElement(
            'div',
            { ...ue, className: H({ size: f, overflowBehaviour: R, className: S }), style: T, 'data-name': A },
            n.createElement(
              'div',
              {
                ...ce,
              ...
              ee.map((e) => n.createElement(C, { ...ve(e), ref: G(D(e)), key: e.id, item: e, fake: !0 })),
              'collapse' === R &&
                n.createElement(z, {
                  size: f,
                  disabled: b,
              ...
              Se ? n.createElement(V, { ...Se, disabled: b }) : n.createElement('div', null),
            ),
          ),
        )
      }
      ...
      ;(0, n.forwardRef)((e, t) => {
        ...
        const { size: s, overflowBehaviour: a } = (0, n.useContext)(p),
          ...
          T = (0, n.useCallback)(
            (e) => {
              c && c(o, e), t && 'object' == typeof t ? (t.current = e) : 'function' == typeof t && t(e)
            },
            [o, c, t],
          ),
